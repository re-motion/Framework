...
namespace Remotion.Validation.RuleBuilders
{
  ...
  public interface IAddingComponentRuleBuilderOptions<TValidatedType, out TProperty> : IRuleBuilderOptions<TValidatedType, TProperty>, IAddingComponentRuleBuilder<TValidatedType, TProperty>
  {
  }
}