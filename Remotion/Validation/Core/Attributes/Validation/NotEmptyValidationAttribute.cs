...
{
  /// <summary>
  /// Apply the <see cref="NotEmptyValidationAttribute"/> to introduce a <see cref="NotEmptyValueValidator"/> or
  ...
  ///     <description><see cref="NotEmptyValueValidator"/></description>
  ///   </item>
  ///   <item>
  ///     <term>byte[]: </term>
  ///     <description><see cref="NotEmptyValueValidator"/></description>
  ...
  public class NotEmptyValidationAttribute : AddingValidationAttributeBase
  {
    ...
    protected override IEnumerable<IPropertyValidator> GetValidators (IPropertyInformation property, IValidationMessageFactory validationMessageFactory)
    {
      ...
      if(property.PropertyType == typeof(string))
        validatorFactory = msg => new NotEmptyValueValidator(msg);
