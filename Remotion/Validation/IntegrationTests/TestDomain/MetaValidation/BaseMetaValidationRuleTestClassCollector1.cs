...
{
  public class BaseMetaValidationRuleTestClassCollector1 : ValidationRuleCollectorBase<BaseMetaValidationTestClass1>
  {
    public BaseMetaValidationRuleTestClassCollector1 ()
    {
      AddRule(c => c.Property1).MaxLength(10);
