...
namespace Remotion.Validation.UnitTests.Merging
{
  ...
  public class DiagnosticOutputValidationRuleMergeDecoratorTest
  {
    ...
    public void SetUp ()
    {
      ...
      _diagnosticOutputValidationRuleMergeDecorator = new DiagnosticOutputValidationRuleMergeDecorator (_wrappedMergerStub, _validatorFormatterStub, logManagerStub);
    }
    ...
    public void Merge_WithValidationCollectors ()
    {
      ...
      var logContextInfo1 = new PropertyValidatorLogContextInfo (
          ...
          new[]
          {
              new PropertyValidatorRegistrationWithContext (new RemovingValidatorRegistration (typeof (NotEmptyValidator), null), removingPropertyRuleStub1),
              new PropertyValidatorRegistrationWithContext (new RemovingValidatorRegistration (typeof (NotEmptyValidator), null), removingPropertyRuleStub1),
              new PropertyValidatorRegistrationWithContext (new RemovingValidatorRegistration (typeof (NotEmptyValidator), null), removingPropertyRuleStub2)
          });
      var logContextInfo2 = new PropertyValidatorLogContextInfo (
          stubValidator1,
          new[]
          { new PropertyValidatorRegistrationWithContext (new RemovingValidatorRegistration (typeof (NotNullValidator), null), removingPropertyRuleStub2) });
      var logContextInfo3 = new PropertyValidatorLogContextInfo (
          stubValidator3,
          new[]
          { new PropertyValidatorRegistrationWithContext (new RemovingValidatorRegistration (typeof (NotEqualValidator), null), removingPropertyRuleStub1) });
      ...
      _wrappedMergerStub.Stub (stub => stub.Merge (validationCollectorInfos))
          .Return (
              new ValidationCollectorMergeResult (addingPropertyValidationRuleCollectors, addingObjectValidationRuleCollectors, _logContextStub));
      ...
      var expectedAfterMerge =
          ...
          + "\r\n        MERGE LOG:"
          + "\r\n        -> 'NotEmptyValidator' was removed from collectors 'CustomerValidationRuleCollector1, CustomerValidationRuleCollector2'"
