...
namespace Remotion.Validation.UnitTests.Merging
{
  ...
  public class PropertyValidatorExtractorTest
  {
    ...
    public void SetUp ()
    {
      ...
      _stubPropertyValidator2 = new NotEmptyValueValidator(new InvariantValidationMessage("Fake Message")); //extracted
      ...
      var registration1 = new { ValidatorType = typeof(NotEmptyValueValidator), CollectorTypeToRemoveFrom = (Type)null };
