  ...
  public class NamespaceAwareDiagnosticOutputValidationRuleMergeDecoratorTest
  {
    ...
    public void Merge_WithValidationCollectors ()
    {
      ...
      var logContextInfo2 = new PropertyValidatorLogContextInfo (
          stubValidator1,
          new[] { new PropertyValidatorRegistrationWithContext (new RemovingValidatorRegistration (typeof (NotNullValidator), null), removingPropertyRuleStub2) });
      var logContextInfo3 = new PropertyValidatorLogContextInfo (
          stubValidator3,
          new[] { new PropertyValidatorRegistrationWithContext (new RemovingValidatorRegistration (typeof (NotEqualValidator), null), removingPropertyRuleStub1) });
