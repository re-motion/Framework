...
namespace Remotion.Validation.UnitTests.Merging
{
  ...
  public class OrderPrecedenceValidationRuleCollectorMergerTest
  {
    ...
    private NotEmptyValueValidator _notEmptyValueValidator;
    ...
    public void SetUp ()
    {
      _notEmptyValueValidator = new NotEmptyValueValidator(new InvariantValidationMessage("Fake Message"));
      ...
      _addingPropertyValidationRuleCollector1.RegisterValidator(_ => _notEmptyValueValidator);
      ...
      _removingPropertyValidationRuleCollector1.RegisterValidator(typeof(NotEmptyValueValidator), null, null);
    ...
    public void Merge_RemovePropertyValidatorWithNoCollectorTypeDefined_ValidatorIsRemoved ()
    {
              ...
              mock =>
                  mock.Create(
                      It.Is<IEnumerable<RemovingPropertyValidatorRegistration>>(
                          c => c.Count() == 1 && c.ToArray()[0].ValidatorType == typeof(NotEmptyValueValidator)),
      ...
      _propertyValidatorExtractorMock
          ...
          .Returns(new[] { _notEmptyValueValidator })
          .Verifiable();
    ...
    public void Merge_RemovePropertyValidatorWithAlreadyRegisteredCollectorTypeDefined_ValidatorIsRemoved ()
    {
      ...
      Assert.That(result[0].Validators, Is.EquivalentTo(new IPropertyValidator[] { _notEmptyValueValidator, _notEqualValidator }));
    }
    ...
    public void Merge_RemovePropertyValidator_AllRemoveRulesInSameGroupAreAppliedBeforeAllAddedRulesInSameGroup ()
    {
      ...
      _propertyValidatorExtractorMock
          .Setup(mock => mock.ExtractPropertyValidatorsToRemove(_addingPropertyValidationRuleCollector1))
          .Returns(new IPropertyValidator[] { _notEmptyValueValidator, _notNullValidator })
          .Verifiable();
      _propertyValidatorExtractorMock
    ...
    public void Merge_RemovePropertyValidator_NoPropertyValidatorsToRemove_NoValidatorIsRemoved ()
    {
      ...
      _propertyValidatorExtractorMock.Verify();
      Assert.That(result.Count(), Is.EqualTo(1));
      Assert.That(result[0].Validators, Is.EquivalentTo(new IPropertyValidator[] { _notEmptyValueValidator, _notNullValidator, _notEqualValidator }));
    }
