  ...
  public class NotNullValidationAttributeTest
  {
    ...
    public void GetPropertyValidator ()
    {
      ...
      _validationMessageFactoryStub
          .Stub (_ => _.CreateValidationMessageForPropertyValidator (typeof (NotNullValidator), propertyInformation))
      ...
      Assert.That (((NotNullValidator) result[0]).ValidationMessage, Is.SameAs (invariantValidationMessageStub));
    }
