...
{
  [TestFixture]
  public class LessThanValidatorTest : ValidatorTestBase
  {
    [Test]
    ...
    public void Validate_WithIComparable_CallsCompareTo ()
    {
      ...
      var validator = new LessThanValidator(comparisonValueMock.Object, new InvariantValidationMessage("Custom validation message: '{0}'."));
