    ...
    protected override ILookup<Type, IAttributesBasedValidationPropertyRuleReflector> CreatePropertyRuleReflectors (IEnumerable<Type> types)
    {
      ...
      foreach (var type in involvedTypes)
      {
        foreach (var property in type.GetProperties (BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly))
        {
          ...
          {
            _validationPropertyRuleReflectorMocks[type].Setup (mock => mock.GetValidatedPropertyFunc (typeof (Employee)))                .Returns (e => ((Employee) e).Position).Verifiable();
            ...
            _validationPropertyRuleReflectorMocks[type].Setup (mock => mock.GetNonRemovablePropertyValidators ())                .Returns (new[] { _propertyValidatorStub2 }).Verifiable();
          ...
          {
            _validationPropertyRuleReflectorMocks[type].Setup (mock => mock.GetValidatedPropertyFunc (typeof (Employee)))                .Returns (e => ((Employee) e).Notes).Verifiable();
            ...
            _validationPropertyRuleReflectorMocks[type].Setup (mock => mock.GetRemovingValidatorRegistrations ())                .Returns (new[] { _removingValidatorRegistration1, _removingValidatorRegistration2 }).Verifiable();
            _validationPropertyRuleReflectorMocks[type].Setup (mock => mock.GetMetaValidationRules ()).Returns (new IPropertyMetaValidationRule[0]).Verifiable();
          }
          else if (property.Name == "LastName")
          {
            _validationPropertyRuleReflectorMocks[type].Setup (mock => mock.GetValidatedPropertyFunc (typeof (SpecialCustomer1)))                .Returns (c => ((SpecialCustomer1) c).LastName).Verifiable();
            _validationPropertyRuleReflectorMocks[type].Setup (mock => mock.GetRemovablePropertyValidators ())                .Returns (new[] { _propertyValidatorStub4, _propertyValidatorStub5 }).Verifiable();
            _validationPropertyRuleReflectorMocks[type].Setup (mock => mock.GetNonRemovablePropertyValidators ()).Returns (new IPropertyValidator[0]).Verifiable();
            _validationPropertyRuleReflectorMocks[type].Setup (mock => mock.GetRemovingValidatorRegistrations ()).Returns (new RemovingValidatorRegistration[0]).Verifiable();
            _validationPropertyRuleReflectorMocks[type].Setup (mock => mock.GetMetaValidationRules ())                .Returns (new[] { _propertyMetaValidationRule1, _propertyMetaValidationRule3 }).Verifiable();
          }
          else if (property.Name == "UserName")
          {
            _validationPropertyRuleReflectorMocks[type].Setup (mock => mock.GetValidatedPropertyFunc (typeof (SpecialCustomer1)))                .Returns (c => ((SpecialCustomer1) c).UserName).Verifiable();
            ...
            _validationPropertyRuleReflectorMocks[type].Setup (mock => mock.GetNonRemovablePropertyValidators ()).Returns (new IPropertyValidator[0]).Verifiable();
            _validationPropertyRuleReflectorMocks[type].Setup (mock => mock.GetRemovingValidatorRegistrations ())                .Returns (new[] { _removingValidatorRegistration3, _removingValidatorRegistration4 }).Verifiable();
