...
namespace Remotion.Validation.UnitTests.Providers
{
  ...
  public class AttributeBasedValidationRuleCollectorProviderBaseTest
  {
    ...
    public void SetUp ()
    {
      ...
      _removingValidatorRegistration2 = new RemovingValidatorRegistration(typeof(NotEmptyValueValidator), null);
      _removingValidatorRegistration3 = new RemovingValidatorRegistration(typeof(NotNullValidator), null);
      _removingValidatorRegistration4 = new RemovingValidatorRegistration(typeof(NotEmptyValueValidator), null);
