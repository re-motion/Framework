...
namespace Remotion.Development.UnitTesting.Compilation.Roslyn {
    internal class CSharpRoslynCompiler : RoslynCompiler {
        private static volatile Regex outputRegWithFileAndLine;
        private static volatile Regex outputRegSimple;

        public CSharpRoslynCompiler(CodeDomProvider codeDomProvider, IRoslynProviderOptions providerOptions = null)
        ...
        protected override void FixUpCompilerParameters(CompilerParameters options) {
            ...
            if (_providerOptions.UseAspNetSettings)
            {
                ...
                Util.RoslynCompilationUtil.PrependCompilerOption(options, "/nowarn:" + String.Join(";", noWarnStrings));
            }
        }
