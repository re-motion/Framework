...
{
  /// <summary>
  /// Interface for all control exists command builders.
  /// </summary>
  /// <typeparam name="TControlSelector">The control selector to use.</typeparam>
  public interface IControlExistsCommandBuilder<in TControlSelector>
      where TControlSelector : IControlSelector
  {
    ...
    /// <see cref="IControlExistsCommand"/>.
    /// </summary>
    IControlExistsCommand Using ([NotNull] TControlSelector strategy);
  }
}
