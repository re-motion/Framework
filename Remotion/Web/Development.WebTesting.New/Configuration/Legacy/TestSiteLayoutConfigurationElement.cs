...
namespace Remotion.Web.Development.WebTesting.Configuration.Legacy
{
  ...
  public class TestSiteLayoutConfigurationElement : ConfigurationElement, IWebTestTestSiteLayoutSettings
  {
    ...
    private readonly ConfigurationProperty _processArgumentsProperty;
    ...
    public TestSiteLayoutConfigurationElement ()
    {
      ...
      _processArgumentsProperty = new ConfigurationProperty("processArguments", typeof(string), null);
    }
    ...
    public string? ProcessArguments => (string?)this[_processArgumentsProperty];

    IReadOnlyList<string> IWebTestTestSiteLayoutSettings.Resources => Resources.Select(e => e.Path).ToArray();

    /// <inheritdoc />
    protected override ConfigurationPropertyCollection Properties => new() { _rootPathProperty, _resourcesProperty, _processPathProperty, _processArgumentsProperty };
  }
}
