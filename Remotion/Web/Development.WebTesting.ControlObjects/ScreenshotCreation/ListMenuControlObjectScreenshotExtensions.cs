...
{
  /// <summary>
  /// Screenshot extensions for <see cref="ListMenuControlObject"/>.
  /// </summary>
  public static class ListMenuControlObjectScreenshotExtensions
  {
    /// <summary>
    ...
    {
      ArgumentUtility.CheckNotNull(nameof(fluentListMenu), fluentListMenu);
