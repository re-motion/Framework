...
{
  /// <summary>
  /// Screenshot extensions for <see cref="TabbedMultiViewControlObject"/>.
  /// </summary>
  public static class TabbedMultiViewControlObjectScreenshotExtensions
  {
    /// <summary>
    ...
    {
      ArgumentUtility.CheckNotNull(nameof(fluentTabbedMultiView), fluentTabbedMultiView);
