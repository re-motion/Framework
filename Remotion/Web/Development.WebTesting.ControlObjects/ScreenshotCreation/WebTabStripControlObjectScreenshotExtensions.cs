...
{
  /// <summary>
  /// Screenshot extensions for <see cref="WebTabStripControlObject"/>.
  /// </summary>
  public static class WebTabStripControlObjectScreenshotExtensions
  {
    /// <summary>
    ...
    {
      ArgumentUtility.CheckNotNull(nameof(fluentWebTabStrip), fluentWebTabStrip);
