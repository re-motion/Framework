...
namespace Remotion.Web.Test.Shared.MultiplePostBackCatching
{
  public partial class TestForm : TestBasePage
  {
    protected override void OnLoad (EventArgs e)
    {
      ...
      var sutFormUrl = SafeServiceLocator.Current.GetInstance<IResourceUrlFactory>()
          .CreateResourceUrl(typeof(SutForm), TestResourceType.Root, "MultiplePostbackCatching/SutForm.aspx")
          .GetUrl();
