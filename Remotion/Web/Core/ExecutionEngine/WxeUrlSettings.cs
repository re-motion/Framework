...
namespace Remotion.Web.ExecutionEngine
{
  ...
  public class WxeUrlSettings
  {
    ...
    public static WxeUrlSettings Create (int? maximumUrlLength = null, string? defaultWxeHandler = null)
    {
      ...
      return new WxeUrlSettings(constructedMaximumUrlLength, constructedDefaultWxeHandler);
    }
    ...
    public WxeUrlSettings ()
        : this(c_defaultMaximumUrlLength, null)
    {
    }

    private WxeUrlSettings (int maximumUrlLength, string? defaultWxeHandler)
    {
