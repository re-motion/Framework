...
public class SmartPage : Page, ISmartPage, ISmartNavigablePage
{
  ...
  /// </summary>
  /// <value> 
  ///   <see langword="true"/> to abort the queued submit. Defaults to <see langword="null"/>, which is interpreted as <see langword="true"/>.
  /// </value>
  /// <remarks>
  ///   Use <see cref="IsQueuedSubmitToBeAborted"/> to evaluate this property.
  /// </remarks>
  [Description (
      "The flag that determines whether to continue or abort a queued submit upon completion of the postback. Undefined is interpreted as true.")]
  [Category ("Behavior")]
  [DefaultValue (null)]
  ...
  {
    get { return _abortQueuedSubmit ?? true; }
  }
