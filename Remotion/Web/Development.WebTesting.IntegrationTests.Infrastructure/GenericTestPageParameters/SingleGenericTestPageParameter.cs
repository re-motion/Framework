...
{
  /// <summary>
  /// <see cref="IGenericTestPageParameter"/> for <see cref="SingleControlSelectorTestCaseFactory{TControlSelector,TControl}"/>.
  /// </summary>
  public class SingleGenericTestPageParameter : GenericTestPageParameterBase
  {
    private const int c_parameterCount = 1;

    /// <summary>
    /// HTML id of the only element on the page.
    /// </summary>
