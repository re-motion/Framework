...
// 
function WebTreeView()
{
}

WebTreeView.Initialize = function ($treeView)
{
...
WebTreeView.OnKeyDown = function (event, $treeView)
{
...
WebTreeView.SetFocus = function ($newTreeNode, $oldTreeNode)
{
...
WebTreeView.ToggleExpander = function ($treeNode)
{
...
WebTreeView.SelectNode = function ($treeNode)
{
  ArgumentUtility.CheckNotNullAndTypeIsJQuery ('$treeNode', $treeNode);
