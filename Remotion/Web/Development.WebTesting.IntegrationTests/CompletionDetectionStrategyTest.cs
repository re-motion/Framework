...
{
  public class CompletionDetectionStrategyTest : IntegrationTest
  {
    [Test]
    public void TestDelayedClick_PostBack ()
    {
      var home = Start();
    ...
    [Test]
    public void TestDelayedClick_PostBackIn ()
    {
      var home = Start();
    ...
    [Test]
    public void TestDelayedClick_Reset ()
    {
      var home = Start();
    ...
    [Test]
    public void TestDelayedClick_ResetIn ()
    {
      var home = Start();
    ...
    /// <summary>
    /// Waits for the completion of the triggered postback, to prevent impact on other tests.
    /// </summary>
