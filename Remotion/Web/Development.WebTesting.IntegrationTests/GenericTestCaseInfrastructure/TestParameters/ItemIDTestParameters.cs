...
{
  /// <summary>
  /// Parameters for <see cref="ItemIDControlSelectorTestCaseFactory{TControlSelector,TControl}"/>.
  /// </summary>
  public class ItemIDTestParameters : ITestParameters
  {
    private string _visibleControlItemID;
    private string _hiddenControlItemID;
    private string _foundControlID;

    public ItemIDTestParameters ()
    {
    }
    ...
    public string Name
    {
      get { return TestConstants.ItemID; }
    }
