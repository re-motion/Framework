...
{
  /// <summary>
  /// Parameters for <see cref="FirstControlSelectorTestCaseFactory{TControlSelector,TControl}"/>.
  /// </summary>
  public class FirstTestParameters : ITestParameters
  {
    private string _foundControlID;

    public FirstTestParameters ()
    {
    }
    ...
    public string Name
    {
      get { return TestConstants.First; }
    }
