...
{
  /// <summary>
  /// Contains test for <see cref="ITitleControlSelector{TControlObject}"/> that are executed by using <see cref="TestCaseSourceAttribute"/>.
  /// </summary>
  public class TitleControlSelectorTestCaseFactory<TControlSelector, TControl>
      : ControlSelectorTestCaseFactoryBase<TControlSelector, TControl, TitleTestParameters>
      ...
      where TControl : ControlObject
  {
    ...
    {
      var control = Selector.GetByTitle (Parameters.VisibleControlTitle);
    ...
    {
      Assert.That (
          () => Selector.GetByTitle (Parameters.HiddenControlTitle),
    ...
    {
      var control = Selector.GetByTitleOrNull (Parameters.VisibleControlTitle);
    ...
    {
      var control = Selector.GetByTitleOrNull (Parameters.HiddenControlTitle);
    ...
    {
      var controlVisible = Selector.ExistsByTitle (Parameters.VisibleControlTitle);
    ...
    {
      var controlVisible = Selector.ExistsByTitle (Parameters.HiddenControlTitle);
