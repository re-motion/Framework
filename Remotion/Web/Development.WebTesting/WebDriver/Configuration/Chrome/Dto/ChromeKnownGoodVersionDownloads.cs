...
namespace Remotion.Web.Development.WebTesting.WebDriver.Configuration.Chrome.Dto
{
  ...
  [DataContract]
  public class ChromeKnownGoodVersionDownloads
  {
    [DataMember(Name = "chrome")]
    public ChromeArtifactDownload[]? ChromeArtifacts { get; set; }

    [DataMember(Name = "chromedriver")]
    public ChromeArtifactDownload[]? ChromeDriverArtifacts { get; set; }
  }
}
