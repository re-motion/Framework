...
namespace Remotion.Web.Development.WebTesting
{
  ...
  public class WebTestConfigurationFactory
  {
    ...
    /// </summary>
    protected const string LatestTestedFirefoxVersion = "111";
    ...
    {
      var configSettings = WebTestConfiguration.Current;

      var configuredBrowser = Browser.Parse(configSettings.Browser);
    ...
    protected virtual IBrowserConfiguration CreateCustomBrowserConfiguration ([NotNull] IWebTestConfiguration configSettings)
    {
      ArgumentUtility.CheckNotNull("configSettings", configSettings);

      throw new NotSupportedException(string.Format("Browser '{0}' is not supported by the '{1}'.", configSettings.Browser, GetType().Name));
    }
    ...
    /// </remarks>
    protected virtual IChromeConfiguration CreateChromeConfiguration ([NotNull] IWebTestConfiguration configSettings)
    {
      ArgumentUtility.CheckNotNull("configSettings", configSettings);
    ...
    /// </remarks>
    protected virtual IEdgeConfiguration CreateEdgeConfiguration ([NotNull] IWebTestConfiguration configSettings)
    {
      ArgumentUtility.CheckNotNull("configSettings", configSettings);
    ...
    protected virtual IFirefoxConfiguration CreateFirefoxConfiguration (IWebTestConfiguration configSettings)
    {
      ArgumentUtility.CheckNotNull("configSettings", configSettings);
    ...
    /// </remarks>
    protected virtual IHostingConfiguration CreateHostingConfiguration ([NotNull] IWebTestConfiguration configSettings)
    {
      ArgumentUtility.CheckNotNull("configSettings", configSettings);
