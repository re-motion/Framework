...
namespace Remotion.Web.Development.WebTesting.ScreenshotCreation
{
  ...
  /// ability to change the <see cref="SkiaCanvas"/> object used to draw or change the <see cref="ResolvedScreenshotElement"/>
      ...
      where T : notnull
  {
    ...
    /// </summary>
    /// <example>
    /// Changing the clipping area of the <see cref="SkiaCanvas"/> object in <see cref="BeginApply"/> should be undone in <see cref="EndApply"/>.
    /// </example>
