...
namespace Remotion.Web.Development.WebTesting.TestSite
{
  public partial class BrowserSessionTest : WxePage
  {
    ...
    {
      var testPersistentCookie = new HttpCookie("TestPersistentCookie", "TestPersistentCookie");
      testPersistentCookie.Expires = DateTime.Now + TimeSpan.FromDays(5);
      Response.Cookies.Add(testPersistentCookie);
    }
  }
}