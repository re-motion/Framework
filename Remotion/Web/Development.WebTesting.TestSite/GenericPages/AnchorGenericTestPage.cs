...
namespace Remotion.Web.Development.WebTesting.TestSite.GenericPages
{
  ...
  /// </summary>
  public class AnchorGenericTestPage : SimpleGenericTestPage<LinkButton>
  {
    public AnchorGenericTestPage ()
    {
    }

    /// <inheritdoc />
    public override LinkButton CreateControl (GenericTestOptions options)
    {
