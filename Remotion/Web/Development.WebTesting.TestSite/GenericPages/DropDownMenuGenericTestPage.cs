...
{
  /// <summary>
  /// Custom <see cref="IGenericTestPage{TOptions}"/> for a <see cref="DropDownMenu"/>.
  /// </summary>
  public class DropDownMenuGenericTestPage : SimpleGenericTestPage<DropDownMenu>
  {
    public DropDownMenuGenericTestPage ()
    {
    }
