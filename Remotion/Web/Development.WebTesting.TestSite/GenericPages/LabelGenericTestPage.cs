...
{
  /// <summary>
  /// Custom <see cref="IGenericTestPage{TOptions}"/> for a <see cref="Label"/>.
  /// </summary>
  public class LabelGenericTestPage : SimpleGenericTestPage<Label>
  {
    public LabelGenericTestPage ()
    {
    }
