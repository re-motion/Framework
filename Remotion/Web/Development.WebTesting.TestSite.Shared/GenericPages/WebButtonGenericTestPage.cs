...
{
  /// <summary>
  /// Custom <see cref="IGenericTestPage{TOptions}"/> for a <see cref="WebButton"/>.
  /// </summary>
  public class WebButtonGenericTestPage : SimpleGenericTestPage<WebButton>
  {
    public WebButtonGenericTestPage ()
    {
    }
