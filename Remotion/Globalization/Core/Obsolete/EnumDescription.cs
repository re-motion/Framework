...
namespace Remotion.Globalization
{
  ...
  public static class EnumDescription
  {
    [NotNull]
    [Obsolete(
        "Use Enum.GetValues (enumType) to get the values, then use IEnumerationGlobalizationService.GetEnumerationValueDisplayName (...) for each value. (Version 1.13.223.0)",
        true)]
    ...
    [NotNull]
    [Obsolete(
        "Use Enum.GetValues (enumType) to get the values, then use IEnumerationGlobalizationService.GetEnumerationValueDisplayName (...) for each value. "
        + "Use a CultureScope set the CurrentUICulture. (Version 1.13.223.0)",
        true)]
    ...
    [NotNull]
    [Obsolete(
        "Use IEnumerationGlobalizationService.GetEnumerationValueDisplayName (...). Use a CultureScope set the CurrentUICulture. (Version 1.13.223.0)",
        true)]
