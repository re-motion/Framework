...
namespace Remotion.ObjectBinding.UnitTests.BindableObject
{
  ...
  public class CompundBindablePropertyReadAccessStrategyTest : TestBase
  {
    ...
    private Mock<IBindablePropertyReadAccessStrategy> _innerStrategy1;
    private Mock<IBindablePropertyReadAccessStrategy> _innerStrategy2;
    private Mock<IBindablePropertyReadAccessStrategy> _innerStrategy3;
    ...
    public override void SetUp ()
    {
      ...
      _innerStrategy1 = new Mock<IBindablePropertyReadAccessStrategy> (MockBehavior.Strict);
      _innerStrategy2 = new Mock<IBindablePropertyReadAccessStrategy> (MockBehavior.Strict);
      _innerStrategy3 = new Mock<IBindablePropertyReadAccessStrategy> (MockBehavior.Strict);

      _strategy = new CompundBindablePropertyReadAccessStrategy (new[] { _innerStrategy1.Object, _innerStrategy2.Object, _innerStrategy3.Object });
    ...
    {
      Assert.That (_strategy.BindablePropertyReadAccessStrategies, Is.EqualTo (new[] { _innerStrategy1.Object, _innerStrategy2.Object, _innerStrategy3.Object }));
    }
    ...
    public void CanRead_WithoutStrategies_ReturnsTrue ()
    {
      ...
      var result = strategy.CanRead (_businessObject.Object, _property);
    ...
    {
      var sequence = new MockSequence();
      _innerStrategy1.Setup (mock => mock.CanRead (_businessObject.Object, _property)).Returns (true).Verifiable();
      _innerStrategy2.Setup (mock => mock.CanRead (_businessObject.Object, _property)).Returns (true).Verifiable();
      _innerStrategy3.Setup (mock => mock.CanRead (_businessObject.Object, _property)).Returns (true).Verifiable();
    ...
    public void CanRead_WithOneStrategyReturingFalse_ReturnsFalse_AndAbortsChecks ()
    {
      var sequence = new MockSequence();
      _innerStrategy1.Setup (mock => mock.CanRead (_businessObject.Object, _property)).Returns (true).Verifiable();
      _innerStrategy2.Setup (mock => mock.CanRead (_businessObject.Object, _property)).Returns (false).Verifiable();
      _innerStrategy3.Setup (mock => mock.CanRead (_businessObject.Object, _property)).Verifiable();
