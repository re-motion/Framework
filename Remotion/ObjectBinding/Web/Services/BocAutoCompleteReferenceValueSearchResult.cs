...
namespace Remotion.ObjectBinding.Web.Services
{
  ...
  public abstract class BocAutoCompleteReferenceValueSearchResult
  {
    ...
    /// </summary>
    public static BocAutoCompleteReferenceValueSearchResult CreateForValueList (BusinessObjectWithIdentityProxy[] values) =>
        new BocAutoCompleteReferenceValueSearchResultWithValueList(values);
