...
namespace Remotion.ObjectBinding.Web.Services
{
  ...
  public interface IBocAutoCompleteReferenceValueWebService : IBocReferenceValueBaseWebService
  {
    ...
    ///   The number of items to skip before returning results or <see langword="null" /> if no offset should be used and results should be returned from the beginning.
    /// </param>
