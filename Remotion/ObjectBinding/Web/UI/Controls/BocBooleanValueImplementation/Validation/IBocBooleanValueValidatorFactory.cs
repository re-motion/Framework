...
{
  /// <summary>
  /// Defines a factory for validators used to validate a <see cref="IBocBooleanValue"/>.
  /// </summary>
  /// <seealso cref="BocBooleanValueValidatorFactory"/>
  /// <seealso cref="CompoundBocBooleanValueValidatorFactory"/>
