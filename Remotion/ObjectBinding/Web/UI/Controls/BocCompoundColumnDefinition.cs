...
namespace Remotion.ObjectBinding.Web.UI.Controls
{
  ...
  public class BocCompoundColumnDefinition : BocValueColumnDefinition
  {
    ...
    [NotifyParentProperty(true)]
    public PropertyPathBindingCollection PropertyPathBindings => _propertyPathBindings;
    ...
    protected override string DisplayedTypeName => "CompoundColumnDefinition";
