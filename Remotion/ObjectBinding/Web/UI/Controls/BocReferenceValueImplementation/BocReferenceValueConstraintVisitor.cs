...
{
  public class BocReferenceValueConstraintVisitor
      : IBusinessObjectConstraintVisitor<BusinessObjectPropertyValueRequiredConstraint>
  {
    public BocReferenceValue Control { get; }

    public BocReferenceValueConstraintVisitor (BocReferenceValue control)
    {
