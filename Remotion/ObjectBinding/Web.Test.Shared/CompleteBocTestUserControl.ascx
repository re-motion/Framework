...
<textboxstyle textmode="MultiLine">
  ...
  <tr>
    <td></td>
    <td><remotion:BocDateTimeValue id="DateTimeField" runat="server" propertyidentifier="DateOfBirth" datasourcecontrol="CurrentObject" EnableOptionalValidators="true"></remotion:BocDateTimeValue></td></tr>
  <tr>
