...
--%>
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="BocMultilineTextValueUserControl.ascx.cs" Inherits="Remotion.ObjectBinding.Web.Test.Shared.IndividualControlTests.BocMultilineTextValueUserControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<textboxstyle rows="3" textmode="MultiLine">
        ...
        <tr>
          <td></td>
          <td><remotion:bocmultilinetextvalue id=DisabledCVField runat="server" datasourcecontrol="CurrentObject" PropertyIdentifier="CV" ErrorMessage="Eingabe erforderlich"  required="True" enabled=false>
<textboxstyle rows="3" textmode="MultiLine">
</TextBoxStyle>
            </remotion:bocmultilinetextvalue></td>
          <td>
