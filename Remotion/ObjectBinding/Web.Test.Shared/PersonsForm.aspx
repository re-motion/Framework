...
--%>
<%@ Page language="c#" Codebehind="PersonsForm.aspx.cs" AutoEventWireup="false" Inherits="Remotion.ObjectBinding.Web.Test.Shared.PersonsForm" %>
...
<html>
  ...
  <body>
    <form id=TheForm method=post runat="server"><h1>Persons Form</h1>
