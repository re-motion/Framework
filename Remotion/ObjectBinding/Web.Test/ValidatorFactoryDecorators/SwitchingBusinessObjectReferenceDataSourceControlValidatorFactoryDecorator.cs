...
namespace OBWTest.ValidatorFactoryDecorators
{
      ...
      : SwitchingValidatorFactoryDecorator<BusinessObjectReferenceDataSourceControl>, IBusinessObjectReferenceDataSourceControlValidatorFactory
  {
    public SwitchingBusinessObjectReferenceDataSourceControlValidatorFactoryDecorator (
        ...
        IBocValidatorFactory<BusinessObjectReferenceDataSourceControl> withfluentValidatorFactory,
        IBocValidatorFactory<BusinessObjectReferenceDataSourceControl> withoutFluentValidatorFactory)
        : base (switchingValidatorFactoryState, withfluentValidatorFactory, withoutFluentValidatorFactory)
    {
    }
  }
}