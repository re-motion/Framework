...
namespace Remotion.ObjectBinding.Web.Development.WebTesting.TestSite.GenericTestPageInfrastructure
{
  ...
  public static class TestConstants
  {
    ...
    public const string DomainProperty = "domainProperty";
    ...
    public const string CorrectDomainPropertyClass = "Remotion.ObjectBinding.Sample.Person, Remotion.ObjectBinding.Sample";
    public const string IncorrectDomainPropertyClass = "Remotion.ObjectBinding.Sample.Job, Remotion.ObjectBinding.Sample";
  }
}