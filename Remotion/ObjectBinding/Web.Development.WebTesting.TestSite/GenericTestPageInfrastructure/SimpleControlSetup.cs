...
{
  public abstract class SimpleControlSetup<TControl> : ControlSetup
      where TControl : Control, new()
  {
    protected SimpleControlSetup (TestOptions options, int controlIndex)
    ...
    /// </summary>
    public abstract TControl CreateControl (string dataSource);

    /// <inheritdoc />
    public override void AddToContainer (Control container)
    {
      var control = CreateControl ("DataSource");
