...
{
  public class BocTextValueControlSetup : SimpleControlSetup<BocTextValue>
  {
    public BocTextValueControlSetup (TestOptions options, int controlIndex)
        : base (options, controlIndex)
    {
    }

    /// <inheritdoc />
    public override BocTextValue CreateControl (string dataSource)
    {
