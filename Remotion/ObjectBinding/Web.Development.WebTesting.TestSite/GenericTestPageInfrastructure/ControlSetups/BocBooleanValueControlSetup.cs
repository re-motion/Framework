...
{
  public class BocBooleanValueControlSetup : SimpleControlSetup<BocBooleanValue>
  {
    public BocBooleanValueControlSetup (TestOptions options, int controlIndex)
        : base (options, controlIndex)
    {
    }

    /// <inheritdoc />
    public override BocBooleanValue CreateControl (string dataSource)
    {
