...
{
  public class BocListControlSetup : SimpleControlSetup<BocList>
  {
    public BocListControlSetup (TestOptions options, int controlIndex)
        : base (options, controlIndex)
    {
    }

    /// <inheritdoc />
    public override BocList CreateControl (string dataSource)
    {
