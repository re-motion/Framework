...
{
  public class BocEnumValueControlSetup : SimpleControlSetup<BocEnumValue>
  {
    public BocEnumValueControlSetup (TestOptions options, int controlIndex)
        : base (options, controlIndex)
    {
    }

    /// <inheritdoc />
    public override BocEnumValue CreateControl (string dataSource)
    {
