...
{
  public class BocReferenceValueControlSetup : SimpleControlSetup<BocReferenceValue>
  {
    public BocReferenceValueControlSetup (TestOptions options, int controlIndex)
        : base (options, controlIndex)
    {
    }

    /// <inheritdoc />
    public override BocReferenceValue CreateControl (string dataSource)
    {
