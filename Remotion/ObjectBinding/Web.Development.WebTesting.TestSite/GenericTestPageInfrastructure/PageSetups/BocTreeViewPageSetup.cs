...
{
  public class BocTreeViewPageSetup : SimplePageSetup
  {
    public BocTreeViewPageSetup ()
        : base ((p, n) => new BocTreeViewControlSetup (p, n))
    {
      AddParameter (TestParameter.ForDisplayName ("Children"));
      AddParameter (TestParameter.ForDomainName ("Children"));
    }
  }
}