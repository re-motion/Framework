...
{
  public class BocListAsGridPageSetup : SimplePageSetup
  {
    public BocListAsGridPageSetup ()
        : base ((p, n) => new BocListAsGridControlSetup (p, n))
    {
      AddParameter (TestParameter.ForDisplayName ("Jobs"));
      AddParameter (TestParameter.ForDomainName ("Jobs"));
    }
  }
}