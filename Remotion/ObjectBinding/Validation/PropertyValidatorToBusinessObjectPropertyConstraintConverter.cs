...
{
  [ImplementationFor (typeof (IPropertyValidatorToBusinessObjectPropertyConstraintConverter), Position = Position, RegistrationType = RegistrationType.Single, Lifetime = LifetimeKind.Singleton)]
