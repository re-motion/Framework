...
namespace Remotion.ObjectBinding.Validation.UnitTests
{
  ...
  public class BusinessObjectValidationResultTest
  {
    ...
    public void GetValidationFailures_ReturnsMatchingValidationFailures ()
    {
      ...
      Assert.That(lastNameValidationFailures[0].ErrorMessage, Is.EqualTo("NotEmptyValueValidator: Validation error."));
      ...
      Assert.That(customerNumberValidationFailures[0].ErrorMessage, Is.EqualTo("NotEmptyValueValidator: Validation error."));
    }
    ...
    public void GetUnhandledValidationFailures_ForBusinessObject_ReturnsFilteredResult ()
    {
      ...
      Assert.That(sortedUnhandledValidationFailures[1].ErrorMessage, Is.EqualTo("NotEmptyValueValidator: Validation error."));
