...
{
  [TestFixture]
  public class ReadOnlyBocMultilineTextValueTest : IntegrationTest
  {
    [Test]
    public void Validate_OnReadOnlyControl_CreatesValidationErrors ()
    {
      ...
      var readOnlyControl = home.MultilineTextValues().GetByLocalID("CVField_ReadOnly");
      var validationErrors = readOnlyControl.GetValidationErrorsForReadOnly();

      Assert.That(validationErrors, Is.EqualTo(new[] { "Localized invalid CV." }));
    }
