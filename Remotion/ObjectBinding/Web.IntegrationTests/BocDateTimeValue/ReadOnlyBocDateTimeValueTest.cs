...
{
  [TestFixture]
  public class ReadOnlyBocDateTimeValueTest : IntegrationTest
  {
    [Test]
    public void Validate_OnReadOnlyControl_CreatesValidationErrors ()
    {
      ...
      var readOnlyControl = home.DateTimeValues().GetByLocalID("DateOfBirthField_ReadOnly");
      var validationErrors = readOnlyControl.GetValidationErrorsForReadOnly();

      Assert.That(validationErrors, Is.EqualTo(new[] { "Localized invalid dateOfBirth." }));
    }
