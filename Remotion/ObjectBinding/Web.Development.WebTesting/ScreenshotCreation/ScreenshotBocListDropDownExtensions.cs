...
{
  /// <summary>
  /// Provides fluent extension methods for controlling a <see cref="BocListControlObjectBase{TRowControlObject,TCellControlObject}"/> drop-down.
  /// </summary>
  public static class ScreenshotBocListDropDownExtensions
  {
    /// <summary>
    /// Opens the drop-down.
    /// </summary>
    ...
    {
      ArgumentNullException.ThrowIfNull(fluentDropDown);
