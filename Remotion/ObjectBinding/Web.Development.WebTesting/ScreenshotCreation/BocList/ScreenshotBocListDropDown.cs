...
{
  /// <summary>
  /// Marker class for the screenshot fluent API. Represents a <see cref="BocListControlObjectBase{TRowControlObject,TCellControlObject}"/> drop-down.
  /// </summary>
  public class ScreenshotBocListDropDown<TList, TRow, TCell> : ISelfResolvable
      ...
      where TCell : ControlObject
  {
    ...
    public ScreenshotBocListDropDown (
