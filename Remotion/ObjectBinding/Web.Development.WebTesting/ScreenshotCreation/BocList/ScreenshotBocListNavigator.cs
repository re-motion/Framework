...
{
  /// <summary>
  /// Marker class for the screenshot fluent API. Represents a <see cref="BocListControlObjectBase{TRowControlObject,TCellControlObject}"/> navigator.
  /// </summary>
  public class ScreenshotBocListNavigator<TList, TRow, TCell> : ISelfResolvable
      ...
      where TCell : ControlObject
  {
    ...
    public ScreenshotBocListNavigator (
