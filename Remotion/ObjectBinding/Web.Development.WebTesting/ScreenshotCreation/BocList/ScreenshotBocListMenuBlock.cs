...
{
  /// <summary>
  /// Marker class for the screenshot fluent API. Represents a <see cref="BocListControlObjectBase{TRowControlObject,TCellControlObject}"/> menu-block.
  /// </summary>
  public class ScreenshotBocListMenuBlock<TList, TRow, TCell> : ISelfResolvable
