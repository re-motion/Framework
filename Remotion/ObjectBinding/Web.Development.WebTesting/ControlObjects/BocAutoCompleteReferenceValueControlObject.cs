...
namespace Remotion.ObjectBinding.Web.Development.WebTesting.ControlObjects
{
  ...
  public class BocAutoCompleteReferenceValueControlObject
      : BocControlObject, IFillableControlObject, ICommandHost, IDropDownMenuHost, IControlObjectWithFormElements, ISupportsValidationErrors, ISupportsValidationErrorsForReadOnly
  {
    /// <summary>
