  ...
  public class BocListRowAndCellValidationFailureHandlerTest
  {
    ...
    public void HandleValidationFailures_WithValidationFailures_ContextContainsConcatenatedMessages ()
    {
      ...
      var validationFailures = new[]
                               {
                                     BusinessObjectValidationFailure.Create("Oh no such an error."),
                                     BusinessObjectValidationFailure.Create("What, another one?")
                               };

      _repository.AddValidationFailuresForBocList(validationFailures);
