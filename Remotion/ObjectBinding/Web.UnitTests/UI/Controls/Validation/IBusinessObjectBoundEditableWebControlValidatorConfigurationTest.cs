...
{
  [TestFixture]
  public class IBusinessObjectBoundEditableWebControlValidatorConfigurationTest
  {
    ...
    public void GetInstance_Once ()
    {
      ...
      Assert.That(instance, Is.InstanceOf<DefaultBusinessObjectBoundEditableWebControlValidatorConfiguration>());
    }
    ...
    public void GetInstance_Twice_ReturnsSameInstance ()
    {
      ...
      Assert.That(instance1, Is.InstanceOf<DefaultBusinessObjectBoundEditableWebControlValidatorConfiguration>());
