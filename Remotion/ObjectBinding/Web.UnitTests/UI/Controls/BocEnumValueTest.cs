...
namespace Remotion.ObjectBinding.Web.UnitTests.UI.Controls
{
  ...
  public class BocEnumValueTest : BocTest
  {
    ...
    {
      var control = new BocEnumValue();
      control.UndefinedItemText = WebString.CreateFromText ("The undefined item");
      control.ListControlStyle.ControlType = listControlType;

      Assert.That (((IBocEnumValue) control).GetNullItemText(), Is.EqualTo (WebString.CreateFromText ("The undefined item")));
    }
