...
namespace Remotion.ObjectBinding.Web.UnitTests.UI.Controls.BocReferenceValueImplementation.Validation
{
  ...
  public class BocReferenceValueValidatorFactoryTest
  {
    ...
    private IBocReferenceValue GetControlWithOptionalValidatorsEnabled (bool isRequired)
    {
      ...
      var controlMock = new Mock<IBocReferenceValue>();
    ...
    private IBocReferenceValue GetControlWithOptionalValidatorsDisabled (bool isRequired, bool hasDataSource = true, bool hasBusinessObject = true, bool hasProperty = true)
    {
      var outValue = "MockValue";
      var dataSourceStub = new Mock<IBusinessObjectDataSource>();
