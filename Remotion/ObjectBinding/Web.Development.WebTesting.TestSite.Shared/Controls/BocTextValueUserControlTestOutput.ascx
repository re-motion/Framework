...
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BocTextValueUserControlTestOutput.ascx.cs" Inherits="Remotion.ObjectBinding.Web.Development.WebTesting.TestSite.Shared.Controls.BocTextValueUserControlTestOutput" %>
<table border="1">
