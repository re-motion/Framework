...
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BocCheckBoxUserControlTestOutput.ascx.cs" Inherits="Remotion.ObjectBinding.Web.Development.WebTesting.TestSite.Shared.Controls.BocCheckBoxUserControlTestOutput" %>
<table border="1">
