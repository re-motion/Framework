...
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BocMultilineTextValueUserControlTestOutput.ascx.cs" Inherits="Remotion.ObjectBinding.Web.Development.WebTesting.TestSite.Shared.Controls.BocMultilineTextValueUserControlTestOutput" %>
<table border="1">
