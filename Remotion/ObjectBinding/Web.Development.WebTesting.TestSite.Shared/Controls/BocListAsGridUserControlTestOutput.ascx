...
--%>
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BocListAsGridUserControlTestOutput.ascx.cs" Inherits="Remotion.ObjectBinding.Web.Development.WebTesting.TestSite.Shared.Controls.BocListAsGridUserControlTestOutput" %>
<table border="1">
