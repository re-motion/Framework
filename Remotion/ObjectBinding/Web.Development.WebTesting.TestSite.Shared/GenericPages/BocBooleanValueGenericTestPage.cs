...
{
  /// <summary>
  /// Custom <see cref="IGenericTestPage{TOptions}"/> for a <see cref="BocBooleanValue"/>.
  /// </summary>
  public class BocBooleanValueGenericTestPage : EditableGenericTestPage<BocBooleanValue>
  {
    public BocBooleanValueGenericTestPage ()
    {
    }
