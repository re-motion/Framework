...
{
  /// <summary>
  /// Custom <see cref="IGenericTestPage{TOptions}"/> for a <see cref="BocTreeView"/>.
  /// </summary>
  public class BocTreeViewGenericTestPage : SimpleGenericTestPage<BocTreeView>
  {
    public BocTreeViewGenericTestPage ()
    {
    }
