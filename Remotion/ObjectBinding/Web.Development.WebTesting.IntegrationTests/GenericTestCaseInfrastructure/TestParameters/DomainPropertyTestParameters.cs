...
{
  /// <summary>
  /// Parameters for <see cref="DomainPropertyControlSelectorTestCaseFactory{TControlSelector,TControl}"/>.
  /// </summary>
  public class DomainPropertyTestParameters : ITestParameters
  {
    ...
    public DomainPropertyTestParameters ()
    {
    }
    ...
    public string Name
    {
      get { return TestConstants.DomainProperty; }
    }
