...
namespace Remotion.ObjectBinding.Web.Development.WebTesting.IntegrationTests
{
  ...
  public class BocBooleanValueControlObjectTest : IntegrationTest
  {
    ...
    [RemotionTestCaseSource (typeof (ValidationErrorTestCaseFactory<BocBooleanValueSelector, BocBooleanValueControlObject>))]
    ...
    public void TestIsDisabled_SetMethodsThrow ()
    {
      ...
      Assert.That (() => control.SetTo (false), Throws.Exception.Message.EqualTo (AssertionExceptionUtility.CreateControlDisabledException ("SetTo").Message));
    }
