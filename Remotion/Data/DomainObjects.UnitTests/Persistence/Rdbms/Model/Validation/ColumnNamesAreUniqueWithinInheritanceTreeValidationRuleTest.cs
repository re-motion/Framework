  ...
  public class ColumnNamesAreUniqueWithinInheritanceTreeValidationRuleTest : ValidationRuleTestBase
  {
    ...
    public void InheritanceRoot_PersistentPropertiesWithSameStorageSpecificPropertyNameInSameClass ()
    {
      ...
      var expectedMessage =
          ...
          + "'PropertyFakeProperty' with the same storage specific name." + Environment.NewLine
          + Environment.NewLine
    ...
    public void InheritanceRoot_TwoPersistentPropertiesWithSameStorageSpecificPropertyNameInSameInheritanceHierarchieLevel ()
    {
      ...
      var expectedMessage =
          ...
          + "storage specific name." + Environment.NewLine
          + Environment.NewLine
    ...
    public void InheritanceRoot_ThreePersistentPropertiesWithSameStorageSpecificPropertyName ()
    {
      ...
      var expectedMessage1 =
          ...
          + "same storage specific name." + Environment.NewLine
          + Environment.NewLine
      ...
      var expectedMessage2 =
          ...
          + "with the same storage specific name." + Environment.NewLine
          + Environment.NewLine
          + "Declaring type: Remotion.Data.DomainObjects.UnitTests.Mapping.TestDomain.Validation.BaseOfBaseValidationDomainObjectClass" + Environment.NewLine
          + "Property: FirstName1FakeProperty";
    ...
    public void InheritanceRoot_PersistentPropertiesWithSameStorageSpecificPropertyNameInDifferentLeavesOfInheritanceTree ()
    {
      ...
      var expectedMessage =
          ...
          + "the same storage specific name." + Environment.NewLine
          + Environment.NewLine
          + "Declaring type: Remotion.Data.DomainObjects.UnitTests.Mapping.TestDomain.Validation.DerivedValidationDomainObjectClass" + Environment.NewLine
