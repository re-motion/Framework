  ...
  public class ObjectIDWithoutClassIDStoragePropertyDefinitionTest : StandardMappingTest
  {
    ...
    public void SplitValuesForComparison_NullValue ()
    {
      ...
      _valuePropertyStub
          .Setup(stub => stub.SplitValuesForComparison(
              It.Is<IEnumerable<object>> (seq => seq.SequenceEqual(new[] { null, DomainObjectIDs.Order3.Value }))))
          .Returns(columnValueTable);
    ...
    public void SplitValuesForComparison_InvalidClassDefinition ()
    {
      ...
      _valuePropertyStub
          ...
          .Callback((IEnumerable<object> values) => ((IEnumerable<object>)mi.Arguments[0]).ToArray())
      ...
      valueProperty1Mock
          .Setup(
              mock => mock.UnifyWithEquivalentProperties(
                  new[] { valueProperty2Stub.Object, valueProperty3Stub.Object }))
