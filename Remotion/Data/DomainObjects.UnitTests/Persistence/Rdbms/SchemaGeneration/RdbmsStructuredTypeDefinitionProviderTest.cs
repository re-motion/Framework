...
namespace Remotion.Data.DomainObjects.UnitTests.Persistence.Rdbms.SchemaGeneration
{
  ...
  public class RdbmsStructuredTypeDefinitionProviderTest : SchemaGenerationTestBase
  {
    ...
    public void GetTypeDefinitions_UsesSimpleStructuredTypeDefinitionRepository ()
    {
      ...
      classDefinition2.SetStorageEntity(CreateUnionViewDefinition());
      ...
      tableManipulationRecordDefinitionProviderStub.Setup(_ => _.GetInsertRecordDefinition(classDefinition1)).Returns(recordDefinitions[1]);
      tableManipulationRecordDefinitionProviderStub.Setup(_ => _.GetLockRecordDefinition(classDefinition1)).Returns(recordDefinitions[2]);
    ...
    private static UnionViewDefinition CreateUnionViewDefinition ()
    {
      // Yeah, it is a hack. Creating a TableDefinition is quite a lot of work, and we only need the object to pass a type check.
