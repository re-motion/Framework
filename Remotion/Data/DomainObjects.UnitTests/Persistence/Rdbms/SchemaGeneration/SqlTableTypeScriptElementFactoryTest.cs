...
namespace Remotion.Data.DomainObjects.UnitTests.Persistence.Rdbms.SchemaGeneration
{
  ...
  public class SqlTableTypeScriptElementFactoryTest : SchemaGenerationTestBase
  {
    ...
    private TableTypeDefinition _tableTypeDefinitionWithClusteredUniqueConstraint;
    private TableTypeDefinition _tableTypeDefinitionWithNonClusteredUniqueConstraint;
    ...
    public void GetCreateElement_TableTypeDefinition_Plain ()
    {
      ...
      Assert.That(scriptElements[0], Is.InstanceOf<ScriptStatement>());
      Assert.That(((ScriptStatement)scriptElements[0]).Statement, Is.EqualTo(expectedResult));
      Assert.That(scriptElements[1], Is.InstanceOf<BatchDelimiterStatement>());
    }
    ...
    public void GetDropElement ()
    {
      ...
      Assert.That(result, Is.InstanceOf<ScriptStatement>());
