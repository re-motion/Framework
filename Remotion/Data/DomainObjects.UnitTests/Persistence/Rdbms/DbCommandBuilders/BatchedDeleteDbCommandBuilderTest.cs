...
[TestFixture]
public class BatchedDeleteDbCommandBuilderTest : StandardMappingTest
{
  ...
  public void Create_WithMultipleTablesDefaultSchema ()
  {
    ...
    foreach (var td in new List<TableDefinition> { tableDefinition1, tableDefinition2, tableDefinition3 })
    {
      ...
      commandSpecification.Setup(stub => stub.CreateDbParameter(It.IsAny<DbCommand>(), _sqlDialectStub.Object.GetParameterName("TVP_Delete_" + td.TableName.EntityName)))
