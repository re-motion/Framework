  ...
  public class UnionSelectDbCommandBuilderTest : StandardMappingTest
  {
    ...
    public void Create_WithOneUnionedTable ()
    {
      ...
      _orderedColumnsStub
          ...
          .Callback((StringBuilder stringBuilder, ISqlDialect sqlDialect) => ((StringBuilder)mi.Arguments[0]).Append("[Column1] ASC, [Column2] DESC"));
      ...
      adjustedSelectedColumnsStub
          ...
          .Callback((StringBuilder stringBuilder, ISqlDialect sqlDialect) => ((StringBuilder)mi.Arguments[0]).Append("[Column1], [Column2], [Column3]"));
      ...
      _comparedColumnsStrictMock
          ...
          .Verifiable();
      _comparedColumnsStrictMock
          .Setup(stub => stub.AppendComparisons(
              It.IsAny<StringBuilder>(),
              _dbCommandStub.Object,
              _sqlDialectStub.Object))
          .Callback((StringBuilder statement, IDbCommand command, ISqlDialect sqlDialect) => ((StringBuilder)mi.Arguments[0]).Append("[delimited FKID] = pFKID"))
          .Verifiable();
      ...
      _comparedColumnsStrictMock.Verify (stub => stub.AppendComparisons(
              It.IsAny<StringBuilder>(),
              _dbCommandStub.Object,
              _sqlDialectStub.Object), Times.Once());
    }
    ...
    public void Create_WithSeveralUnionedTables ()
    {
      ...
      adjustedSelectedColumnsStub2
          .Setup(stub => stub.AppendProjection(It.IsAny<StringBuilder>(), _sqlDialectStub.Object))
          .Callback((StringBuilder stringBuilder, ISqlDialect sqlDialect) => ((StringBuilder)mi.Arguments[0]).Append("[Column1], NULL, [Column3]"));
      var adjustedSelectedColumnsStub3 = new Mock<ISelectedColumnsSpecification>();
      adjustedSelectedColumnsStub3
          .Setup(stub => stub.AppendProjection(It.IsAny<StringBuilder>(), _sqlDialectStub.Object))
          .Callback((StringBuilder stringBuilder, ISqlDialect sqlDialect) => ((StringBuilder)mi.Arguments[0]).Append("NULL, [Column2], [Column3]"));
      _fullSelectedColumnsStub
          .Setup(stub => stub.AdjustForTable(_table1))
      ...
      _comparedColumnsStrictMock.Verify (stub => stub.AppendComparisons(
              It.IsAny<StringBuilder>(),
              _dbCommandStub.Object,
              _sqlDialectStub.Object), Times.Exactly (3));
    }
  }
}
