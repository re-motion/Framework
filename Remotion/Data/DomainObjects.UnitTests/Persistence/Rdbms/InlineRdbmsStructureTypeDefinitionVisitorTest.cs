...
namespace Remotion.Data.DomainObjects.UnitTests.Persistence.Rdbms
{
  ...
  public class InlineRdbmsStructureTypeDefinitionVisitorTest : StandardMappingTest
  {
    ...
    {
      void HandleTableTypeDefinition (SqlTableTypeDefinition table, Action<IRdbmsStructuredTypeDefinition> continuation);
    }

    private SqlTableTypeDefinition _tableTypeDefinition;
    ...
    public void Visit_WithoutResult_Continuation_TableTypeDefinition ()
    {
      ...
      _voidReceiverMock
          ...
          .Callback((SqlTableTypeDefinition _, Action<IRdbmsStructuredTypeDefinition> continuation) => continuation(secondTypeDef))
          .Verifiable();
