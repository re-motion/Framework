  ...
  public class TableSerializerTest : SchemaGenerationTestBase
  {
    ...
    public void Serialize_CreatesPersistenceModelProvider ()
    {
      ...
      propertySerializerMock.Setup(
          _ => _.Serialize(
              ...
              It.IsNotNull<IRdbmsPersistenceModelProvider>()))
      ...
      propertySerializerMock.Verify (          _ => _.Serialize(
              It.IsNotNull<PropertyDefinition>(),
              It.IsNotNull<IRdbmsPersistenceModelProvider>()), Times.AtLeastOnce());
    }
    ...
    public void Serialize_OnlyAddsPersistentProperties ()
    {
      ...
      propertySerializerMock.Expect(
          _ => _.Serialize(
              Arg<PropertyDefinition>.Matches(_ => propertyDefinitionConstraint),
              It.IsAny<IRdbmsPersistenceModelProvider>()))
