...
{
  [TestFixture]
  public class SqlTableTypeScriptBuilderTest : SchemaGenerationTestBase
  {
    private Mock<IStructuredTypeScriptElementFactory> _tableTypeScriptFactoryStub;
    private SqlTableTypeScriptBuilder _builder;
    private SqlTableTypeDefinition _tableTypeDefinition1;
    private SqlTableTypeDefinition _tableTypeDefinition2;
    private SqlTableTypeDefinition _tableTypeDefinition3;
    ...
    public override void SetUp ()
    {
      ...
      _builder = new SqlTableTypeScriptBuilder(_tableTypeScriptFactoryStub.Object, new SqlCommentScriptElementFactory());
