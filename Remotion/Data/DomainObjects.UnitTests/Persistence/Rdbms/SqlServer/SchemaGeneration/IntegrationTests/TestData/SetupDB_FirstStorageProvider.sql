...
IF TYPE_ID('[dbo].[TVP_Boolean_distinct]') IS NULL CREATE TYPE [dbo].[TVP_Boolean_distinct] AS TABLE
(
  [Value] bit NULL
...
IF TYPE_ID('[dbo].[TVP_Byte_distinct]') IS NULL CREATE TYPE [dbo].[TVP_Byte_distinct] AS TABLE
(
  [Value] tinyint NULL
  UNIQUE CLUSTERED ([Value])
)
...
IF TYPE_ID('[dbo].[TVP_DateTime_distinct]') IS NULL CREATE TYPE [dbo].[TVP_DateTime_distinct] AS TABLE
(
  [Value] datetime NULL
  UNIQUE CLUSTERED ([Value])
)
...
IF TYPE_ID('[dbo].[TVP_Decimal_distinct]') IS NULL CREATE TYPE [dbo].[TVP_Decimal_distinct] AS TABLE
(
  [Value] decimal (38, 3) NULL
  UNIQUE CLUSTERED ([Value])
)
...
IF TYPE_ID('[dbo].[TVP_Double_distinct]') IS NULL CREATE TYPE [dbo].[TVP_Double_distinct] AS TABLE
(
  [Value] float NULL
  UNIQUE CLUSTERED ([Value])
)
...
IF TYPE_ID('[dbo].[TVP_Guid_distinct]') IS NULL CREATE TYPE [dbo].[TVP_Guid_distinct] AS TABLE
(
  [Value] uniqueidentifier NULL
  UNIQUE CLUSTERED ([Value])
)
...
IF TYPE_ID('[dbo].[TVP_Int16_distinct]') IS NULL CREATE TYPE [dbo].[TVP_Int16_distinct] AS TABLE
(
  [Value] smallint NULL
  UNIQUE CLUSTERED ([Value])
)
...
IF TYPE_ID('[dbo].[TVP_Int32_distinct]') IS NULL CREATE TYPE [dbo].[TVP_Int32_distinct] AS TABLE
(
  [Value] int NULL
  UNIQUE CLUSTERED ([Value])
)
...
IF TYPE_ID('[dbo].[TVP_Int64_distinct]') IS NULL CREATE TYPE [dbo].[TVP_Int64_distinct] AS TABLE
(
  [Value] bigint NULL
  UNIQUE CLUSTERED ([Value])
)
...
IF TYPE_ID('[dbo].[TVP_Single_distinct]') IS NULL CREATE TYPE [dbo].[TVP_Single_distinct] AS TABLE
(
  [Value] real NULL
  UNIQUE CLUSTERED ([Value])
)
