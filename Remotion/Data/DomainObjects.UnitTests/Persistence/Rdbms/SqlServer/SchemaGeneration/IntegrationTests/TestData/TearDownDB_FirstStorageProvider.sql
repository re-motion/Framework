...
DROP TYPE IF EXISTS [dbo].[TVP_Address_Insert]
DROP TYPE IF EXISTS [dbo].[TVP_AllTables_Lock]
DROP TYPE IF EXISTS [dbo].[TVP_Address_Update]
...
DROP TYPE IF EXISTS [dbo].[TVP_TableWithoutProperties_Insert]
DROP TYPE IF EXISTS [dbo].[TVP_TableWithoutProperties_Update]
DROP TYPE IF EXISTS [dbo].[TVP_TableWithRelations_Insert]
DROP TYPE IF EXISTS [dbo].[TVP_TableWithRelations_Update]
DROP TYPE IF EXISTS [dbo].[TVP_Customer_Insert]
DROP TYPE IF EXISTS [dbo].[TVP_Customer_Update]
DROP TYPE IF EXISTS [dbo].[TVP_AbstractClass_Insert]
DROP TYPE IF EXISTS [dbo].[TVP_AbstractClass_Update]
DROP TYPE IF EXISTS [dbo].[TVP_ConcreteClass_Insert]
DROP TYPE IF EXISTS [dbo].[TVP_ConcreteClass_Update]
DROP TYPE IF EXISTS [dbo].[TVP_DevelopmentPartner_Insert]
DROP TYPE IF EXISTS [dbo].[TVP_DevelopmentPartner_Update]
DROP TYPE IF EXISTS [dbo].[TVP_Employee_Insert]
DROP TYPE IF EXISTS [dbo].[TVP_Employee_Update]
DROP TYPE IF EXISTS [dbo].[TVP_FirstClass_Insert]
DROP TYPE IF EXISTS [dbo].[TVP_FirstClass_Update]
DROP TYPE IF EXISTS [dbo].[TVP_MixinAddedTwiceWithDifferentNullability_BaseClassWithDBTable_Insert]
DROP TYPE IF EXISTS [dbo].[TVP_MixinAddedTwiceWithDifferentNullability_BaseClassWithDBTable_Update]
DROP TYPE IF EXISTS [dbo].[TVP_MixinAddedTwiceWithDifferentNullability_TargetClassWithDBTable_Insert]
DROP TYPE IF EXISTS [dbo].[TVP_MixinAddedTwiceWithDifferentNullability_TargetClassWithDBTable_Update]
...
DROP TYPE IF EXISTS [dbo].[TVP_SecondClass_Insert]
DROP TYPE IF EXISTS [dbo].[TVP_SecondClass_Update]
DROP TYPE IF EXISTS [dbo].[TVP_SiblingOfTableWithRelations_Insert]
DROP TYPE IF EXISTS [dbo].[TVP_SiblingOfTableWithRelations_Update]
DROP TYPE IF EXISTS [dbo].[TVP_ThirdClass_Insert]
DROP TYPE IF EXISTS [dbo].[TVP_ThirdClass_Update]
-- Drop all synonyms
-- Drop all indexes
-- Drop all views
