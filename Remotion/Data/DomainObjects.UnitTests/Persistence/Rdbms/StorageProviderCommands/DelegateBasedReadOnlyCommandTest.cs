...
{
  [TestFixture]
  public class DelegateBasedReadOnlyCommandTest
  {
    [Test]
    public void Execute ()
    {
      var executionContext = new Mock<IRdbmsProviderReadOnlyCommandExecutionContext>();
      var innerCommandStub = new Mock<IRdbmsProviderReadOnlyCommand<string>>();
      var delegateBasedCommand = new DelegateBasedReadOnlyCommand<string, int>(innerCommandStub.Object, s => s.Length);
    ...
    public void Create ()
    {
      ...
      Assert.That(instance, Is.TypeOf(typeof(DelegateBasedReadOnlyCommand<string, int>)));
