...
namespace Remotion.Data.DomainObjects.UnitTests.Persistence.Rdbms.StorageProviderCommands
{
  ...
  public class MultiObjectIDLoadCommandTest : StandardMappingTest
  {
    ...
    public void LoadObjectIDsFromCommandBuilder ()
    {
      ...
      _objectIDReaderStub.Setup (stub => stub.ReadSequence (_dataReaderMock.Object)).Returns (enumerableStub.Object);
      ...
      var result =
          (IEnumerable<ObjectID>)PrivateInvoke.InvokeNonPublicMethod(command, "LoadObjectIDsFromCommandBuilder", _dbCommandBuilder1Mock.Object, _commandExecutionContextStub.Object);
      result.ToArray();
