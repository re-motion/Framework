  ...
  public class QueryCommandFactoryTest : StandardMappingTest
  {
    ...
    public void CreateForDataContainerQuery ()
    {
      ...
      _dbCommandBuilderFactoryStrictMock
          .Setup(
              stub => stub.CreateForQuery("statement", expectedParametersWithType))
    ...
    public void CreateForScalarQuery ()
    {
      ...
      _dataStoragePropertyDefinitionFactoryStrictMock
          ...
          .Returns(_property3)
          .Verifiable();
      _dataStoragePropertyDefinitionFactoryStrictMock.Object.Replay();
      ...
      _dbCommandBuilderFactoryStrictMock
          ...
          .Returns(commandBuilderStub.Object)
          .Verifiable();
      _dbCommandBuilderFactoryStrictMock.Object.Replay();
