...
public class BatchedSaveCommandFactoryTest : StandardMappingTest
{
  ...
  public override void SetUp ()
  {
    ...
    _factory = new BatchedSaveCommandFactory(
        ...
        Mock.Of<ITableManipulationRecordDefinitionProvider>());
  ...
  public void CreateForSave_New ()
  {
    ...
    Assert.That(result, Is.TypeOf(typeof(BatchedDataContainerSaveCommand)));
    var contexts = ((BatchedDataContainerSaveCommand)result).Contexts.Cast<SingleObjectMultiDataContainerSaveCommandContext>().ToList();

    Assert.That(contexts.Count, Is.EqualTo(5));
    Assert.That(contexts[0].ObjectID, Is.EqualTo(dataContainerNew1.ID));
    Assert.That(contexts[0].CommandBuilder, Is.SameAs(insertDbCommandBuilderNew1.Object));
    Assert.That(contexts[1].ObjectID, Is.EqualTo(dataContainerNew2.ID));
    Assert.That(contexts[1].CommandBuilder, Is.SameAs(insertDbCommandBuilderNew2.Object));
    Assert.That(contexts[2].ObjectID, Is.EqualTo(dataContainerNewWithoutRelations.ID));
    Assert.That(contexts[2].CommandBuilder, Is.SameAs(insertDbCommandBuilderNew3.Object));
    Assert.That(contexts[3].ObjectID, Is.EqualTo(dataContainerNew1.ID));
    Assert.That(contexts[3].CommandBuilder, Is.SameAs(updateDbCommandBuilderNew1.Object));
    Assert.That(contexts[4].ObjectID, Is.EqualTo(dataContainerNew2.ID));
    Assert.That(contexts[4].CommandBuilder, Is.SameAs(updateDbCommandBuilderNew2.Object));
  }
  ...
  public void CreateForSave_Changed ()
  {
    ...
    Assert.That(contexts[0].ObjectID, Is.EqualTo(dataContainerChangedSerialNumber.ID));
    Assert.That(contexts[0].CommandBuilder, Is.SameAs(updateDbCommandBuilderChangedSerialNumber.Object));
    Assert.That(contexts[1].ObjectID, Is.EqualTo(dataContainerChangedEmployee.ID));
    Assert.That(contexts[1].CommandBuilder, Is.SameAs(updateDbCommandBuilderChangedEmployee.Object));
    Assert.That(contexts[2].ObjectID, Is.EqualTo(dataContainerChangedMarkedAsChanged.ID));
    Assert.That(contexts[2].CommandBuilder, Is.SameAs(updateDbCommandBuilderMarkedAsChanged.Object));
  }
  ...
  public void CreateForSave_Deleted ()
  {
    ...
    Assert.That(contexts.Count, Is.EqualTo(5));
    Assert.That(contexts[0].ObjectID, Is.EqualTo(dataContainerDeletedWithRelations1.ID));
    Assert.That(contexts[0].CommandBuilder, Is.SameAs(updateDbCommandBuilderDeleted2.Object));
    Assert.That(contexts[1].ObjectID, Is.EqualTo(dataContainerDeletedWithRelations2.ID));
    Assert.That(contexts[1].CommandBuilder, Is.SameAs(updateDbCommandBuilderDeleted3.Object));
    Assert.That(contexts[2].ObjectID, Is.EqualTo(dataContainerDeletedWithoutRelations.ID));
    Assert.That(contexts[2].CommandBuilder, Is.SameAs(deleteDbCommandBuilderDeleted1.Object));
    Assert.That(contexts[3].ObjectID, Is.EqualTo(dataContainerDeletedWithRelations1.ID));
    Assert.That(contexts[3].CommandBuilder, Is.SameAs(deleteDbCommandBuilderDeleted2.Object));
    Assert.That(contexts[4].ObjectID, Is.EqualTo(dataContainerDeletedWithRelations2.ID));
    Assert.That(contexts[4].CommandBuilder, Is.SameAs(deleteDbCommandBuilderDeleted3.Object));
  }
  ...
  public void CreateForSave_Unchanged ()
  {
    ...
    _tableDefinitionFinderStrictMock.Verify();
    Assert.That(result, Is.TypeOf(typeof(BatchedDataContainerSaveCommand)));
    var tuples = ((BatchedDataContainerSaveCommand)result).Contexts.ToList();
