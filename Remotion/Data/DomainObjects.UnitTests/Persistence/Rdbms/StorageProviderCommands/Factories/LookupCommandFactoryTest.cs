      ...
      _objectReaderFactoryStrictMock
          .Setup(
              mock => mock.CreateDataContainerReader(
                  (IRdbmsStorageEntityDefinition)_tableDefinition1,
                  expectedSelectedColumns))
    ...
    public void CreateForSortedMultiIDLookup_TableDefinition_MultipleIDLookup_AndMultipleTables ()
    {
      ...
      _dbCommandBuilderFactoryStrictMock
          .Setup(
              stub => stub.CreateForSelect(
                  _tableDefinition2,
                  _tableDefinition2.GetAllColumns(),
                  expectedComparedColumns2,
                  new OrderedColumn[0]))
      ...
      _objectReaderFactoryStrictMock
          .Setup(
              mock => mock.CreateDataContainerReader(
                  (IRdbmsStorageEntityDefinition)_tableDefinition2,
                  expectedSelectedColumns2))
