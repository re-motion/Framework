...
{
  [TestFixture]
  public class RdbmsStorageSettingsFactoryTest
  {
    [Test]
    public void Create_CreatesStorageSettingsObject ()
    {
      ...
      var defaultProvider = storageSettings.GetDefaultStorageProviderDefinition();
      Assert.That(defaultProvider, Is.InstanceOf<RdbmsProviderDefinition>());
