...
namespace Remotion.Data.DomainObjects.UnitTests.Serialization
{
  ...
  public class DomainObjectCollectionEndPointTest : ClientTransactionBaseTest
  {
    ...
    public override void SetUp ()
    {
      ...
      _endPoint =
          (DomainObjectCollectionEndPoint)((StateUpdateRaisingDomainObjectCollectionEndPointDecorator)TestableClientTransaction.DataManager.GetRelationEndPointWithoutLoading(
              endPointID)).InnerEndPoint;
