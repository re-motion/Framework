...
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.Views WHERE TABLE_NAME = 'ComplexOrderView' AND TABLE_SCHEMA = 'dbo')
  DROP VIEW [dbo].[ComplexOrderView]
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.Views WHERE TABLE_NAME = 'IInterfaceWithOneImplementorView' AND TABLE_SCHEMA = 'dbo')
  DROP VIEW [dbo].[IInterfaceWithOneImplementorView]
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.Views WHERE TABLE_NAME = 'IInterfaceWithoutImplementorsView' AND TABLE_SCHEMA = 'dbo')
  DROP VIEW [dbo].[IInterfaceWithoutImplementorsView]
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.Views WHERE TABLE_NAME = 'Implementor1View' AND TABLE_SCHEMA = 'dbo')
  DROP VIEW [dbo].[Implementor1View]
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.Views WHERE TABLE_NAME = 'Implementor2View' AND TABLE_SCHEMA = 'dbo')
  DROP VIEW [dbo].[Implementor2View]
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.Views WHERE TABLE_NAME = 'IOrderView' AND TABLE_SCHEMA = 'dbo')
  DROP VIEW [dbo].[IOrderView]
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.Views WHERE TABLE_NAME = 'IOrderGroupView' AND TABLE_SCHEMA = 'dbo')
  DROP VIEW [dbo].[IOrderGroupView]
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.Views WHERE TABLE_NAME = 'IOrderItemView' AND TABLE_SCHEMA = 'dbo')
  DROP VIEW [dbo].[IOrderItemView]
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.Views WHERE TABLE_NAME = 'OnlyImplementorView' AND TABLE_SCHEMA = 'dbo')
  DROP VIEW [dbo].[OnlyImplementorView]
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.Views WHERE TABLE_NAME = 'OrderGroupView' AND TABLE_SCHEMA = 'dbo')
  DROP VIEW [dbo].[OrderGroupView]
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.Views WHERE TABLE_NAME = 'SimpleOrderView' AND TABLE_SCHEMA = 'dbo')
  DROP VIEW [dbo].[SimpleOrderView]
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.Views WHERE TABLE_NAME = 'SimpleOrderItemView' AND TABLE_SCHEMA = 'dbo')
  DROP VIEW [dbo].[SimpleOrderItemView]
...
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.Tables WHERE TABLE_NAME = 'ComplexOrder' AND TABLE_SCHEMA = 'dbo')
  DROP TABLE [dbo].[ComplexOrder]
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.Tables WHERE TABLE_NAME = 'Implementor1' AND TABLE_SCHEMA = 'dbo')
  DROP TABLE [dbo].[Implementor1]
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.Tables WHERE TABLE_NAME = 'Implementor2' AND TABLE_SCHEMA = 'dbo')
  DROP TABLE [dbo].[Implementor2]
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.Tables WHERE TABLE_NAME = 'OnlyImplementor' AND TABLE_SCHEMA = 'dbo')
  DROP TABLE [dbo].[OnlyImplementor]
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.Tables WHERE TABLE_NAME = 'OrderGroup' AND TABLE_SCHEMA = 'dbo')
  DROP TABLE [dbo].[OrderGroup]
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.Tables WHERE TABLE_NAME = 'SimpleOrder' AND TABLE_SCHEMA = 'dbo')
  DROP TABLE [dbo].[SimpleOrder]
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.Tables WHERE TABLE_NAME = 'SimpleOrderItem' AND TABLE_SCHEMA = 'dbo')
  DROP TABLE [dbo].[SimpleOrderItem]
