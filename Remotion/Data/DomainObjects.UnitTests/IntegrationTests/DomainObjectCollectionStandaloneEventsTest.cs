  ...
  public class DomainObjectCollectionStandaloneEventsTest : ClientTransactionBaseTest
  {
    ...
    public void Clear_Events ()
    {
      ...
      _eventReceiverMock
            .InSequence (sequence)
            .Setup(
                mock => mock.OnRemoving(It.Is<DomainObjectCollectionChangeEventArgs> (args => args.DomainObject == _itemA)))
            .Callback((DomainObjectCollectionChangeEventArgs args) => Assert.That(_collection, Is.EqualTo(new[] { _itemA, _itemB })))
            .Verifiable();
      _eventReceiverMock
            .InSequence (sequence)
      ...
      _eventReceiverMock
            .InSequence (sequence)
            .Setup(
                mock => mock.OnRemoved(It.Is<DomainObjectCollectionChangeEventArgs> (args => args.DomainObject == _itemB)))
