...
.Verify (mock => mock.ConnectionOpened(It.IsAny<Guid>()), Times.AtLeastOnce());
      _persistenceExtensionMock
.Verify (              mock => mock.QueryExecuting(
                  It.IsAny<Guid>(), It.IsAny<Guid>(), It.IsAny<string>(), It.IsAny<IDictionary<string, object>>()), Times.AtLeastOnce());
      _persistenceExtensionMock
.Verify (mock => mock.QueryExecuted(It.IsAny<Guid>(), It.IsAny<Guid>(), It.IsAny<TimeSpan>()), Times.AtLeastOnce());
    ...
    public void NoIteration_DoesNotOpenConnection ()
    {
      ...
      _persistenceExtensionMock
.Verify (mock => mock.ConnectionOpened(It.IsAny<Guid>()), Times.Never());
      _persistenceExtensionMock
.Verify (              mock => mock.QueryExecuting(
                  It.IsAny<Guid>(), It.IsAny<Guid>(), It.IsAny<string>(), It.IsAny<IDictionary<string, object>>()), Times.Never());
      _persistenceExtensionMock
.Verify (mock => mock.QueryExecuted(It.IsAny<Guid>(), It.IsAny<Guid>(), It.IsAny<TimeSpan>()), Times.Never());
      _persistenceExtensionMock
.Verify (              mock => mock.QueryCompleted(It.IsAny<Guid>(), It.IsAny<Guid>(), It.IsAny<TimeSpan>(), It.IsAny<int>()), Times.Never());
