...
public class TableValuedParametersIntegrationTest : ClientTransactionBaseTest
{
  ...
  public void Contains_WithEmptyCollection ()
  {
    ...
    var query = QueryFactory.CreateQuery(
        new QueryDefinition("Test", TestDomainStorageProviderDefinition, "SELECT * FROM [Order] o WHERE o.[ID] IN (SELECT [Value] FROM @1)", QueryType.Collection),
  ...
  public void Contains_UsingTableValuedParameter_NullValue ()
  {
    ...
    var query = QueryFactory.CreateQuery(
        new QueryDefinition("Test", TestDomainStorageProviderDefinition, "SELECT * FROM [Order] o WHERE o.[OrderNumber] IN (SELECT [Value] FROM @1)", QueryType.Collection),
  ...
  public void Contains_UsingTableValuedParameter_Int ()
  {
    ...
    var query = QueryFactory.CreateQuery(
        new QueryDefinition("Test", TestDomainStorageProviderDefinition, "SELECT * FROM [Order] o WHERE o.[OrderNo] IN (SELECT [Value] FROM @1)", QueryType.Collection),
        new QueryParameterCollection { { "@1", orderNumbers } });
  ...
  public void Contains_UsingTableValuedParameter_DateTime ()
  {
    ...
    var query = QueryFactory.CreateQuery(
        new QueryDefinition("Test", TestDomainStorageProviderDefinition, "SELECT * FROM [Order] o WHERE o.[DeliveryDate] IN (SELECT [Value] FROM @1)", QueryType.Collection),
  ...
  public void Contains_UsingTableValuedParameter_String ()
  {
    ...
    var query = QueryFactory.CreateQuery(
        new QueryDefinition("Test", TestDomainStorageProviderDefinition, "SELECT * FROM [OrderItem] o WHERE o.[Product] IN (SELECT [Value] FROM @1)", QueryType.Collection),
  ...
  public void Contains_UsingTableValuedParameter_Decimal ()
  {
    ...
    var query = QueryFactory.CreateQuery(
        new QueryDefinition("Test", TestDomainStorageProviderDefinition, "SELECT * FROM [Product] o WHERE o.[Price] IN (SELECT [Value] FROM @1)", QueryType.Collection),
  ...
  public void Contains_UsingTableValuedParameter_Enum ()
  {
    ...
    var query = QueryFactory.CreateQuery(
        new QueryDefinition("Test", TestDomainStorageProviderDefinition, "SELECT * FROM [TableWithAllDataTypes] o WHERE o.[Enum] IN (SELECT [Value] FROM @1)", QueryType.Collection),
  ...
  public void Contains_UsingTableValuedParameter_Double ()
  {
    ...
    var query = QueryFactory.CreateQuery(
        new QueryDefinition("Test", TestDomainStorageProviderDefinition, "SELECT * FROM [TableWithAllDataTypes] o WHERE o.[Double] IN (SELECT [Value] FROM @1)", QueryType.Collection),
        new QueryParameterCollection { { "@1", values } });
  ...
  public void Contains_UsingTableValuedParameter_ExtensibleEnum ()
  {
    ...
    var query = QueryFactory.CreateQuery(
        new QueryDefinition("Test", TestDomainStorageProviderDefinition, "SELECT * FROM [TableWithAllDataTypes] o WHERE o.[ExtensibleEnum] IN (SELECT [Value] FROM @1)", QueryType.Collection),
        new QueryParameterCollection { { "@1", values } });
  ...
  public void From ()
  {
    ...
    var query = QueryFactory.CreateQuery(
        new QueryDefinition("Test", TestDomainStorageProviderDefinition, "SELECT [possible].[Value] FROM @1 [possible]", QueryType.Custom),
        new QueryParameterCollection { { "@1", possibleItems } });
  ...
  public void Join ()
  {
    ...
    var query = QueryFactory.CreateQuery(
        new QueryDefinition("Test", TestDomainStorageProviderDefinition, "SELECT o.* FROM [Order] o INNER JOIN @1 [possible] ON o.[ID] = [possible].[Value]", QueryType.Collection),
        new QueryParameterCollection { { "@1", possibleItems } });
