...
namespace Remotion.Data.DomainObjects.UnitTests.IntegrationTests.Transaction
{
  ...
  public class SubTransactionNewObjectGetObjectTest : ClientTransactionBaseTest
  {
    ...
    public void GetObjects_UnloadedObjects_PropagatedToParent ()
    {
      ...
      extensionMock.Verify (mock => mock.ObjectsLoading(parent,
          new[] { DomainObjectIDs.Order1, DomainObjectIDs.Order3, DomainObjectIDs.OrderItem1 }), Times.AtLeastOnce());
      extensionMock.Verify (mock => mock.ObjectsLoading(parent,
          It.Is<ReadOnlyCollection<ObjectID>> (_ => new[] { DomainObjectIDs.ClassWithAllDataTypes1 }.All (_.Contains))), Times.Never());
    }
