  ...
  public class FilterQueryResultEventsTest : ReadOnlyTransactionsTestBase
  {
    ...
    public void FilterQueryResult_RaisedInAllHierarchyLevels ()
    {
      ...
      ExtensionStrictMock
            ...
            .Callback((ClientTransaction clientTransaction, QueryResult<DomainObject> queryResult) => Assert.That(ReadOnlyRootTransaction.IsWriteable, Is.False))
            .Verifiable();
      ExtensionStrictMock
            .Setup(
                mock => mock.FilterQueryResult(
            ...
            .Callback((ClientTransaction clientTransaction, QueryResult<DomainObject> queryResult) => Assert.That(ReadOnlyMiddleTransaction.IsWriteable, Is.False))
            .Verifiable();
      ExtensionStrictMock
            .Setup(
                mock => mock.FilterQueryResult(
            ...
            .Callback((ClientTransaction clientTransaction, QueryResult<DomainObject> queryResult) => Assert.That(WriteableSubTransaction.IsWriteable, Is.True))
            .Verifiable();
    ...
    public void FilterCustomQueryResult_RaisedInAllHierarchyLevels ()
    {
      ...
      ListenerDynamicMock
            ...
            .Callback((ClientTransaction clientTransaction, IQuery query, IEnumerable<IQueryResultRow> results) => Assert.That(ReadOnlyRootTransaction.IsWriteable, Is.False))
            .Verifiable();
      ...
      ListenerDynamicMock
            ...
            .Callback((ClientTransaction clientTransaction, IQuery query, IEnumerable<IQueryResultRow> results) => Assert.That(ReadOnlyMiddleTransaction.IsWriteable, Is.False))
            .Verifiable();
      ...
      ListenerDynamicMock
            ...
            .Callback((ClientTransaction clientTransaction, IQuery query, IEnumerable<IQueryResultRow> results) => Assert.That(WriteableSubTransaction.IsWriteable, Is.True))
            .Verifiable();
