  ...
  public class ModificationsInLoadEventTest : ReadOnlyTransactionsTestBase
  {
    ...
    public void OnLoaded_CanModifyThisObject_UnidirectionalRelations ()
    {
      ...
      _loadEventReceiverMock
            ...
            .Callback((DomainObject domainObject) => CheckTransactionAndSetProperty(ReadOnlyRootTransaction, _location, l => l.Client, expectedValue: _client1, newValue: _client2))
            .Verifiable();
      _loadEventReceiverMock
            .InSequence (sequence)
            .Setup(mock => mock.OnLoaded(_location))
            .Callback((DomainObject domainObject) => CheckTransactionAndSetProperty(ReadOnlyMiddleTransaction, _location, l => l.Client, expectedValue: _client2, newValue: _client3))
            .Verifiable();
      _loadEventReceiverMock
            .InSequence (sequence)
            .Setup(mock => mock.OnLoaded(_location))
            .Callback((DomainObject domainObject) => CheckTransactionAndSetProperty(WriteableSubTransaction, _location, l => l.Client, expectedValue: _client3, newValue: _client4))
            .Verifiable();
