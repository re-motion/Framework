...
namespace Remotion.Data.DomainObjects.UnitTests.IntegrationTests.Transaction
{
  ...
  public class SubTransactionExtensionTest : ClientTransactionBaseTest
  {
        ...
        ObjectID expectedRelatedID)
    {
      ...
      extensionMock
          .InVerifiableSequence(sequence)
          .Setup(mock => mock.ObjectsLoaded(_subTransaction.ParentTransaction, It.IsNotNull<IReadOnlyList<IDomainObject>>()))
          .Verifiable();
      ...
      extensionMock
          .InVerifiableSequence(sequence)
          .Setup(mock => mock.ObjectsLoaded(_subTransaction, It.IsNotNull<IReadOnlyList<IDomainObject>>()))
          .Verifiable();
      extensionMock
          .InVerifiableSequence(sequence)
          .Setup(mock => mock.RelationReading(_subTransaction, It.IsNotNull<IDomainObject>(), It.IsNotNull<IRelationEndPointDefinition>(), ValueAccess.Current))
          .Verifiable();
