...
namespace Remotion.Data.DomainObjects.UnitTests.IntegrationTests.Transaction
{
  ...
  public class SubTransactionExtensionTest : ClientTransactionBaseTest
  {
    ...
    public void NewObjectCreation ()
    {
      ...
      extensionMock.InSequence(sequence).Setup(mock => mock.NewObjectCreating(_subTransaction, typeof(Order))).Verifiable();
    ...
    public void ObjectLoading ()
    {
      ...
      extensionMock
          .InSequence(sequence)
          .Setup(mock => mock.ObjectsLoaded(_subTransaction.ParentTransaction, It.Is<ReadOnlyCollection<IDomainObject>>(list => list.Count == 1)))
          .Verifiable();
      extensionMock
          .InSequence(sequence)
      ...
      extensionMock
          .InSequence(sequence)
          .Setup(mock => mock.ObjectsLoaded(_subTransaction, It.Is<ReadOnlyCollection<IDomainObject>>(list => list.Count == 1)))
          .Verifiable();
        ...
        ObjectID expectedRelatedID)
    {
      ...
      extensionMock
          .InSequence(sequence)
          .Setup(mock => mock.ObjectsLoaded(_subTransaction.ParentTransaction, It.Is<IReadOnlyList<IDomainObject>>(_ => _ != null)))
          .Verifiable();
      extensionMock.InSequence(sequence).Setup(mock => mock.ObjectsLoading(_subTransaction, new[] { expectedMainObjectID })).Verifiable();
      extensionMock
          .InSequence(sequence)
          .Setup(mock => mock.ObjectsLoaded(_subTransaction, It.Is<IReadOnlyList<IDomainObject>>(_ => _ != null)))
          .Verifiable();
      extensionMock
          .InSequence(sequence)
          .Setup(mock => mock.RelationReading(_subTransaction, It.IsAny<IDomainObject>(), It.IsAny<IRelationEndPointDefinition>(), It.IsAny<ValueAccess>()))
          .Verifiable();
      if (expectLoadEventsForRelatedObject)
      {
        ...
        extensionMock
            .InSequence(sequence)
            .Setup(mock => mock.ObjectsLoaded(_subTransaction.ParentTransaction, It.IsAny<IReadOnlyList<IDomainObject>>()))
            .Verifiable();
        extensionMock
            .InSequence(sequence)
        ...
        extensionMock
            .InSequence(sequence)
            .Setup(mock => mock.ObjectsLoaded(_subTransaction, It.IsAny<IReadOnlyList<IDomainObject>>()))
            .Verifiable();
      }
      ...
      extensionMock
          ...
          .Setup(
              mock => mock.RelationRead(
                  ...
                  It.IsAny<IDomainObject>(),
                  It.IsAny<IRelationEndPointDefinition>(),
                  It.IsAny<IReadOnlyCollectionData<IDomainObject>>(),
                  It.IsAny<ValueAccess>()))
          .Verifiable();
      ...
      extensionMock
          ...
          .Setup(
              mock => mock.RelationReading(
                  ...
                  It.IsAny<IDomainObject>(),
                  It.IsAny<IRelationEndPointDefinition>(),
                  It.IsAny<ValueAccess>())).Verifiable();
      extensionMock
          .InSequence(sequence)
          .Setup(
              mock => mock.RelationRead(
    ...
    public void ObjectDelete ()
    {
      ...
      extensionMock.InSequence(sequence).Setup(mock => mock.ObjectDeleting(_subTransaction, computer)).Verifiable();

      computerEventReceiver.InSequence(sequence).Setup(mock => mock.Deleting(computer, EventArgs.Empty)).Verifiable();

      computerEventReceiver.InSequence(sequence).Setup(mock => mock.Deleted(computer, EventArgs.Empty)).Verifiable();

      extensionMock.InSequence(sequence).Setup(mock => mock.ObjectDeleted(_subTransaction, computer)).Verifiable();
    ...
    public void ObjectDeleteWithOldRelatedObjects ()
    {
      ...
      extensionMock.InSequence(sequence).Setup(mock => mock.ObjectDeleting(_subTransaction, _order1)).Verifiable();

      order1MockEventReceiver.InSequence(sequence).Setup(mock => mock.Deleting(_order1, EventArgs.Empty)).Verifiable();
      ...
      order1MockEventReceiver.InSequence(sequence).Setup(mock => mock.Deleted(_order1, EventArgs.Empty)).Verifiable();

      extensionMock.InSequence(sequence).Setup(mock => mock.ObjectDeleted(_subTransaction, _order1)).Verifiable();
      _order1.Delete();
    ...
    public void GetRelatedObjectWithLazyLoad ()
    {
      ...
      extensionMock
          .InSequence(sequence)
          .Setup(mock => mock.ObjectsLoaded(_subTransaction.ParentTransaction, It.Is<IReadOnlyList<IDomainObject>>(_ => _.Count == 1)))
          .Verifiable();
      extensionMock
          .InSequence(sequence)
      ...
      extensionMock
          .InSequence(sequence)
          .Setup(mock => mock.ObjectsLoaded(_subTransaction, It.Is<IReadOnlyList<IDomainObject>>(list => list.Count == 1)))
          .Verifiable();
      extensionMock
          .InSequence(sequence)
          .Setup(
    ...
    public void GetRelatedObjectsWithLazyLoad ()
    {
      ...
      extensionMock
          .InSequence(sequence)
          .Setup(mock => mock.ObjectsLoaded(_subTransaction.ParentTransaction, It.Is<IReadOnlyList<IDomainObject>>(_ => _.Count == 2)))
          .Verifiable();
      extensionMock
          .InSequence(sequence)
      ...
      extensionMock
          .InSequence(sequence)
          .Setup(mock => mock.ObjectsLoaded(_subTransaction, It.Is<IReadOnlyList<IDomainObject>>(_ => _.Count == 2)))
          .Verifiable();
    ...
    public void GetOriginalRelatedObjectWithLazyLoad ()
    {
      ...
      extensionMock
          .InSequence(sequence)
          .Setup(mock => mock.ObjectsLoaded(_subTransaction, It.Is<IReadOnlyList<IDomainObject>>(_ => _.Count == 1)))
          .Verifiable();
      extensionMock
          .InSequence(sequence)
          .Setup(
    ...
    public void GetOriginalRelatedObjectsWithLazyLoad_ForDomainObjectCollection ()
    {
      ...
      extensionMock
          .InSequence(sequence)
          .Setup(mock => mock.ObjectsLoaded(_subTransaction.ParentTransaction, It.Is<IReadOnlyList<IDomainObject>>(list => list.Count == 2)))
          .Verifiable();
      extensionMock
          .InSequence(sequence)
      ...
      extensionMock
          .InSequence(sequence)
          .Setup(mock => mock.ObjectsLoaded(_subTransaction, It.Is<IReadOnlyList<IDomainObject>>(list => list.Count == 2)))
          .Verifiable();
      extensionMock
          .InSequence(sequence)
          .Setup(
    ...
    public void GetOriginalRelatedObjectsWithLazyLoad_ForVirtualCollection ()
    {
      ...
      extensionMock
          .InSequence(sequence)
          .Setup(mock => mock.ObjectsLoaded(_subTransaction.ParentTransaction, It.Is<IReadOnlyList<IDomainObject>>(list => list.Count == 3)))
          .Verifiable();
      extensionMock
          .InSequence(sequence)
      ...
      extensionMock
          .InSequence(sequence)
          .Setup(mock => mock.ObjectsLoaded(_subTransaction, It.Is<IReadOnlyList<IDomainObject>>(list => list.Count == 3)))
          .Verifiable();
      extensionMock
          .InSequence(sequence)
          .Setup(
    ...
    public void FilterQueryResultWithLoad ()
    {
      ...
      extensionMock
          .InSequence(sequence)
          .Setup(mock => mock.ObjectsLoaded(_subTransaction.ParentTransaction, It.Is<ReadOnlyCollection<IDomainObject>>(list => list.Count == 2)))
          .Verifiable();
      extensionMock
          .InSequence(sequence)
          .Setup(mock => mock.FilterQueryResult(_subTransaction.ParentTransaction, It.Is<QueryResult<DomainObject>>(qr => qr.Count == 2 && qr.Query == query)))
    ...
    public void CommitWithChangedPropertyValue ()
    {
      ...
      extensionMock
          ...
          .Verifiable();
      extensionMock.InSequence(sequence).Setup(mock => mock.Committed(_subTransaction, new[] { computer })).Verifiable();
    ...
    public void CommitWithChangedRelationValue ()
    {
      ...
      extensionMock
          .InSequence(sequence)
          .Setup(mock => mock.Committed(_subTransaction, It.Is<ReadOnlyCollection<IDomainObject>>(p => p.SetEquals(new DomainObject[] { computer, employee }))))
          .Verifiable();
    ...
    public void CommitWithChangedRelationValueWithClassIDColumn ()
    {
      ...
      extensionMock
          .InSequence(sequence)
          .Setup(mock => mock.Committed(_subTransaction, It.Is<ReadOnlyCollection<IDomainObject>>(p => p.SetEquals(new DomainObject[] { _order1, newCustomer, oldCustomer }))))
          .Verifiable();
    ...
    public void CommitWithEvents ()
    {
      ...
      extensionMock
          ...
          .Setup(mock => mock.Committing(_subTransaction, new[] { computer }, It.IsNotNull<CommittingEventRegistrar>()))
          .Verifiable();
      clientTransactionMockEventReceiver.InSequence(sequence).SetupCommitting(_subTransaction, computer).Verifiable();
      computerEventReveiver.InSequence(sequence).Setup(mock => mock.Committing(computer, It.IsAny<DomainObjectCommittingEventArgs>())).Verifiable();
      extensionMock
          .InSequence(sequence)
          .Setup(mock => mock.CommitValidate(_subTransaction, It.Is<ReadOnlyCollection<PersistableData>>(c => c.Select(d => d.DomainObject).SetEquals(new[] { computer }))))
          .Verifiable();
      computerEventReveiver.InSequence(sequence).Setup(mock => mock.Committed(computer, It.IsAny<EventArgs>())).Verifiable();
      clientTransactionMockEventReceiver.InSequence(sequence).SetupCommitted(_subTransaction, computer).Verifiable();
      extensionMock.InSequence(sequence).Setup(mock => mock.Committed(_subTransaction, new[] { computer })).Verifiable();
    ...
    public void Rollback ()
    {
      ...
      extensionMock
          .InSequence(sequence)
          .Setup(mock => mock.RollingBack(_subTransaction, It.Is<IReadOnlyList<IDomainObject>>(_ => _.Contains(computer))))
          .Verifiable();
      extensionMock
          .InSequence(sequence)
          .Setup(mock => mock.RolledBack(_subTransaction, It.Is<IReadOnlyList<IDomainObject>>(_ => _.Contains(computer))))
          .Verifiable();
    ...
    public void GetObjects ()
    {
      ...
      extensionMock
          .InSequence(sequence)
          .Setup(mock => mock.ObjectsLoaded(_subTransaction, It.Is<ReadOnlyCollection<IDomainObject>>(list => list.Count == 2)))
          .Verifiable();
    ...
    public void UnloadData ()
    {
      ...
      extensionMock
          ...
          .Callback((ClientTransaction _, IReadOnlyList<IDomainObject> _) => Assert.That(_subTransactionDataManager.DataContainers[_order1.ID] != null))
          .Verifiable();
      extensionMock
          .InSequence(sequence)
          .Setup(mock => mock.ObjectsUnloading(_subTransaction.ParentTransaction, new[] { _order1 }))
          .Callback((ClientTransaction _, IReadOnlyList<IDomainObject> _) => Assert.That(_parentTransactionDataManager.DataContainers[_order1.ID] != null))
          .Verifiable();
      extensionMock
          .InSequence(sequence)
