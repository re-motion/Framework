  ...
  public class UnloadAllTest : UnloadTestBase
  {
    ...
    public void Events ()
    {
      ...
      clientTransactionListener
            ...
            .Verifiable();
      unloadEventReceiver
            .InSequence (sequence).Setup (mock => mock.OnUnloading (order1)).Verifiable();
      unloadEventReceiver
            .InSequence (sequence).Setup (mock => mock.OnUnloading (order3)).Verifiable();

      using (mockRepository.Unordered())
        {
          clientTransactionListener.Setup (
              mock => mock.RelationEndPointMapUnregistering (TestableClientTransaction, RelationEndPointID.Resolve (order1, o => o.Customer))).Verifiable();
          clientTransactionListener.Setup (
              mock => mock.RelationEndPointMapUnregistering (TestableClientTransaction, RelationEndPointID.Resolve (order1, o => o.Official))).Verifiable();
          clientTransactionListener.Setup (
              mock => mock.RelationEndPointMapUnregistering (TestableClientTransaction, RelationEndPointID.Resolve (order1, o => o.OrderTicket))).Verifiable();
          clientTransactionListener.Setup (
              mock => mock.RelationEndPointMapUnregistering (TestableClientTransaction, RelationEndPointID.Resolve (order3, o => o.Customer))).Verifiable();
          clientTransactionListener.Setup (
              mock => mock.RelationEndPointMapUnregistering (TestableClientTransaction, RelationEndPointID.Resolve (order3, o => o.Official))).Verifiable();
          clientTransactionListener.Setup (
              mock => mock.RelationEndPointMapUnregistering (TestableClientTransaction, RelationEndPointID.Resolve (order3, o => o.OrderTicket))).Verifiable();

          clientTransactionListener.Setup (mock => mock.DataContainerMapUnregistering (TestableClientTransaction, order1.InternalDataContainer)).Verifiable();
          clientTransactionListener.Setup (mock => mock.DataContainerMapUnregistering (TestableClientTransaction, order3.InternalDataContainer)).Verifiable();
        }
      unloadEventReceiver
            .InSequence (sequence).Setup (mock => mock.OnUnloaded (order3)).Verifiable();
      unloadEventReceiver
            .InSequence (sequence).Setup (mock => mock.OnUnloaded (order1)).Verifiable();
      clientTransactionListener
            .InSequence (sequence)
            .Setup(
    ...
    public void Events_New ()
    {
      ...
      clientTransactionListener
            ...
            .Setup(
                ...
                mock.ObjectsUnloading(
                    TestableClientTransaction, new[] { order }))
            .Verifiable();
      unloadEventReceiver
            .InSequence (sequence).Setup (mock => mock.OnUnloading (order)).Verifiable();

      using (mockRepository.Unordered())
        {
          clientTransactionListener.Setup (
              mock => mock.RelationEndPointMapUnregistering (TestableClientTransaction, It.IsAny<RelationEndPointID>())).Verifiable();

          clientTransactionListener.Setup (mock => mock.DataContainerMapUnregistering (TestableClientTransaction, order.InternalDataContainer)).Verifiable();
          clientTransactionListener.Setup (mock => mock.ObjectMarkedInvalid (TestableClientTransaction, order)).Verifiable();
        }
      unloadEventReceiver
            .InSequence (sequence).Setup (mock => mock.OnUnloaded (order)).Verifiable();
      clientTransactionListener
            .InSequence (sequence)
            .Setup(
                mock =>
      ...
      clientTransactionListener.Verify (              mock => mock.RelationEndPointMapUnregistering (TestableClientTransaction, It.IsAny<RelationEndPointID>()), Times.AtLeastOnce());
      unloadEventReceiver.Verify();
    }
      ...
      using (ClientTransaction.Current.CreateSubTransaction().EnterDiscardingScope())
      {
        ...
        using (ClientTransaction.Current.CreateSubTransaction().EnterDiscardingScope())
        {
          ...
          using (ClientTransaction.Current.CreateSubTransaction().EnterDiscardingScope())
          {
            ...
            clientTransactionListener.Verify (                mock => mock.DataContainerMapUnregistering(middleTopTransaction, It.Is<DataContainer> (dc => dc.ID == newObject.ID)), Times.AtLeastOnce());

            clientTransactionListener.Verify (                mock =>
                mock.DataContainerMapUnregistering(middleBottomTransaction, It.Is<DataContainer> (dc => dc.ID == newObject.ID)), Times.AtLeastOnce());
    ...
    public void Events_Cancellation ()
    {
      ...
      clientTransactionListener
            ...
            .Setup(
                mock =>
                mock.ObjectsUnloading(
                    TestableClientTransaction, It.Is<ReadOnlyCollection<DomainObject>> (_ => new[] { order }.All (_.Contains))))
            .Verifiable();
      unloadEventReceiver
            .InSequence (sequence).Setup (mock => mock.OnUnloading (order)).Throws (exception).Verifiable();
    ...
    public void Events_Recalculation ()
    {
      ...
      clientTransactionListener
            ...
            .Setup(
                mock => mock.ObjectsUnloading(
                    TestableClientTransaction,
                    new[] { order1 }))
            .Callback((ClientTransaction clientTransaction, IReadOnlyList<DomainObject> unloadedDomainObjects) => order3.EnsureDataAvailable())
            .Verifiable();
      unloadEventReceiver
            .InSequence (sequence).Setup (mock => mock.OnUnloading (order1)).Verifiable();
      clientTransactionListener
      ...
      unloadEventReceiver
            ...
            .Callback((DomainObject domainObject) => order4.EnsureDataAvailable())
            .Verifiable();
      clientTransactionListener
            .InSequence (sequence)
            .Setup(
            ...
            .Verifiable();
      unloadEventReceiver
            .InSequence (sequence).Setup (mock => mock.OnUnloading (order4)).Verifiable();

      using (mockRepository.Unordered())
        {
          clientTransactionListener.Setup (
              mock => mock.DataContainerMapUnregistering (TestableClientTransaction, It.Is<DataContainer> (dc => dc.ID == order1.ID))).Verifiable();
          clientTransactionListener.Setup (
              mock => mock.DataContainerMapUnregistering (TestableClientTransaction, It.Is<DataContainer> (dc => dc.ID == order3.ID))).Verifiable();
          clientTransactionListener.Setup (
              mock => mock.DataContainerMapUnregistering (TestableClientTransaction, It.Is<DataContainer> (dc => dc.ID == order4.ID))).Verifiable();
        }
      unloadEventReceiver
            .InSequence (sequence).Setup (mock => mock.OnUnloaded (order4)).Verifiable();
      unloadEventReceiver
            .InSequence (sequence).Setup (mock => mock.OnUnloaded (order3)).Verifiable();
      unloadEventReceiver
            .InSequence (sequence).Setup (mock => mock.OnUnloaded (order1)).Verifiable();
    ...
    public void Events_EmptyTransaction ()
    {
      ...
      clientTransactionListener.Verify (          mock => mock.ObjectsUnloading(It.IsAny<ClientTransaction>(), It.IsAny<ReadOnlyCollection<DomainObject>>()), Times.Never());
      clientTransactionListener.Verify (          mock => mock.ObjectsUnloaded(It.IsAny<ClientTransaction>(), It.IsAny<ReadOnlyCollection<DomainObject>>()), Times.Never());
    }
