...
namespace Remotion.Data.DomainObjects.UnitTests.DataManagement
{
  ...
  public class DataContainerTest : ClientTransactionBaseTest
  {
    ...
    public void GetValue_RaisesEvent_Cancellation ()
    {
      ...
      _eventListenerMock.Verify (          mock => mock.PropertyValueRead(
              It.IsAny<DataContainer>(), It.IsAny<PropertyDefinition>(), It.IsAny<object>(), It.IsAny<ValueAccess>()), Times.Never());
    }
    ...
    public void SetValue_RaisesEvent ()
    {
      ...
      _eventListenerMock
          ...
          .Callback((DataContainer dataContainer, PropertyDefinition propertyDefinition, object oldValue, object newValue) => Assert.That(_existingDataContainer.GetValueWithoutEvents(_orderNumberProperty, ValueAccess.Current), Is.EqualTo(0)))
          .Verifiable();
      _eventListenerMock
          .Setup(mock => mock.PropertyValueChanged(_existingDataContainer, _orderNumberProperty, 0, 17))
          .Callback((DataContainer dataContainer, PropertyDefinition propertyDefinition, object oldValue, object newValue) => Assert.That(_existingDataContainer.GetValueWithoutEvents(_orderNumberProperty, ValueAccess.Current), Is.EqualTo(17)))
          .Verifiable();
    ...
    public void SetValue_RaisesEvent_Cancellation ()
    {
      ...
      _eventListenerMock.Verify (          mock => mock.PropertyValueChanged(
              It.IsAny<DataContainer>(), It.IsAny<PropertyDefinition>(), It.IsAny<object>(), It.IsAny<object>()), Times.Never());
    ...
    public void SetValue_SameValue_NoEventButStillTouched ()
    {
      ...
      _eventListenerMock.Verify (          mock => mock.PropertyValueChanging(
              It.IsAny<DataContainer>(),
    ...
    public void GetValueWithoutEvents_RaisesNoEvent ()
    {
      ...
      _eventListenerMock.Verify (          mock => mock.PropertyValueReading(It.IsAny<DataContainer>(), It.IsAny<PropertyDefinition>(), It.IsAny<ValueAccess>()), Times.Never());
      _eventListenerMock.Verify (          mock => mock.PropertyValueRead(
              It.IsAny<DataContainer>(), It.IsAny<PropertyDefinition>(), It.IsAny<object>(), It.IsAny<ValueAccess>()), Times.Never());
    }
