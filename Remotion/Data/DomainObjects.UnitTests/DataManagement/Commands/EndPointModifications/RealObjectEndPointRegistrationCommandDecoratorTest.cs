...
namespace Remotion.Data.DomainObjects.UnitTests.DataManagement.Commands.EndPointModifications
{
  ...
  public class RealObjectEndPointRegistrationCommandDecoratorTest
  {
    ...
    public void Perform ()
    {
      ...
      _oldRelatedEndPointMock.Setup (mock => mock.UnregisterCurrentOppositeEndPoint (_realObjectEndPointStub.Object)).Verifiable();
      _decoratedCommandMock.InSequence (sequence).Setup (mock => mock.Perform()).Verifiable();
      _newRelatedEndPointMock.Setup (mock => mock.RegisterCurrentOppositeEndPoint (_realObjectEndPointStub.Object)).Verifiable();
