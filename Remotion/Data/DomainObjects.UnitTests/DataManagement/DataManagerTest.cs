...
namespace Remotion.Data.DomainObjects.UnitTests.DataManagement
{
  ...
  public class DataManagerTest : ClientTransactionBaseTest
  {
    ...
    public void CreateUnloadVirtualEndPointCommand ()
    {
      ...
      _endPointManagerMock
          .Setup(mock => mock.CreateUnloadVirtualEndPointsCommand(
    ...
    public void GetDataContainerWithLazyLoad_NotLoaded ()
    {
      ...
      _objectLoaderMock
          ...
          .Verifiable();
      _objectLoaderMock.Object.Replay();
    ...
    public void GetDataContainerWithLazyLoad_NotFound ()
    {
      ...
      _objectLoaderMock
          ...
          .Callback((ObjectID id, bool throwOnNotFound) => _invalidDomainObjectManagerMock.Object.Stub(stub => stub.Object.IsInvalid(notFoundID)).Return(true))
    ...
    public void GetDataContainersWithLazyLoad ()
    {
      ...
      _objectLoaderMock
          .Setup(mock => mock.LoadObjects(
              new[] { nonLoadedDataContainer1.ID, nonLoadedDataContainer2.ID },
              throwOnNotFound))
          .Callback(
    ...
    public void GetDataContainersWithLazyLoad_WithInvalidID ()
    {
      ...
      _objectLoaderMock
          ...
          .Callback((IEnumerable<ObjectID> idsToBeLoaded, bool throwOnNotFound) => ((IEnumerable<ObjectID>)mi.Arguments[0]).ToList())
    ...
    public void GetDataContainersWithLazyLoad_NotFound ()
    {
      ...
      _objectLoaderMock
          .Setup(mock => mock.LoadObjects(
              new[] { nonLoadedDataContainer.ID, notFoundID },
              throwOnNotFound))
          .Callback(
              (IEnumerable<ObjectID> idsToBeLoaded, bool throwOnNotFound) =>
              {
                DataManagerTestHelper.AddDataContainer(_dataManagerWithMocks, nonLoadedDataContainer);
                _invalidDomainObjectManagerMock.Object.Stub(stub => stub.Object.IsInvalid(notFoundID)).Return(true);
              })
    ...
    public void LoadLazyVirtualObjectEndPoint_MarkedCompleteByLoader ()
    {
      ...
      _objectLoaderMock
          ...
          .Callback((RelationEndPointID relationEndPointID) => endPointMock.Object.Stub(stub => stub.Object.IsDataComplete).Return(true))
          .Verifiable();
      ...
      endPointMock.Verify (stub => stub.IsDataComplete, Times.Once());
      endPointMock.Verify (stub => stub.IsDataComplete, Times.Once());
    }
