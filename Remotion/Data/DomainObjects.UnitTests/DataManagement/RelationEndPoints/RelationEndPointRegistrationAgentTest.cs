...
namespace Remotion.Data.DomainObjects.UnitTests.DataManagement.RelationEndPoints
{
  ...
  public class RelationEndPointRegistrationAgentTest : StandardMappingTest
  {
    ...
    public void RegisterEndPoint_RealEndPoint_PointingToNull ()
    {
      ...
      oppositeEndPointMock.Setup (mock => mock.RegisterOriginalOppositeEndPoint (endPointMock)).Verifiable();
    ...
    public void UnregisterEndPoint_RealEndPoint_PointingToNonNull_NonUnidirectional_CanBeCollectedTrue ()
    {
      ...
      oppositeEndPointMock.Setup (mock => mock.UnregisterOriginalOppositeEndPoint (endPointMock)).Verifiable();

      _map.AddEndPoint(endPointMock);
      _map.AddEndPoint(oppositeEndPointMock);

      _endPointProviderMock.Setup (mock => mock.GetOrCreateVirtualEndPoint (oppositeEndPointMock.ID)).Returns (oppositeEndPointMock).Verifiable();
