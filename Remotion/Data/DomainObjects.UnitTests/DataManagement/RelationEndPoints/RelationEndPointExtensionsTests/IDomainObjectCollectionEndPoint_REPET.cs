...
{
  [TestFixture]
  public class IDomainObjectCollectionEndPoint_RelationEndPointExtensionsTest : ClientTransactionBaseTest
  {
    [Test]
    public void GetEndPointWithOppositeDefinition_Object ()
    {
      ...
      var oppositeEndPoint = endPoint.GetEndPointWithOppositeDefinition<IDomainObjectCollectionEndPoint>(customer);
    ...
    public void GetEndPointWithOppositeDefinition_ID ()
    {
      ...
      var customer = DomainObjectIDs.Customer1.GetObject<Customer>();
      var oppositeEndPoint = endPoint.GetEndPointWithOppositeDefinition<IDomainObjectCollectionEndPoint>(customer.ID);
