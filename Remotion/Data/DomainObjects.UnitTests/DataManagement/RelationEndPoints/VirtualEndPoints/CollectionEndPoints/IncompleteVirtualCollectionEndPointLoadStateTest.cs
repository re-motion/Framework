...
{
  [TestFixture]
  public class IncompleteVirtualCollectionEndPointLoadStateTest : StandardMappingTest
  {
    private RelationEndPointID _endPointID;
    private IVirtualCollectionEndPoint _collectionEndPointMock;

    private IncompleteVirtualCollectionEndPointLoadState.IEndPointLoader _endPointLoaderMock;
    private IVirtualCollectionEndPointDataManagerFactory _dataManagerFactoryStub;

    private IncompleteVirtualCollectionEndPointLoadState _loadState;

    private Product _relatedObject;
    private IRealObjectEndPoint _relatedEndPointStub;

    private Product _relatedObject2;
    ...
    public override void SetUp ()
    {
      ...
      _dataManagerFactoryStub = MockRepository.GenerateStub<IVirtualCollectionEndPointDataManagerFactory>();

      var dataManagerStub = MockRepository.GenerateStub<IVirtualCollectionEndPointDataManager>();
      dataManagerStub.Stub (stub => stub.HasDataChanged()).Return (false);

      _loadState = new IncompleteVirtualCollectionEndPointLoadState (_endPointLoaderMock, _dataManagerFactoryStub);

      _relatedObject = DomainObjectMother.CreateFakeObject<Product>();
      _relatedEndPointStub = MockRepository.GenerateStub<IRealObjectEndPoint>();
      _relatedEndPointStub.Stub (stub => stub.ObjectID).Return (_relatedObject.ID);

      _relatedObject2 = DomainObjectMother.CreateFakeObject<Product>();
    ...
    public void MarkDataComplete_CreatesNewDataManager ()
    {
      ...
      _collectionEndPointMock.Stub (stub => stub.GetCollectionEventRaiser())
          .Return (MockRepository.GenerateStub<IDomainObjectCollectionEventRaiser>());
      _collectionEndPointMock.Replay();

      var newManagerMock = MockRepository.GenerateStrictMock<IVirtualCollectionEndPointDataManager>();
    ...
    public void MarkDataComplete_EndPointsWithoutItems_AreRegisteredAfterStateSetter ()
    {
      ...
      var newManagerStub = MockRepository.GenerateStub<IVirtualCollectionEndPointDataManager>();
    ...
    public void MarkDataComplete_Items_AreRegisteredInOrder_WithOrWithoutEndPoints ()
    {
      ...
      var newManagerMock = MockRepository.GenerateMock<IVirtualCollectionEndPointDataManager>();
    ...
    public void MarkDataComplete_RaisesEvent ()
    {
      ...
      Action<IVirtualCollectionEndPointDataManager> stateSetter = dataManager => counter.CheckPosition ("stateSetter", expectedManagerPosition);
