...
namespace Remotion.Data.DomainObjects.UnitTests.DataManagement.RelationEndPoints.VirtualEndPoints.CollectionEndPoints
{
  ...
  public class DomainObjectCollectionEndPointCollectionManagerTest : StandardMappingTest
  {
    ...
    public override void SetUp ()
    {
      ...
      _manager = new DomainObjectCollectionEndPointCollectionManager(_endPointID, _domainObjectCollectionProviderMock.Object, _associatedDomainObjectCollectionDataStrategyFactoryMock.Object);
    ...
    public void AssociateCollectionWithEndPoint ()
    {
      ...
      oldCollectionMock.Setup (mock => ((IAssociatableDomainObjectCollection)mock).AssociatedEndPointID).Returns (_endPointID);
      oldCollectionMock.Setup (mock => ((IAssociatableDomainObjectCollection)mock).TransformToStandAlone()).Returns (oldDataStrategyOfOldCollection).Verifiable();
      ...
      newCollectionMock
          .Setup(mock => ((IAssociatableDomainObjectCollection)mock).TransformToAssociated(_endPointID, _associatedDomainObjectCollectionDataStrategyFactoryMock.Object))
    ...
    private DomainObjectCollection RegisterAssociatedOriginalCollection ()
    {
      ...
      StubEmptyDataStrategy(_associatedDataStrategyStub.Object);
