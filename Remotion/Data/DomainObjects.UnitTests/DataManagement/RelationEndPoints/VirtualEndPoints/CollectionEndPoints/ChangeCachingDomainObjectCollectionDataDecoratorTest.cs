...
namespace Remotion.Data.DomainObjects.UnitTests.DataManagement.RelationEndPoints.VirtualEndPoints.CollectionEndPoints
{
  ...
  public class ChangeCachingDomainObjectCollectionDataDecoratorTest : StandardMappingTest
  {
    ...
    public void OnWrappedDataChanged_InvalidatedCacheLeadsToReEvaluation ()
    {
      ...
      _strategyStrictMock.InSequence (sequence).Setup (mock => mock.HasDataChanged (_decoratorWithRealData, It.IsAny<IDomainObjectCollectionData>())).Returns (true).Verifiable();
      _strategyStrictMock.InSequence (sequence).Setup (mock => mock.HasDataChanged (_decoratorWithRealData, It.IsAny<IDomainObjectCollectionData>())).Returns (false).Verifiable();
