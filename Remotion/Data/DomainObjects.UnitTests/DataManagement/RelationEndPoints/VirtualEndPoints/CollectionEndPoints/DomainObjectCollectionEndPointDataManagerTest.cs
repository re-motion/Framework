  ...
  public class DomainObjectCollectionEndPointDataManagerTest : StandardMappingTest
  {
    ...
    public void HasDataChanged ()
    {
      _changeDetectionStrategyMock
          .Setup(mock => mock.HasDataChanged(
              _dataManager.CollectionData,
              _dataManager.OriginalCollectionData))
          .Returns(true)
          .Verifiable();
    ...
    public void HasDataChanged_Cached ()
    {
      ...
      _changeDetectionStrategyMock.Verify (mock => mock.HasDataChanged(
              _dataManager.CollectionData,
              _dataManager.OriginalCollectionData), Times.Once());
    ...
    {
      using (_changeDetectionStrategyMock.Object.GetMockRepository().Ordered())
      {
        _changeDetectionStrategyMock
            .Setup(mock => mock.HasDataChanged(
                _dataManager.CollectionData,
