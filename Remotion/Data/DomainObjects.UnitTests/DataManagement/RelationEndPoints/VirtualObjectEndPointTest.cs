...
namespace Remotion.Data.DomainObjects.UnitTests.DataManagement.RelationEndPoints
{
  ...
  public class VirtualObjectEndPointTest : ClientTransactionBaseTest
  {
    ...
    public void Initialization_NonVirtualDefinition ()
    {
      ...
      Assert.That(
          () => new VirtualObjectEndPoint(TestableClientTransaction, id, _lazyLoaderMock.Object, _endPointProviderStub.Object, _transactionEventSinkStub.Object, _dataManagerFactory),
    ...
    public void CanBeCollected ()
    {
      ...
      _loadStateMock.Object.Replay();

      var result1 = _endPoint.CanBeCollected;
      var result2 = _endPoint.CanBeCollected;

      _loadStateMock.Verify (mock => mock.CanEndPointBeCollected (_endPoint), Times.Once());
    ...
    public void CanBeMarkedIncomplete ()
    {
      ...
      _loadStateMock.Verify (mock => mock.CanDataBeMarkedIncomplete (_endPoint), Times.Once());
      Assert.That(result1, Is.True);
      Assert.That(result2, Is.False);
    }
    ...
    public void MarkDataComplete ()
    {
      ...
      _loadStateMock
          ...
          .Callback((IVirtualObjectEndPoint endPoint, DomainObject item, Action<IVirtualObjectEndPointDataManager> stateSetter) => { stateSetter = (Action<IVirtualObjectEndPointDataManager>)mi.Arguments[2]; })
          .Verifiable();
      ...
      stateSetter(dataManagerStub.Object);
    ...
    public void MarkDataIncomplete ()
    {
      ...
      _loadStateMock
          ...
          .Callback((IVirtualObjectEndPoint endPoint, Action stateSetter) => { stateSetter = (Action)mi.Arguments[1]; })
          .Verifiable();
