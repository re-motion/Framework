...
{
  [TestFixture]
  public class DomainObjectCollectionEndPointIntegrationTest : ClientTransactionBaseTest
  {
    ...
    private void SetCollectionAndNotify (DomainObjectCollectionEndPoint collectionEndPoint, DomainObjectCollection newCollection)
    {
