...
namespace Remotion.Data.DomainObjects.UnitTests.Linq
{
  ...
  public class DomainObjectQueryExecutorTest : StandardMappingTest
  {
    ...
    public override void SetUp ()
    {
      ...
      _queryGeneratorMock = new Mock<IDomainObjectQueryGenerator> (MockBehavior.Strict);
    ...
    {
      _queryGeneratorMock
          .Setup(mock => mock.CreateSequenceQuery<Order>(
              "<dynamic query>",
    ...
    private void ExpectCreateQueryWithFetchQueryModelBuilders<T> (QueryModel queryModel, IExecutableQuery<IEnumerable<T>> fakeResult)
    {
      ...
      _queryGeneratorMock
          ...
          .Returns(fakeResult)
          .Callback((string id, StorageProviderDefinition storageProviderDefinition, QueryModel queryModel, IEnumerable<FetchQueryModelBuilder> fetchQueryModelBuilders) =>
{
