...
public class TableValuedParameterIntegrationTest : IntegrationTestBase
{
  ...
  public void Contains_WithEmptyCollection ()
  {
    ...
    var collectionStub = new Mock<ICollection<Guid>>();
    collectionStub.As<IEnumerable>().Setup(_ => _.GetEnumerator()).Returns(() => array.GetEnumerator());
    collectionStub.Setup(_ => _.GetEnumerator()).Returns(() => ((IEnumerable<Guid>)array).GetEnumerator());
    var possibleItems = collectionStub.Object;
