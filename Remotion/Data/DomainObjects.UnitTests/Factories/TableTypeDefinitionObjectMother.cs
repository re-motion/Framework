...
namespace Remotion.Data.DomainObjects.UnitTests.Factories
{
  ...
  {
    public static SqlTableTypeDefinition Create (
        ...
        IReadOnlyCollection<ITableConstraintDefinition> constraints = null)
    {
      ...
      return new SqlTableTypeDefinition(new EntityNameDefinition(schemaName, typeName), propertyDefinitions, constraints);
    }
  }
}
