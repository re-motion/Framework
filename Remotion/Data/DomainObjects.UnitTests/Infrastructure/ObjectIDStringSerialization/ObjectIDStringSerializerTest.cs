...
namespace Remotion.Data.DomainObjects.UnitTests.Infrastructure.ObjectIDStringSerialization
{
  ...
  public class ObjectIDStringSerializerTest : StandardMappingTest
  {
    ...
    [Test]
    public void Parse_CheckSerializableStringValue ()
    {
      string idString = "Official|Arthur &pipe; Dent|System.String";
      ObjectID id = ObjectIDStringSerializer.Instance.Parse (idString);
    ...
    [Test]
    public void Parse_CheckSerializableStringValue_WithEscapeString ()
    {
      string idString = "Official|Dent &pipe; &amp;pipe; Zaphod Beeblebrox|System.String";
      ObjectID id = ObjectIDStringSerializer.Instance.Parse (idString);

      Assert.That (id.StorageProviderDefinition.Name, Is.EqualTo ("UnitTestStorageProviderStub"));
      Assert.That (id.ClassID, Is.EqualTo ("Official"));
      Assert.That (id.Value.GetType(), Is.EqualTo (typeof (string)));
      Assert.That (id.Value, Is.EqualTo ("Dent | &pipe; Zaphod Beeblebrox"));
    }
    ...
    [Test]
    public void TryParse_CheckSerializableStringValue ()
    {
      string idString = "Official|Arthur &pipe; Dent|System.String";
    ...
    [Test]
    public void TryParse_CheckSerializableStringValue_WithEscapeString ()
    {
      string idString = "Official|Dent &pipe; &amp;pipe; Zaphod Beeblebrox|System.String";
