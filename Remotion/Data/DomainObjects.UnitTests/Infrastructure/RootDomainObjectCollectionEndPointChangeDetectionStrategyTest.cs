...
{
  [TestFixture]
  public class RootDomainObjectCollectionEndPointChangeDetectionStrategyTest : ClientTransactionBaseTest
  {
    private Order _order1;
    private Order _order3;
    private Order _order4;

    private RootDomainObjectCollectionEndPointChangeDetectionStrategy _strategy;
