  ...
  public class ObjectLifetimeAgentTest : StandardMappingTest
  {
    ...
    public void NewObject ()
    {
      ...
      _domainObjectCreatorMock
          ...
          .Callback((IObjectInitializationContext objectInitializationContext, ParamList constructorParameters, ClientTransaction clientTransaction) => CheckInitializationContext<NewObjectInitializationContext>(mi.Arguments[0], _objectID1, _transaction))
    ...
    public void NewObject_CreationException_CausesObjectToBeDeleted ()
    {
      ...
      _domainObjectCreatorMock
          ...
          .Callback((IObjectInitializationContext objectInitializationContext, ParamList constructorParameters, ClientTransaction clientTransaction) =>
{
      ...
      var deleteCommandMock = SetupDeleteExpectations(_dataManagerMock.Object, _domainObject1);
          ...
          .Callback((IObjectInitializationContext objectInitializationContext, ParamList constructorParameters, ClientTransaction clientTransaction) =>
{
      ...
      var deleteCommandMock = SetupDeleteExpectationsWithException(_dataManagerMock.Object, _domainObject1, exceptionInDelete);
    ...
    public void GetObjectReference_UnknownObject_ReturnsUnloadedObject ()
    {
      ...
      _domainObjectCreatorMock
          ...
          .Returns(_domainObject1)
          .Callback(
              (IObjectInitializationContext objectInitializationContext, ClientTransaction clientTransaction) =>               CheckInitializationContext<ObjectReferenceInitializationContext>(mi.Arguments[0], _objectIDWithCreatorMock, _transaction))
          .Verifiable();
    ...
    public void GetObjectReference_UnknownObject_WithSubTransaction_PutsRootTransactionIntoContext ()
    {
      ...
      _domainObjectCreatorMock
          .Setup(mock => mock.CreateObjectReference(Arg<ObjectReferenceInitializationContext>.Is.TypeOf, subTransaction))
          .Returns(_domainObject1)
          .Callback(
              (IObjectInitializationContext objectInitializationContext, ClientTransaction clientTransaction) =>               CheckInitializationContext<ObjectReferenceInitializationContext>(mi.Arguments[0], _objectIDWithCreatorMock, _transaction))
          .Verifiable();
...
initialCommandStub.Setup(stub => stub.ExpandToAllRelatedObjects()).Returns(new ExpandedCommand(actualCommandMock.Object)).Ordered(counter);
actualCommandMock.Setup(mock => mock.Begin()).Ordered(counter);
actualCommandMock.Setup(mock => mock.Perform()).Ordered(counter);
actualCommandMock.Setup(mock => mock.End()).Ordered(counter);
      dataManagerMock.Setup (mock => mock.CreateDeleteCommand (deletedObject)).Returns (initialCommandStub.Object).Verifiable();
      return actualCommandMock.Object;
    }
    ...
    private IDataManagementCommand SetupDeleteExpectationsWithException (IDataManager dataManagerMock, DomainObject deletedObject, Exception exception)
    {
      ...
      actualCommandMock.Setup (stub => stub.GetAllExceptions()).Returns (Enumerable.Empty<Exception>());
initialCommandStub.Setup(stub => stub.ExpandToAllRelatedObjects()).Returns(new ExpandedCommand(actualCommandMock.Object)).Ordered(counter);
      actualCommandMock.Setup (mock => mock.Begin()).Throws (exception).Verifiable();
      dataManagerMock.Setup (mock => mock.CreateDeleteCommand (deletedObject)).Returns (initialCommandStub.Object).Verifiable();
      return actualCommandMock.Object;
    }
