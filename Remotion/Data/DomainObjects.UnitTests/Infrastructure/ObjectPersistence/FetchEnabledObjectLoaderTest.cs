      ...
      _loadedObjectDataRegistrationAgentMock
          ...
          .Setup(
              mock => mock.BeginRegisterIfRequired(
                  new[] { _resultItem1, _resultItem2 }, true, It.IsNotNull<LoadedObjectDataPendingRegistrationCollector>()))
          .Callback((IEnumerable<ILoadedObjectData> loadedObjects, bool throwOnNotFound, LoadedObjectDataPendingRegistrationCollector pendingLoadedObjectDataCollector) => collector = pendingLoadedObjectDataCollector)
