  ...
  public class SubPersistenceStrategyTest : ClientTransactionBaseTest
  {
    ...
    public void LoadObjectData_Multiple ()
    {
      ...
      _parentTransactionContextMock
          ...
          .Returns(new[] { parentObject1, null, parentObject3 })
          .Verifiable();
      _parentTransactionContextMock
          ...
          .Callback(() =>
{
    ...
    public void PersistData_EndPoints ()
    {
      ...
      _parentTransactionContextMock
          .Setup(mock => mock.GetRelationEndPointWithoutLoading(persistedEndPoint1.ID))
          .Returns(parentEndPointMock1.Object)
          .Verifiable();
parentEndPointMock1
          .Setup(mock => mock.SetDataFromSubTransaction(persistedEndPoint1))
      ...
      _parentTransactionContextMock
          .Setup(mock => mock.GetRelationEndPointWithoutLoading(persistedEndPoint3.ID))
          .Returns(parentEndPointMock3.Object)
          .Verifiable();
parentEndPointMock3
          .Setup(mock => mock.SetDataFromSubTransaction(persistedEndPoint3))
          .Ordered(counter, "SetDataFromSubTransaction must occur prior to Dispose.");
_unlockedParentTransactionContextMock.Setup(mock => mock.Dispose()).Ordered(counter, "Dispose should come at the end.");
...
_parentTransactionContextMock
          .Setup(mock => mock.GetRelationEndPointWithoutLoading(persistedEndPoint.ID))
...
parentEndPointMock
          .Setup(mock => mock.SetDataFromSubTransaction(persistedEndPoint))
          .Ordered(counter, "SetDataFromSubTransaction must occur prior to Dispose.");
_unlockedParentTransactionContextMock.Setup(mock => mock.Dispose()).Ordered(counter, "Dispose should come at the end.");
