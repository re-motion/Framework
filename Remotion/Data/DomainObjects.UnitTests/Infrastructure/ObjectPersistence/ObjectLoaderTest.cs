...
namespace Remotion.Data.DomainObjects.UnitTests.Infrastructure.ObjectPersistence
{
  ...
  public class ObjectLoaderTest : StandardMappingTest
  {
    ...
    {
      _persistenceStrategyMock.Setup (mock => mock.LoadObjectData (DomainObjectIDs.Order1)).Returns (_loadedObjectDataStub1.Object).Verifiable();
      var throwOnNotFound = BooleanObjectMother.GetRandomBoolean();
      _loadedObjectDataRegistrationAgentMock.Setup (mock => mock.RegisterIfRequired (new[] { _loadedObjectDataStub1.Object }, throwOnNotFound)).Verifiable();
    ...
    public void LoadObjects ()
    {
      ...
      _persistenceStrategyMock
          .Setup(mock => mock.LoadObjectData(
      ...
      _loadedObjectDataRegistrationAgentMock
          .Setup(mock => mock.RegisterIfRequired(
              new[] { _loadedObjectDataStub1.Object, _loadedObjectDataStub2.Object },
              true))
          .Verifiable();
