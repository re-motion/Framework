...
namespace Remotion.Data.DomainObjects.UnitTests.Tracing
{
  ...
  public class TracingDbCommandTest
  {
    ...
    public void ExecuteNonQuery ()
    {
      ...
      _extensionMock.Object.QueryExecuting(_connectionID,_command.QueryID, "commandText", It.IsNotNull<IDictionary<string,object>>());
      _innerCommandMock.InSequence (sequence).Setup (mock => mock.ExecuteNonQuery()).Returns (100).Verifiable();
      _extensionMock.Object.QueryExecuted(_connectionID, _command.QueryID, It.Is<TimeSpan> (_ => _ > TimeSpan.Zero ));
      _extensionMock.Object.QueryCompleted(_connectionID, _command.QueryID, TimeSpan.Zero, 100);
    ...
    public void ExecuteNonQuery_WithError ()
    {
      ...
      _extensionMock.Object.QueryExecuting(_connectionID, _command.QueryID, "commandText", CreateParametersArgumentExpectation());
      _innerCommandMock.InSequence (sequence).Setup (mock => mock.ExecuteNonQuery()).Throws (exception).Verifiable();

      _extensionMock.Object.QueryError(_connectionID, _command.QueryID, exception);
    ...
    public void ExecuteReaderWithOverload ()
    {
      ...
      {
        _extensionMock.Object.QueryExecuting(_connectionID, _command.QueryID, "commandText", CreateParametersArgumentExpectation());
        _innerCommandMock.Setup (mock => mock.ExecuteReader (CommandBehavior.SchemaOnly)).Returns (readerStub.Object).Verifiable();
        _extensionMock.Object.QueryExecuted(_connectionID, _command.QueryID, It.Is<TimeSpan> (_ => _ > TimeSpan.Zero ));
      }
    ...
    public void ExecuteScalar ()
    {
      ...
      _extensionMock.Object.QueryCompleted(_connectionID, _command.QueryID, TimeSpan.Zero, 1);
