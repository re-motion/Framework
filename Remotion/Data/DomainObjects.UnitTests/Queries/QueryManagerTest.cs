...
namespace Remotion.Data.DomainObjects.UnitTests.Queries
{
  ...
  public class QueryManagerTest : ClientTransactionBaseTest
  {
    ...
    public void GetCollection ()
    {
      ...
      _transactionEventSinkWithMock.Setup(stub => stub.RaiseFilterQueryResultEvent(It.IsAny<QueryResult<Order>>()))
          .Returns((QueryResult<Order>) null)
    ...
    public void GetCollection_CallsFilterQueryResult ()
    {
      ...
      _transactionEventSinkWithMock.Setup(mock => mock.RaiseFilterQueryResultEvent(
          It.Is<QueryResult<Order>> (qr => qr.ToArray().SequenceEqual(new[] { _fakeOrder1 }))))
    ...
    public void GetCollection_NonGeneric ()
    {
      ...
      _transactionEventSinkWithMock.Setup(mock => mock.RaiseFilterQueryResultEvent(
          It.Is<QueryResult<DomainObject>> (qr => qr.ToArray().SequenceEqual(new[] { _fakeOrder1, _fakeOrder2 }))))
          .Returns(filteredResult)
          .Verifiable();
    ...
    public void GetCustom ()
    {
      ...
      _transactionEventSinkWithMock.Setup(stub => stub.RaiseFilterCustomQueryResultEvent(
          _customQuery,
          new[] { "Fake1", "Fake2" }))
          .Returns((IEnumerable<object>) null)
          .Callback(mi => mi.ReturnValue = mi.Arguments[1])
          .Verifiable();
