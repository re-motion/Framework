...
{
  [TestFixture]
  public class IQueryDefinitionLoaderTest
  {
    ...
    {
      var factory1 = _serviceLocator.GetInstance<IQueryDefinitionLoader>();
      var factory2 = _serviceLocator.GetInstance<IQueryDefinitionLoader>();
