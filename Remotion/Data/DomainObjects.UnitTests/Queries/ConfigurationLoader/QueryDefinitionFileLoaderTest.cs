...
using Remotion.Data.DomainObjects.UnitTests.Queries.Configuration;
...
namespace Remotion.Data.DomainObjects.UnitTests.Queries.ConfigurationLoader
{
  ...
  public class QueryDefinitionFileLoaderTest : StandardMappingTest
  {
    ...
    [Test]
    public void LoadQueryDefinitions_ScalarQueryWithCollectionType_ThrowsException ()
    {
      var loader = new QueryDefinitionFileLoader(_storageProviderDefinitionFinder);
      Assert.That(
    ...
    [Test]
    public void LoadQueryDefinitions_QueryConfigurationWithInvalidNamespace_ThrowsException ()
    {
    ...
    [Test]
    public void LoadQueryDefinitions_DefaultStorageProviderDefinition ()
    {
      var loader = new QueryDefinitionFileLoader(_storageProviderDefinitionFinder);
    ...
    [Test]
    public void LoadQueryDefinitions_CustomStorageProviderDefinition ()
    {
      var loader = new QueryDefinitionFileLoader(_storageProviderDefinitionFinder);
      var queries = loader.LoadQueryDefinitions(GetFullScriptPath("QueriesForStorageGroupTest.xml"));
    ...
    [Test]
    public void LoadQueryDefinitions_FallbackToDefaultStorageProviderDefinition ()
    {
      var loader = new QueryDefinitionFileLoader(_storageProviderDefinitionFinder);
      var queries = loader.LoadQueryDefinitions(GetFullScriptPath("QueriesForStorageGroupTest.xml"));
