...
namespace Remotion.Data.DomainObjects.UnitTests.DomainObjects
{
  ...
  public class PropertyAccessorTest : ClientTransactionBaseTest
  {
    ...
    public void SetValue_WithObjectList_Notifies ()
    {
      ...
      listenerMock.Verify (        mock => mock.RelationChanged(TestableClientTransaction, sector, propertyAccessor.PropertyData.RelationEndPointDefinition, null, newCompanies[0]), Times.AtLeastOnce());
    }
    ...
    public void SetValue_WithRelatedObject_Notifies ()
    {
      ...
      listenerMock.Verify (          mock => mock.RelationChanged(TestableClientTransaction, order, propertyAccessor.PropertyData.RelationEndPointDefinition, oldTicket, newTicket), Times.AtLeastOnce());
    }
