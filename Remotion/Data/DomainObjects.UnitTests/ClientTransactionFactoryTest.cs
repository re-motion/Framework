...
namespace Remotion.Data.DomainObjects.UnitTests
{
  ...
  public class ClientTransactionFactoryTest
  {
    ...
    public void CreateRootTransaction_WithExtension ()
    {
      ...
      factory.Protected().Setup ("OnTransactionCreated", true, It.IsNotNull<ClientTransaction>()).Callback (
          (object target, string methodName, object?[] arguments) =>           ((ClientTransaction)invocation.Arguments[0]).Extensions.Add (extensionStub.Object)).Verifiable();
    ...
    public void CreateChildTransaction_WithExtension ()
    {
      ...
      factory
.Protected()          .Setup ("OnTransactionCreated", true, It.IsNotNull<ClientTransaction>())          .Callback((object target, string methodName, object?[] arguments) => ((ClientTransaction)invocation.Arguments[0]).Extensions.Add(extensionStub.Object))
          .Verifiable();
