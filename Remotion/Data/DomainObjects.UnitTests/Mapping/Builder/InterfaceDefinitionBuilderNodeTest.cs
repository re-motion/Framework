...
namespace Remotion.Data.DomainObjects.UnitTests.Mapping.Builder
{
  ...
  public class InterfaceDefinitionBuilderNodeTest
  {
    ...
    public void Initialize ()
    {
      ...
      Assert.That(classDefinitionBuilderNode.ExtendedInterfaces, Is.Empty);
      Assert.That(classDefinitionBuilderNode.ImplementingClasses, Is.Empty);
      Assert.That(classDefinitionBuilderNode.ExtendingInterfaces, Is.Empty);
    ...
    public void Initialize_WithExtendedInterface_AddsInstanceToExtendedInterface ()
    {
      ...
      Assert.That(subNode.ExtendedInterfaces, Is.EqualTo(new[] { baseNode }));
      Assert.That(baseNode.IsLeafNode, Is.False);
      Assert.That(baseNode.ExtendingInterfaces, Is.EqualTo(new[] { subNode }));
    }
    ...
    public void Initialize_WithIDomainObject_Throws ()
    {
      Assert.That(
          ...
          Throws.ArgumentException
              .With.ArgumentExceptionMessageEqualTo("Cannot create a builder node for the IDomainObject type.", "type"));
    }
    ...
    public void EndBuildTypeDefinition ()
    {
      ...
      mappingObjectFactoryMock.Setup(e => e.CreateInterfaceDefinition(typeof(IBase), It.Is<IEnumerable<InterfaceDefinition>>(f => !f.Any()))).Returns(baseInterfaceDefinition);
      mappingObjectFactoryMock.Setup(e => e.CreateInterfaceDefinition(typeof(ISub), new[] { baseInterfaceDefinition })).Returns(subInterfaceDefinition);
      mappingObjectFactoryMock.Setup(e => e.CreateClassDefinition(typeof(Sub), null, It.Is<IEnumerable<InterfaceDefinition>>(f => !f.Any()))).Returns(subClassDefinition);
    ...
    public void BeginBuildTypeDefinition ()
    {
      ...
      mappingObjectFactoryMock.Setup(e => e.CreateInterfaceDefinition(typeof(IBase), It.Is<IEnumerable<InterfaceDefinition>>(f => !f.Any()))).Returns(baseInterfaceDefinition);
      mappingObjectFactoryMock.Setup(e => e.CreateInterfaceDefinition(typeof(ISub), new[] { baseInterfaceDefinition }))
    ...
    public void BeginBuildTypeDefinition_Twice_DoesNotRebuild ()
    {
      ...
      mappingObjectFactoryMock.Verify(e => e.CreateInterfaceDefinition(typeof(IBase), It.Is<IEnumerable<InterfaceDefinition>>(f => !f.Any())), Times.Once);
    }
    ...
    public void AddImplementingClass ()
    {
      ...
      Assert.That(baseNode.ImplementingClasses, Is.EqualTo(new[] { subNode }));
    }
    ...
    public void AddImplementingClass_WithConstructedNode_Throws ()
    {
      ...
      Assert.That(
          ...
          Throws.ArgumentException
              .With.ArgumentExceptionMessageEqualTo("The specified implemented interfaces must not be constructed.", "implementedInterfaces"));
    }
    ...
    public void AddExtendingInterface_WithConstructedNode_Throws ()
    {
      ...
      Assert.That(
          ...
          Throws.ArgumentException
              .With.ArgumentExceptionMessageEqualTo("The specified extended interfaces must not be constructed.", "extendedInterfaces"));
    }
  }
}
