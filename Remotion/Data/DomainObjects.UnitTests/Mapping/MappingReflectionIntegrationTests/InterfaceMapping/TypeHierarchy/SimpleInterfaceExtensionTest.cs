...
{
  public class SimpleInterfaceExtensionTest : ReferenceMappingTestBase
  {
    ...
    private interface ISub2 : IBase
    {
    }

    private interface ISubber : ISub
    {
    }
    ...
    {
      builder.InterfaceDefinitionFor<IBase>();

      builder.InterfaceDefinitionFor<ISub>()
          .Extends<IBase>();

      builder.InterfaceDefinitionFor<ISub2>()
          .Extends<IBase>();

      builder.InterfaceDefinitionFor<ISubber>()
          .Extends<ISub>();
    }
  }
}
