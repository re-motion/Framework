...
{
  public class ExtendedInterfaceImplementationTest : ReferenceMappingTestBase
  {
    ...
    private interface IC : IA, IB, INotInMapping
    {
    }

    [DBTable]
    public class Test : DomainObject, IC
    {
    }
    ...
    protected override void CreateReferenceTypeDefinitions (ReferenceTypeDefinitionCollectionBuilder builder)
    {
      ...
      builder.InterfaceDefinitionFor<IC>()
          .Extends<IA>()
          .Extends<IB>();

      builder.ClassDefinitionFor<Test>()
          .Implements<IA>()
          .Implements<IB>()
          .Implements<IC>();
    }
