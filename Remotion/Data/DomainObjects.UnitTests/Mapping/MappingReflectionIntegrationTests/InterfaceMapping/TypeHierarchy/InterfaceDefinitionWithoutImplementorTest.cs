...
{
  public class InterfaceDefinitionWithoutImplementorTest : ReferenceMappingTestBase
  {
    private interface INoImplementors : IDomainObject
    {
    }
    ...
    {
      builder.InterfaceDefinitionFor<INoImplementors>();
    }
  }
}
