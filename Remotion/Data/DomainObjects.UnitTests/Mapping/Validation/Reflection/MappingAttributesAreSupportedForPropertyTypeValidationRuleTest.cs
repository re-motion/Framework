  ...
  public class MappingAttributesAreSupportedForPropertyTypeValidationRuleTest : ValidationRuleTestBase
  {
    ...
    public void InvalidPropertyWithStringPropertyAttribute ()
    {
      ...
      AssertMappingValidationResult(validationResult, false,
        $"The 'StringPropertyAttribute' may be only applied to properties of type 'String'.{Environment.NewLine}{Environment.NewLine}"
    ...
    public void InvalidPropertyWithBinaryPropertyAttribute ()
    {
      ...
      AssertMappingValidationResult(validationResult, false, $"The 'BinaryPropertyAttribute' may be only applied to properties of type 'Byte[]'.{Environment.NewLine}{Environment.NewLine}"
        + "Declaring type: Remotion.Data.DomainObjects.UnitTests.Mapping.TestDomain.Validation.Reflection."
        + $"MappingAttributesAreSupportedForPropertyTypeValidationRule.ClassWithInvalidPropertyAttributes{Environment.NewLine}"
    ...
    public void InvalidPropertyWithExtensibleEnumPropertyAttribute ()
    {
      ...
      AssertMappingValidationResult(validationResult, false, $"The 'ExtensibleEnumPropertyAttribute' may be only applied to properties of type 'IExtensibleEnum'.{Environment.NewLine}{Environment.NewLine}"
        + "Declaring type: Remotion.Data.DomainObjects.UnitTests.Mapping.TestDomain.Validation.Reflection."
        +$"MappingAttributesAreSupportedForPropertyTypeValidationRule.ClassWithInvalidPropertyAttributes{Environment.NewLine}"
    ...
    public void InvalidPropertyWithMandatoryPropertyAttribute ()
    {
      ...
      AssertMappingValidationResult(validationResult, false,
        $"The 'MandatoryAttribute' may be only applied to properties assignable to types 'DomainObject', 'ObjectList`1', or 'IObjectList`1'.{Environment.NewLine}{Environment.NewLine}"
        + "Declaring type: Remotion.Data.DomainObjects.UnitTests.Mapping.TestDomain.Validation.Reflection."
        +$"MappingAttributesAreSupportedForPropertyTypeValidationRule.ClassWithInvalidPropertyAttributes{Environment.NewLine}"
    ...
    public void SeveralInvalidProperties ()
    {
      ...
      var expectedMessage1 = $"The 'MandatoryAttribute' may be only applied to properties assignable to types 'DomainObject', 'ObjectList`1', or 'IObjectList`1'.{Environment.NewLine}{Environment.NewLine}"
        + "Declaring type: Remotion.Data.DomainObjects.UnitTests.Mapping.TestDomain.Validation.Reflection."
        +$"MappingAttributesAreSupportedForPropertyTypeValidationRule.ClassWithInvalidPropertyAttributes{Environment.NewLine}"
        + "Property: StringPropertyWithMandatoryPropertyAttribute";
      var expectedMessage2 = $"The 'ExtensibleEnumPropertyAttribute' may be only applied to properties of type 'IExtensibleEnum'.{Environment.NewLine}{Environment.NewLine}"
        + "Declaring type: Remotion.Data.DomainObjects.UnitTests.Mapping.TestDomain.Validation.Reflection."
        + $"MappingAttributesAreSupportedForPropertyTypeValidationRule.ClassWithInvalidPropertyAttributes{Environment.NewLine}"
        + "Property: StringPropertyWithExtensibleEnumPropertyAttribute";
      var expectedMessage3 = $"The 'BinaryPropertyAttribute' may be only applied to properties of type 'Byte[]'.{Environment.NewLine}{Environment.NewLine}"
        + "Declaring type: Remotion.Data.DomainObjects.UnitTests.Mapping.TestDomain.Validation.Reflection."
        + $"MappingAttributesAreSupportedForPropertyTypeValidationRule.ClassWithInvalidPropertyAttributes{Environment.NewLine}"
        + "Property: BoolPropertyWithBinaryPropertyAttribute";
