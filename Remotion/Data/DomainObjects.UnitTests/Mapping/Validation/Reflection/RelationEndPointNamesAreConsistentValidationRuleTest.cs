  ...
  public class RelationEndPointNamesAreConsistentValidationRuleTest : ValidationRuleTestBase
  {
    ...
    public void OppositeRelationPropertyHasNoBidirectionalRelationAttributeDefined ()
    {
      ...
      var expectedMessage =
          ...
          + "'RelationEndPointPropertyClass2' does not define a matching 'DBBidirectionalRelationAttribute'." + Environment.NewLine
          + Environment.NewLine
    ...
    public void OppositeRelationPropertyNameDoesNotMatch ()
    {
      ...
      var expectedMessage =
        ...
        + "defines a 'DBBidirectionalRelationAttribute' whose opposite property does not match." + Environment.NewLine
        + Environment.NewLine
        + "Declaring type: Remotion.Data.DomainObjects.UnitTests.Mapping.TestDomain.Validation.Reflection."
        + "RelationEndPointNamesAreConsistentValidationRule.RelationEndPointPropertyClass1" + Environment.NewLine
