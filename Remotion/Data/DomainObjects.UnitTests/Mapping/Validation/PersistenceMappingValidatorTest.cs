...
namespace Remotion.Data.DomainObjects.UnitTests.Mapping.Validation
{
  ...
  public class PersistenceMappingValidatorTest
  {
    ...
    private Mock<IPersistenceMappingValidationRule> _validationRuleMock1;
    private Mock<IPersistenceMappingValidationRule> _validationRuleMock2;
    private Mock<IPersistenceMappingValidationRule> _validationRuleMock3;

    [SetUp]
    public void SetUp ()
    {
      var type = typeof(DerivedValidationDomainObjectClass);
      _typeDefinition1 = TypeDefinitionObjectMother.CreateClassDefinition(classType: type);
      _typeDefinition2 = TypeDefinitionObjectMother.CreateClassDefinition(classType: type);
      _typeDefinition3 = TypeDefinitionObjectMother.CreateClassDefinition(classType: type);

      _validationRuleMock1 = new Mock<IPersistenceMappingValidationRule>(MockBehavior.Strict);
      _validationRuleMock2 = new Mock<IPersistenceMappingValidationRule>(MockBehavior.Strict);
      _validationRuleMock3 = new Mock<IPersistenceMappingValidationRule>(MockBehavior.Strict);
    ...
    {
      var validator = new PersistenceMappingValidator(_validationRuleMock1.Object);
    ...
    {
      var validator = new PersistenceMappingValidator(_validationRuleMock1.Object, _validationRuleMock2.Object, _validationRuleMock3.Object);
