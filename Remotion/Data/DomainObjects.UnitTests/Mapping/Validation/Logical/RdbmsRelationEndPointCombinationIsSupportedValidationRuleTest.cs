  ...
  public class RdbmsRelationEndPointCombinationIsSupportedValidationRuleTest : ValidationRuleTestBase
  {
    ...
    public void TwoVirtualRelationEndPoints ()
    {
      ...
      var expectedMessage =
          ...
          + "'DBBidirectionalRelationAttribute'." + Environment.NewLine
          + Environment.NewLine
    ...
    public void TwoVirtualRelationEndPoint_FirstEndPointIsAnonymous ()
    {
      ...
      var expectedMessage =
          ...
          + "One of the two properties must set 'ContainsForeignKey' to 'true' on the 'DBBidirectionalRelationAttribute'." + Environment.NewLine
          + Environment.NewLine
          + "Declaring type: Remotion.Data.DomainObjects.UnitTests.Mapping.TestDomain.Integration.Order" + Environment.NewLine
          + "Property: OrderNumber" + Environment.NewLine
          + "Relation ID: Test";
    ...
    public void TwoNonVirtualRelationEndPoints ()
    {
      ...
      var expectedMessage =
        ...
        +"contains two non-virtual end points. One of the two properties must set 'ContainsForeignKey' to 'false' on the 'DBBidirectionalRelationAttribute'." + Environment.NewLine
        + Environment.NewLine
        +"Declaring type: Remotion.Data.DomainObjects.UnitTests.Mapping.TestDomain.Integration.Order" + Environment.NewLine
