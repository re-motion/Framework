...
namespace Remotion.Data.DomainObjects.UnitTests.Mapping.Validation.Logical
{
  ...
  public class VirtualRelationEndPointCardinalityMatchesPropertyTypeValidationRuleTest : ValidationRuleTestBase
  {
    ...
    public void VirtualRelationEndPointDefinitionWithCardinalityOne_And_PropertyTypeNotAssignableToDomainObject ()
    {
      ...
      var expectedMessage =
          $"The property type of a virtual end point of a one-to-one relation must be assignable to 'DomainObject'.{Environment.NewLine}{Environment.NewLine}"
    ...
    public void VirtualRelationEndPointDefinitionWithCardinalityMany_And_PropertyTypeIsDomainObjectCollection ()
    {
      ...
      var expectedMessage =
          $"The property type of a virtual end point of a one-to-many relation must be assignable to 'ObjectList`1'.{Environment.NewLine}{Environment.NewLine}"
          + $"Declaring type: Remotion.Data.DomainObjects.UnitTests.Mapping.TestDomain.Integration.Order{Environment.NewLine}"
    ...
    public void VirtualRelationEndPointDefinitionWithCardinalityMany_And_PropertyTypeIsNotIObjectList ()
    {
      ...
      var expectedMessage =
          $"The property type of a virtual end point of a one-to-many relation must be 'IObjectList`1'.{Environment.NewLine}{Environment.NewLine}"
          + $"Declaring type: Remotion.Data.DomainObjects.UnitTests.Mapping.TestDomain.Integration.Order{Environment.NewLine}"
          + "Property: PropertyName";
      AssertMappingValidationResult(validationResult, false, expectedMessage);
    }
