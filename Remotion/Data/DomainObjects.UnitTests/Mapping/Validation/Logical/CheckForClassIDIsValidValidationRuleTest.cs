...
namespace Remotion.Data.DomainObjects.UnitTests.Mapping.Validation.Logical
{
  ...
  public class CheckForClassIDIsValidValidationRuleTest : ValidationRuleTestBase
  {
    ...
    public void InvalidClassID (string classID)
    {
      ...
      var expectedMessage =
          $"The Class-ID '{classID}' is not valid. Valid Class-IDs must start with a letter or underscore and containing only letters, digits, and underscores.{Environment.NewLine}{Environment.NewLine}"
