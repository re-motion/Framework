  ...
  public class SortExpressionIsValidValidationRuleTest : ValidationRuleTestBase
  {
    ...
    public void InvalidSortExpression_WithDomainObjectCollectionRelationEndPointDefinition ()
    {
      ...
      var expectedMessage =
          ...
          + "or a derived class of 'Order', the full unique re-store property identifier can be specified." + Environment.NewLine
          + Environment.NewLine
    ...
    public void InvalidSortExpression_WithVirtualCollectionRelationEndPointDefinition ()
    {
      ...
      var expectedMessage =
          ...
          + "or a derived class of 'ProductReview', the full unique re-store property identifier can be specified." + Environment.NewLine
          + Environment.NewLine
          + "Declaring type: Remotion.Data.DomainObjects.UnitTests.Mapping.TestDomain.Integration.Product" + Environment.NewLine
          + "Property: Reviews";
      AssertMappingValidationResult(validationResult, false, expectedMessage);
    }
  }
