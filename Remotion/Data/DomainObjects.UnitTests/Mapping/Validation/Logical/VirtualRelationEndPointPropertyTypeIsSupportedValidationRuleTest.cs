...
namespace Remotion.Data.DomainObjects.UnitTests.Mapping.Validation.Logical
{
  ...
  public class VirtualRelationEndPointPropertyTypeIsSupportedValidationRuleTest : ValidationRuleTestBase
  {
    ...
    public void LeftEndpointPropertyType_NotAssignableToObjectListOrDomainObjectOrOfTypeIObjectList ()
    {
      ...
      var expectedMessage =
          "Virtual property 'Left' of class 'Order' is of type 'String', but must be assignable to 'DomainObject' or 'ObjectList`1' or be of type 'IObjectList`1'." + Environment.NewLine
          + Environment.NewLine
    ...
    public void RightEndpointPropertyType_NotAssignableToIObjectListOrObjectListOrDomainObjectOrOfTypeIObjectList ()
    {
      ...
      var expectedMessage =
          "Virtual property 'Right' of class 'Order' is of type 'String', but must be assignable to 'DomainObject' or 'ObjectList`1' or be of type 'IObjectList`1'." + Environment.NewLine
          + Environment.NewLine
          + "Declaring type: Remotion.Data.DomainObjects.UnitTests.Mapping.TestDomain.Integration.Order" + Environment.NewLine
          + "Property: Right";
      AssertMappingValidationResult(validationResult, false, expectedMessage);
