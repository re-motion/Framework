      ...
      Assert.That(
          ...
          Throws.InstanceOf<MappingException>()
              .With.Message.EqualTo(
                  ...
                  "Declaring type: Remotion.Data.DomainObjects.UnitTests.Mapping.TestDomain.Validation.Integration.NotSupportedRelations."
                  + "OneToMany_ContainsForeignKeyIsTrueOnManySite.InvalidRelationClass2" + Environment.NewLine
      ...
      Assert.That(
          ...
          Throws.InstanceOf<MappingException>()
              .With.Message.EqualTo(
                  "Only relation end points with a property type of 'DomainObject' can contain the foreign key." + Environment.NewLine + Environment.NewLine
                  + "Declaring type: Remotion.Data.DomainObjects.UnitTests.Mapping.TestDomain.Validation.Integration.NotSupportedRelations."
                  + "OneToMany_ContainsForeignKeyIsTrueOnBothSites.InvalidRelationClass2" + Environment.NewLine
                  + "Property: RelationProperty2"));
    }
      ...
      Assert.That(
          ...
          Throws.InstanceOf<MappingException>()
              .With.Message.EqualTo(
                  ...
                  + "Declaring type: Remotion.Data.DomainObjects.UnitTests.Mapping.TestDomain.Validation.Integration.NotSupportedRelations."
                  + "OneToOne_WithSortExpression.InvalidRelationClass1" + Environment.NewLine
      ...
      Assert.That(
          ...
          Throws.InstanceOf<MappingException>()
              .With.Message.EqualTo(
                  ...
                  + "Declaring type: Remotion.Data.DomainObjects.UnitTests.Mapping.TestDomain.Validation.Integration.NotSupportedRelations."
                  + "OneToMany_WithInvalidSortExpression.InvalidRelationClass2" + Environment.NewLine
                  + "Property: RelationProperty2"));
    }
