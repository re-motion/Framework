...
namespace Remotion.Data.DomainObjects.UnitTests.Mapping.TestDomain.Validation
{
  ...
  {
    public static EnumTypeValidationDomainObjectClass.ExtensibleEnumTypeWithValues Value (
        this ExtensibleEnumDefinition<EnumTypeValidationDomainObjectClass.ExtensibleEnumTypeWithValues> definition)
    {
