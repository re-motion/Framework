  ...
  public class PropertyDefinitionTest : StandardMappingTest
  {
    ...
    public void Initialize ()
    {
      ...
      var actual = new PropertyDefinition(
          _typeDefinition, _propertyInformationStub.Object, "Test", false, false, null, StorageClass.Persistent);
    ...
    public void Initialize_WithReferenceType_IsNullableTrue ()
    {
      _propertyInformationStub.Setup(stub => stub.PropertyType).Returns(typeof(string));
      var actual = new PropertyDefinition(
          _typeDefinition, _propertyInformationStub.Object, "Test", false, true, null, StorageClass.Persistent);
    ...
    public void Initialize_WithString_MaxLengthSet ()
    {
      _propertyInformationStub.Setup(stub => stub.PropertyType).Returns(typeof(string));
      var actual = new PropertyDefinition(
          _typeDefinition, _propertyInformationStub.Object, "Test", false, true, 50, StorageClass.Persistent);
    ...
    public void IsObjectID_True ()
    {
      ...
      var actual = new PropertyDefinition(
          _typeDefinition, _propertyInformationStub.Object, "Test", true, false, null, StorageClass.Persistent);
