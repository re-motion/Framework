...
namespace Remotion.Data.DomainObjects.UnitTests.Mapping
{
  ...
  public class LegacyPropertyDefaultValueProviderTests
  {
    ...
    public void DefaultValue_NotNullable_ExtensibleEnumWithoutValues ()
    {
      ...
      var defaultValue = (IExtensibleEnum)_defaultValueProvider.GetDefaultValue(_propertyInformationStub.Object, false);
      Assert.That(defaultValue, Is.Not.Null);
      Assert.That(defaultValue.ValueName, Is.Null);
    }
