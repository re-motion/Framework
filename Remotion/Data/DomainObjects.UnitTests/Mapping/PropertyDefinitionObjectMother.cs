...
namespace Remotion.Data.DomainObjects.UnitTests.Mapping
{
  ...
  public static class PropertyDefinitionObjectMother
  {
    ...
    {
      Type declaringType = typeDefinition.Type;
      ...
      return CreateForPropertyInformation(typeDefinition, propertyName, isObjectID, isNullable, maxLength, storageClass, propertyInformationStub.Object);
    }
