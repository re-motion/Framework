...
public class DomainObjectCollectionChangeEventArgs : EventArgs
{
  ...
  /// </summary>
  /// <param name="domainObject">The <see cref="Remotion.Data.DomainObjects.IDomainObject"/> that is being added or removed to the collection. Must not be <see langword="null"/>.</param>
