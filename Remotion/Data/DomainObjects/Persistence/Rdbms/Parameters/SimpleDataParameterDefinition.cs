...
/// <summary>
/// Can create <see cref="IDataParameterDefinition"/> instances for simple (atomic) parameter values.
/// </summary>
public class SimpleDataParameterDefinition : IDataParameterDefinition
{
  ...
  {
    ArgumentUtility.CheckType(nameof(value), value, StorageTypeInformation.DotNetType);
  ...
  public IDbDataParameter CreateDataParameter (IDbCommand command, string parameterName, object parameterValue)
  {
    ...
    if (StorageTypeInformation.StorageTypeLength.HasValue)
      parameter.Size = StorageTypeInformation.StorageTypeLength.Value;
