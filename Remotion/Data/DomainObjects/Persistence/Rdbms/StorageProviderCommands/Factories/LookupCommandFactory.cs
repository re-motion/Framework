...
namespace Remotion.Data.DomainObjects.Persistence.Rdbms.StorageProviderCommands.Factories
{
  ...
  public class LookupCommandFactory
  {
    ...
    public virtual IRdbmsProviderReadOnlyCommand<ObjectLookupResult<DataContainer>> CreateForSingleIDLookup (ObjectID objectID)
    {
    ...
    public virtual IRdbmsProviderReadOnlyCommand<IEnumerable<ObjectLookupResult<DataContainer>>> CreateForSortedMultiIDLookup (
    ...
    public virtual IRdbmsProviderReadOnlyCommand<IEnumerable<ObjectLookupResult<object>>> CreateForMultiTimestampLookup (
        IEnumerable<ObjectID> objectIDs)
    {
      ArgumentUtility.CheckNotNull("objectIDs", objectIDs);
