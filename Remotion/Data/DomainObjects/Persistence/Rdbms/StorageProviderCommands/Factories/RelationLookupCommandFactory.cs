...
namespace Remotion.Data.DomainObjects.Persistence.Rdbms.StorageProviderCommands.Factories
{
  ...
  public class RelationLookupCommandFactory
  {
    ...
    public virtual IRdbmsProviderReadOnlyCommand<IEnumerable<DataContainer>> CreateForRelationLookup (
        RelationEndPointDefinition foreignKeyEndPoint, ObjectID foreignKeyValue, SortExpressionDefinition? sortExpressionDefinition)
    {
      ...
      return InlineRdbmsStorageEntityDefinitionVisitor.Visit<IRdbmsProviderReadOnlyCommand<IEnumerable<DataContainer>>>(
    ...
    protected virtual IRdbmsProviderReadOnlyCommand<IEnumerable<DataContainer>> CreateForDirectRelationLookup (
    ...
    protected virtual IRdbmsProviderReadOnlyCommand<IEnumerable<DataContainer>> CreateForIndirectRelationLookup (
    ...
    {
      return
          new FixedValueCommand<IEnumerable<DataContainer>>(Enumerable.Empty<DataContainer>());
    }
