...
namespace Remotion.Data.DomainObjects.Persistence.Rdbms.StorageProviderCommands.Factories
{
  ...
  public class QueryCommandFactory
  {
    ...
    public virtual IRdbmsProviderCommand<IEnumerable<DataContainer?>> CreateForDataContainerQuery (IQuery query)
    {
    ...
    public virtual IRdbmsProviderCommand<IEnumerable<IQueryResultRow>> CreateForCustomQuery (IQuery query)
    {
      ArgumentUtility.CheckNotNull("query", query);
    ...
    public virtual IRdbmsProviderCommand<object?> CreateForScalarQuery (IQuery query)
    {
      ArgumentUtility.CheckNotNull("query", query);
