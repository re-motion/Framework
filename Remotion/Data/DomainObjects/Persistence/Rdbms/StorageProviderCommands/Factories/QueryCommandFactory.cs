...
namespace Remotion.Data.DomainObjects.Persistence.Rdbms.StorageProviderCommands.Factories
{
  ...
  public class QueryCommandFactory
  {
    ...
    public virtual IRdbmsProviderReadOnlyCommand<IEnumerable<DataContainer?>> CreateForDataContainerQuery (IQuery query)
    {
    ...
    public virtual IRdbmsProviderReadWriteCommand<IEnumerable<IQueryResultRow>> CreateForCustomQuery (IQuery query)
    {
      ArgumentUtility.CheckNotNull("query", query);
    ...
    public virtual IRdbmsProviderReadWriteCommand<object?> CreateForScalarQuery (IQuery query)
    {
      ArgumentUtility.CheckNotNull("query", query);
