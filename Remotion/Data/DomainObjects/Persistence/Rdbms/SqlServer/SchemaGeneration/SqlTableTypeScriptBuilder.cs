...
namespace Remotion.Data.DomainObjects.Persistence.Rdbms.SqlServer.SchemaGeneration
{
  ...
  /// </summary>
  public class SqlTableTypeScriptBuilder : IScriptBuilder
  {
    ...
    public SqlTableTypeScriptBuilder (IStructuredTypeScriptElementFactory elementFactory, ICommentScriptElementFactory commentFactory)
    {
    ...
    private void AddTableTypeDefinition (SqlTableTypeDefinition tableTypeDefinition)
    {
