...
namespace Remotion.Data.DomainObjects.Persistence
{
  ...
  {
    /// <summary>
    /// Resolves an <see cref="IReadOnlyStorageProvider"/> based on the supplied <paramref name="storageProviderID"/>.
    /// </summary>
    ...
    IReadOnlyStorageProvider GetMandatory (string storageProviderID);
  }
}
