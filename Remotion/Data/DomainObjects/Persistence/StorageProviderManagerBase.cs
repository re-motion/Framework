...
namespace Remotion.Data.DomainObjects.Persistence
{
      ...
      where TStorageProvider : IReadOnlyStorageProvider
  {
    ...
    protected StorageProviderManagerBase (IPersistenceExtension persistenceExtension)
    {
    ...
    public TStorageProvider GetMandatory (string storageProviderID)
    {
      ...
      TStorageProvider? provider = this[storageProviderID];
      if (provider == null)
      {
    ...
    public TStorageProvider? this [string storageProviderID]
    {
      get
      {
        CheckDisposed();
