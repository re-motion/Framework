...
[Obsolete("Use IReadOnlyStorageProvider or IStorageProvider instead. (Version 6.1.0)", true)]
public abstract class StorageProvider
{
  private const string c_messageForPublicMembers = "Use IReadOnlyStorageProvider or IStorageProvider instead. For derived classes/mixins, consider deriving from/mixing RdbmsProvider instead. (Version 6.1.0)";
  private const string c_messageForAbstractMembers = "Derive from/mix RdbmsProvider instead, or fully implement the IStorageProvider interface in your class. (Version 6.1.0)";
