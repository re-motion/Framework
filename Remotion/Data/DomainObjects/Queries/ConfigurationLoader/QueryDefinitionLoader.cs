...
namespace Remotion.Data.DomainObjects.Queries.ConfigurationLoader
{
  ...
  public class QueryDefinitionLoader : IQueryDefinitionLoader
  {
    ...
    private readonly Lazy<ReadOnlyCollection<QueryDefinition>> _queries;
    ...
    public QueryDefinitionLoader (IQueryFileFinder queryFileFinder)
    {
      ...
      _queries = new Lazy<ReadOnlyCollection<QueryDefinition>>(
          LoadAllQueryDefinitionsImplementation,
          LazyThreadSafetyMode.ExecutionAndPublication);
    }

    /// <inheritdoc />
    public IReadOnlyCollection<QueryDefinition> LoadAllQueryDefinitions () => _queries.Value;

    private ReadOnlyCollection<QueryDefinition> LoadAllQueryDefinitionsImplementation ()
    {
