...
namespace Remotion.Data.DomainObjects.Queries.Configuration
{
  ...
  public enum QueryType
  {
    ...
    /// </summary>
    [Obsolete("'QueryType.Collection' has been replaced with 'QueryType.CollectionReadWrite'. (Version 6.1.0)", false)]
    Collection = CollectionReadWrite,

    /// <summary>
    /// Instances of a <see cref="QueryDefinition"/> return only a single value.
    /// </summary>
    [Obsolete("'QueryType.Scalar' has been replaced with 'QueryType.ScalarReadWrite'. (Version 6.1.0)", false)]
    Scalar = ScalarReadWrite,

    /// <summary>
    /// Instances of a <see cref="QueryDefinition"/> return a sequence of arbitrary objects.
    /// </summary>
    [Obsolete("'QueryType.Custom' has been replaced with 'QueryType.CustomReadWrite'. (Version 6.1.0)", false)]
    ...
    /// Instances of a <see cref="QueryDefinition"/> return a collection of <see cref="DomainObject"/>s.
    /// </summary>
    [Obsolete("'QueryType.Collection' has been replaced with 'QueryType.CollectionReadWrite'. (Version 6.1.0)", false, DiagnosticId = ObsoleteDiagnosticIDs.QueryTypeValue)]
    Collection = CollectionReadWrite,

    /// <summary>
    /// Instances of a <see cref="QueryDefinition"/> return only a single value.
    /// </summary>
    [Obsolete("'QueryType.Scalar' has been replaced with 'QueryType.ScalarReadWrite'. (Version 6.1.0)", false, DiagnosticId = ObsoleteDiagnosticIDs.QueryTypeValue)]
    Scalar = ScalarReadWrite,

    /// <summary>
    /// Instances of a <see cref="QueryDefinition"/> return a sequence of arbitrary objects.
    /// </summary>
    [Obsolete("'QueryType.Custom' has been replaced with 'QueryType.CustomReadWrite'. (Version 6.1.0)", false, DiagnosticId = ObsoleteDiagnosticIDs.QueryTypeValue)]
    Custom = CustomReadWrite,
#endif
  }
}
