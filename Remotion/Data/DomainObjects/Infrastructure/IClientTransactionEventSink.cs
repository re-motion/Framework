...
namespace Remotion.Data.DomainObjects.Infrastructure
{
  ...
  public interface IClientTransactionEventSink
  {
    ...
    // User event
    void RaiseRelationReadingEvent (IDomainObject domainObject, IRelationEndPointDefinition relationEndPointDefinition, ValueAccess valueAccess);
    // User event
    void RaiseRelationReadEvent (IDomainObject domainObject, IRelationEndPointDefinition relationEndPointDefinition, IDomainObject? relatedObject, ValueAccess valueAccess);
    // User event
