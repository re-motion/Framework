...
namespace Remotion.Data.DomainObjects.Linq
{
  ...
  public class MappingResolver : IMappingResolver
  {
    ...
    {
      ArgumentUtility.CheckNotNull(nameof(storageSpecificExpressionResolver), storageSpecificExpressionResolver);
    ...
    {
      ArgumentUtility.CheckNotNull(nameof(sqlColumnExpression), sqlColumnExpression);
      ArgumentUtility.CheckNotNull(nameof(memberInfo), memberInfo);
    ...
    {
      ArgumentUtility.CheckNotNull(nameof(checkedExpression), checkedExpression);
