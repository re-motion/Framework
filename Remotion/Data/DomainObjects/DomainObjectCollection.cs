...
namespace Remotion.Data.DomainObjects
{
  ...
  public partial class DomainObjectCollection : ICloneable, IList, IAssociatableDomainObjectCollection
  {
    ...
    /// </summary>
    /// <param name="id">The <see cref="ObjectID"/> of the <see cref="IDomainObject"/> to locate in the <see cref="DomainObjectCollection"/>. Must not be <see langword="null"/>.</param>
    /// <returns><see langword="true"/> if the <see cref="IDomainObject"/> with the <paramref name="id"/> is found in the <see cref="DomainObjectCollection"/>; otherwise, false;</returns>
