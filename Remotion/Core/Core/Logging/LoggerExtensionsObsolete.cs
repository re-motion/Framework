...
public static class LoggerExtensionsObsolete
{
  ...
  /// </summary>
  /// <param name="logger">The <see cref="MicrosoftLogger"/> instance where the message is to be logged.</param>
  ...
  public static void Log (this MicrosoftLogger logger, MicrosoftLoglevel logLevel, int eventID, object? message)
  {
  ...
  public static void Log (this MicrosoftLogger logger, MicrosoftLoglevel logLevel, object? message, Exception exceptionObject)
  {
  ...
  /// <param name="logLevel">The <see cref="MicrosoftLoglevel"/> of the message to be logged.</param>
  /// <param name="message">The message object to log.</param>
  public static void Log (this MicrosoftLogger logger, MicrosoftLoglevel logLevel, object? message)
  {
  ...
  public static void LogFormat (this MicrosoftLogger logger, MicrosoftLoglevel logLevel, int eventID, string? format, params object?[] args)
  {
  ...
  /// <param name="args">An array containing zero or more objects to format.</param>
  [StringFormatMethod("format")]
  public static void LogFormat (this MicrosoftLogger logger, MicrosoftLoglevel logLevel, string? format, params object?[] args)
  {
  ...
  /// <param name="args">An array containing zero or more objects to format.</param>
  [StringFormatMethod("format")]
  public static void LogFormat (this MicrosoftLogger logger, MicrosoftLoglevel logLevel, Exception exceptionObject, string? format, params object?[] args)
  {
  ...
  /// <param name="message">The message object to log.</param>
  /// <param name="exceptionObject">The <see cref="Exception"/> to log, including its stack trace. Pass <see langword="null"/> to not log an exception.</param>
  public static void Debug (this MicrosoftLogger logger, int eventID, object? message, Exception exceptionObject)
  {
  ...
  /// <param name="eventID">The numeric identifier for the event.</param>
  /// <param name="message">The message object to log.</param>
  public static void Debug (this MicrosoftLogger logger, int eventID, object? message)
  {
  ...
  /// <param name="message">The message object to log.</param>
  /// <param name="exceptionObject">The <see cref="Exception"/> to log, including its stack trace. Pass <see langword="null"/> to not log an exception.</param>
  public static void Debug (this MicrosoftLogger logger, object? message, Exception exceptionObject)
  {
  ...
  /// <param name="logger">The <see cref="MicrosoftLogger"/> instance where the message is to be logged.</param>
  /// <param name="message">The message object to log.</param>
  public static void Debug (this MicrosoftLogger logger, object? message)
  {
  ...
  /// <param name="args">An array containing zero or more objects to format.</param>
  [StringFormatMethod("format")]
  public static void DebugFormat (this MicrosoftLogger logger, int eventID, Exception exceptionObject, string? format, params object?[] args)
  {
  ...
  /// <param name="args">An array containing zero or more objects to format.</param>
  [StringFormatMethod("format")]
  public static void DebugFormat (this MicrosoftLogger logger, int eventID, string? format, params object?[] args)
  {
  ...
  /// <param name="args">An array containing zero or more objects to format.</param>
  [StringFormatMethod("format")]
  public static void DebugFormat (this MicrosoftLogger logger, string? format, params object?[] args)
  {
  ...
  /// <param name="args">An array containing zero or more objects to format.</param>
  [StringFormatMethod("format")]
  public static void DebugFormat (this MicrosoftLogger logger, Exception exceptionObject, string? format, params object?[] args)
  {
  ...
  /// <param name="message">The message object to log.</param>
  /// <param name="exceptionObject">The <see cref="Exception"/> to log, including its stack trace. Pass <see langword="null"/> to not log an exception.</param>
  public static void Info (this MicrosoftLogger logger, int eventID, object? message, Exception exceptionObject)
  {
  ...
  /// <param name="eventID">The numeric identifier for the event.</param>
  /// <param name="message">The message object to log.</param>
  public static void Info (this MicrosoftLogger logger, int eventID, object? message)
  {
  ...
  /// <param name="message">The message object to log.</param>
  /// <param name="exceptionObject">The <see cref="Exception"/> to log, including its stack trace. Pass <see langword="null"/> to not log an exception.</param>
  public static void Info (this MicrosoftLogger logger, object? message, Exception exceptionObject)
  {
  ...
  /// <param name="logger">The <see cref="MicrosoftLogger"/> instance where the message is to be logged.</param>
  /// <param name="message">The message object to log.</param>
  public static void Info (this MicrosoftLogger logger, object? message)
  {
  ...
  /// <param name="args">An array containing zero or more objects to format.</param>
  [StringFormatMethod("format")]
  public static void InfoFormat (this MicrosoftLogger logger, int eventID, Exception exceptionObject, string? format, params object?[] args)
  {
  ...
  /// <param name="args">An array containing zero or more objects to format.</param>
  [StringFormatMethod("format")]
  public static void InfoFormat (this MicrosoftLogger logger, int eventID, string? format, params object?[] args)
  {
  ...
  /// <param name="args">An array containing zero or more objects to format.</param>
  [StringFormatMethod("format")]
  public static void InfoFormat (this MicrosoftLogger logger, string? format, params object?[] args)
  {
  ...
  /// <param name="args">An array containing zero or more objects to format.</param>
  [StringFormatMethod("format")]
  public static void InfoFormat (this MicrosoftLogger logger, Exception exceptionObject, string? format, params object?[] args)
  {
  ...
  /// <param name="message">The message object to log.</param>
  /// <param name="exceptionObject">The <see cref="Exception"/> to log, including its stack trace. Pass <see langword="null"/> to not log an exception.</param>
  public static void Warn (this MicrosoftLogger logger, int eventID, object? message, Exception exceptionObject)
  {
  ...
  /// <param name="eventID">The numeric identifier for the event.</param>
  /// <param name="message">The message object to log.</param>
  public static void Warn (this MicrosoftLogger logger, int eventID, object? message)
  {
  ...
  /// <param name="message">The message object to log.</param>
  /// <param name="exceptionObject">The <see cref="Exception"/> to log, including its stack trace. Pass <see langword="null"/> to not log an exception.</param>
  public static void Warn (this MicrosoftLogger logger, object? message, Exception exceptionObject)
  {
  ...
  /// <param name="logger">The <see cref="MicrosoftLogger"/> instance where the message is to be logged.</param>
  /// <param name="message">The message object to log.</param>
  public static void Warn (this MicrosoftLogger logger, object? message)
  {
  ...
  /// <param name="args">An array containing zero or more objects to format.</param>
  [StringFormatMethod("format")]
  public static void WarnFormat (this MicrosoftLogger logger, int eventID, Exception exceptionObject, string? format, params object?[] args)
  {
  ...
  /// <param name="args">An array containing zero or more objects to format.</param>
  [StringFormatMethod("format")]
  public static void WarnFormat (this MicrosoftLogger logger, int eventID, string? format, params object?[] args)
  {
  ...
  /// <param name="args">An array containing zero or more objects to format.</param>
  [StringFormatMethod("format")]
  public static void WarnFormat (this MicrosoftLogger logger, string? format, params object?[] args)
  {
  ...
  /// <param name="args">An array containing zero or more objects to format.</param>
  [StringFormatMethod("format")]
  public static void WarnFormat (this MicrosoftLogger logger, Exception exceptionObject, string? format, params object?[] args)
  {
  ...
  /// <param name="message">The message object to log.</param>
  /// <param name="exceptionObject">The <see cref="Exception"/> to log, including its stack trace. Pass <see langword="null"/> to not log an exception.</param>
  public static void Error (this MicrosoftLogger logger, int eventID, object? message, Exception exceptionObject)
  {
  ...
  /// <param name="eventID">The numeric identifier for the event.</param>
  /// <param name="message">The message object to log.</param>
  public static void Error (this MicrosoftLogger logger, int eventID, object? message)
  {
  ...
  /// <param name="message">The message object to log.</param>
  /// <param name="exceptionObject">The <see cref="Exception"/> to log, including its stack trace. Pass <see langword="null"/> to not log an exception.</param>
  public static void Error (this MicrosoftLogger logger, object? message, Exception exceptionObject)
  {
  ...
  /// <param name="logger">The <see cref="MicrosoftLogger"/> instance where the message is to be logged.</param>
  /// <param name="message">The message object to log.</param>
  public static void Error (this MicrosoftLogger logger, object? message)
  {
  ...
  /// <param name="args">An array containing zero or more objects to format.</param>
  [StringFormatMethod("format")]
  public static void ErrorFormat (this MicrosoftLogger logger, int eventID, Exception exceptionObject, string? format, params object?[] args)
  {
  ...
  /// <param name="args">An array containing zero or more objects to format.</param>
  [StringFormatMethod("format")]
  public static void ErrorFormat (this MicrosoftLogger logger, int eventID, string? format, params object?[] args)
  {
  ...
  /// <param name="args">An array containing zero or more objects to format.</param>
  [StringFormatMethod("format")]
  public static void ErrorFormat (this MicrosoftLogger logger, string? format, params object?[] args)
  {
  ...
  /// <param name="args">An array containing zero or more objects to format.</param>
  [StringFormatMethod("format")]
  public static void ErrorFormat (this MicrosoftLogger logger, Exception exceptionObject, string? format, params object?[] args)
  {
  ...
  /// <param name="message">The message object to log.</param>
  /// <param name="exceptionObject">The <see cref="Exception"/> to log, including its stack trace. Pass <see langword="null"/> to not log an exception.</param>
  public static void Critical (this MicrosoftLogger logger, int eventID, object? message, Exception exceptionObject)
  {
  ...
  /// <param name="eventID">The numeric identifier for the event.</param>
  /// <param name="message">The message object to log.</param>
  public static void Critical (this MicrosoftLogger logger, int eventID, object? message)
  {
  ...
  /// <param name="message">The message object to log.</param>
  /// <param name="exceptionObject">The <see cref="Exception"/> to log, including its stack trace. Pass <see langword="null"/> to not log an exception.</param>
  public static void Critical (this MicrosoftLogger logger, object? message, Exception exceptionObject)
  {
  ...
  /// <param name="logger">The <see cref="MicrosoftLogger"/> instance where the message is to be logged.</param>
  /// <param name="message">The message object to log.</param>
  public static void Critical (this MicrosoftLogger logger, object? message)
  {
  ...
  /// <param name="args">An array containing zero or more objects to format.</param>
  [StringFormatMethod("format")]
  public static void CriticalFormat (this MicrosoftLogger logger, int eventID, Exception exceptionObject, string? format, params object?[] args)
  {
  ...
  /// <param name="args">An array containing zero or more objects to format.</param>
  [StringFormatMethod("format")]
  public static void CriticalFormat (this MicrosoftLogger logger, int eventID, string? format, params object?[] args)
  {
  ...
  /// <param name="args">An array containing zero or more objects to format.</param>
  [StringFormatMethod("format")]
  public static void CriticalFormat (this MicrosoftLogger logger, string? format, params object?[] args)
  {
  ...
  /// <param name="args">An array containing zero or more objects to format.</param>
  [StringFormatMethod("format")]
  public static void CriticalFormat (this MicrosoftLogger logger, Exception exceptionObject, string? format, params object?[] args)
  {
  ...
  /// </summary>
  /// <param name="logger">The <see cref="MicrosoftLogger"/> instance where the message is to be logged.</param>
  public static bool IsDebugEnabled (this MicrosoftLogger logger)
  {
  ...
  /// </summary>
  /// <param name="logger">The <see cref="MicrosoftLogger"/> instance where the message is to be logged.</param>
  public static bool IsInformationEnabled (this MicrosoftLogger logger)
  {
    ArgumentUtility.CheckNotNull("logger", logger);
  ...
  /// </summary>
  /// <param name="logger">The <see cref="MicrosoftLogger"/> instance where the message is to be logged.</param>
  public static bool IsWarningEnabled (this MicrosoftLogger logger)
  {
    ArgumentUtility.CheckNotNull("logger", logger);
  ...
  /// </summary>
  /// <param name="logger">The <see cref="MicrosoftLogger"/> instance where the message is to be logged.</param>
  public static bool IsErrorEnabled (this MicrosoftLogger logger)
  {
    ArgumentUtility.CheckNotNull("logger", logger);
  ...
  /// </summary>
  /// <param name="logger">The <see cref="MicrosoftLogger"/> instance where the message is to be logged.</param>
  public static bool IsCriticalEnabled (this MicrosoftLogger logger)
  {
    ArgumentUtility.CheckNotNull("logger", logger);
