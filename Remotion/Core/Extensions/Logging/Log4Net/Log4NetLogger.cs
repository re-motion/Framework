...
public class Log4NetLogger : MicrosoftLogging.ILogger
{
  ...
  public static Level Convert (MicrosoftLogging.LogLevel logLevel)
  {
    switch (logLevel)
    {
      case MicrosoftLogging.LogLevel.Debug:
        return Level.Debug;
      case MicrosoftLogging.LogLevel.Information:
        return Level.Info;
      case MicrosoftLogging.LogLevel.Warning:
        return Level.Warn;
      case MicrosoftLogging.LogLevel.Error:
        return Level.Error;
      case MicrosoftLogging.LogLevel.Critical:
  ...
  public static Level Convert (RemotionLogging.LogLevel logLevel)
  {
    switch (logLevel)
    {
      case RemotionLogging.LogLevel.Debug:
        return Level.Debug;
      case RemotionLogging.LogLevel.Info:
        return Level.Info;
      case RemotionLogging.LogLevel.Warn:
        return Level.Warn;
      case RemotionLogging.LogLevel.Error:
        return Level.Error;
      case RemotionLogging.LogLevel.Fatal:
        return Level.Fatal;
      default:
        throw new ArgumentException(string.Format("LogLevel does not support value {0}.", logLevel), "logLevel");
    }
  ...
  {
    var loggingEvent = new LoggingEvent(typeof(RemotionLogging.Log4NetLog), null, _logger.Name, level, message, exceptionObject);
