...
namespace Remotion.Extensions.UnitTests.Logging.LoggerExtensionsTests
{
  ...
  public class DebugTest : BaseTest
  {
    ...
    public void Test_FormatWithEnumAndException ()
    {
      ...
      Log.LogFormat(MicrosoftLogLevel.Debug, LogMessages.TheMessage, exception, "First", "Second");
    ...
    public void Test_FormatWithEnum ()
    {
      ...
      Log.LogFormat(MicrosoftLogLevel.Debug, LogMessages.TheMessage, null, "First", "Second");
