...
namespace Remotion.Extensions.UnitTests.Logging.LoggerExtensionsTests
{
  ...
  public class TraceTest : BaseTest
  {
    ...
    public void Test_FormatWithEnumAndException ()
    {
      ...
      Log.LogFormat(MicrosoftLogLevel.Trace, LogMessages.TheMessage, exception, "First", "Second");

      LoggingEvent[] events = GetLoggingEvents();
      Assert.That(events.Length, Is.EqualTo(1));
      LoggingEvent loggingEvent = events[0];
      Assert.That(loggingEvent.Level, Is.EqualTo(Level.Trace));
    ...
    public void Test_FormatWithEnum ()
    {
      ...
      Log.LogFormat(MicrosoftLogLevel.Trace, LogMessages.TheMessage, null, "First", "Second");
