...
namespace Remotion.Extensions.UnitTests.Logging.LoggerExtensionsObsoleteTests
{
  ...
  public class ErrorTest : BaseTest
  {
    ...
    public void Test_FormatWithEnumAndException ()
    {
      ...
      Log.LogFormat(MicrosoftLogLevel.Error, LogMessages.TheMessage, exception, "First", "Second");
    ...
    public void Test_FormatWithEnum ()
    {
      ...
      Log.LogFormat(MicrosoftLogLevel.Error, LogMessages.TheMessage, null, "First", "Second");
