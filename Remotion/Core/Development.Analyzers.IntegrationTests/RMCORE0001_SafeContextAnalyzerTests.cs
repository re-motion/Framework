...
";
    ...
    [Test]
    public async Task SafeContext_WithTasksParallelAndSafeContextBoundary_NoDiagnostic ()
    {
      const string input = @"
using System;
using System.Threading.Tasks;
...
public class A
{
  public void Test ()
  {
    using var boundary = SafeContext.Parallel.OpenSafeContextBoundary();
...
";
      await Verifier.VerifyAnalyzerAsync(input, true);
    }

    [Test]
    public async Task SafeContext_WithTasksParallelAndSafeContextBoundaryFromInstance_NoDiagnostic ()
    {
      const string input = @"
using System;
using System.Threading.Tasks;
...
public class A
{
  public void Test ()
  {
    using var boundary = SafeContext.Instance.OpenSafeContextBoundary();
...
";
    ...
    [Test]
    public async Task SafeContext_WithTasksParallelAndSafeContextBoundaryAfterUsages_Diagnostic ()
    {
      const string input = @"
using System;
using System.Threading.Tasks;
...
";
    ...
    [Test]
    public async Task SafeContext_WithTasksParallelAndUselessUsingStatement_Diagnostic ()
    {
      const string input = @"
using System;
using System.IO;
...
public class A
{
  public void Test ()
  {
    using var reader = File.OpenText(""notAFile"");
...
";
    ...
    [Test]
    public async Task SafeContext_WithTasksParallelAndSeveralLocalUsingDeclarations1_NoDiagnostic ()
    {
      const string input = @"
using System;
using System.IO;
...
";
    ...
    [Test]
    public async Task SafeContext_WithTasksParallelAndSeveralLocalUsingDeclarations2_NoDiagnostic ()
    {
      const string input = @"
using System;
using System.IO;
...
";
    ...
    [Test]
    public async Task SafeContext_WithTasksParallelAndSafeContextBoundaryBlock_NoDiagnostic ()
    {
      const string input = @"
using System;
using System.Threading.Tasks;
...
";
    ...
    [Test]
    public async Task SafeContext_WithTasksParallelAndSafeContextBoundaryInstanceBlock_NoDiagnostic ()
    {
      const string input = @"
using System;
using System.Threading.Tasks;
...
";
    ...
    [Test]
    public async Task SafeContext_WithTasksParallelAndNestedSafeContextBoundaryBlock_NoDiagnostic ()
    {
      const string input = @"
using System;
using System.IO;
...
public class A
{
  public void Test ()
  {
    using (SafeContext.Parallel.OpenSafeContextBoundary()) 
    {
      using (var reader = File.OpenText(""notAFile.txt""))
      {
        SafeContext.Instance.SetData(""a"", 3);
