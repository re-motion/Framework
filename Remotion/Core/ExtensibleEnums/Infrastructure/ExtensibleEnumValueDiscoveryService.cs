...
namespace Remotion.ExtensibleEnums.Infrastructure
{
  ...
  public class ExtensibleEnumValueDiscoveryService : IExtensibleEnumValueDiscoveryService
  {
    ...
    {
      ArgumentUtility.CheckNotNull(nameof(definition), definition);
      ArgumentUtility.CheckNotNull(nameof(typeCandidates), typeCandidates);
    ...
    {
      ArgumentUtility.CheckNotNull(nameof(definition), definition);
      ArgumentUtility.CheckNotNull(nameof(typeDeclaringMethods), typeDeclaringMethods);
    ...
    public IEnumerable<MethodInfo> GetValueExtensionMethods (Type extensibleEnumType, IEnumerable<MethodInfo> methodCandidates)
    {
      ...
      ArgumentUtility.CheckNotNull(nameof(methodCandidates), methodCandidates);
