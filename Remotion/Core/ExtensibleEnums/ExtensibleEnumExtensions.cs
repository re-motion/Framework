...
namespace Remotion.ExtensibleEnums
{
  ...
  public static class ExtensibleEnumExtensions
  {
    ...
    /// </summary>
    [Obsolete(
        "Retrieve IExtensibleEnumerationGlobalizationService from IoC container and use IExtensibleEnumerationGlobalizationService.GetExtensibleEnumerationValueDisplayName (...). (Version 1.13.223.0)",
        true)]
