...
namespace Remotion.Mixins.UnitTests.Core.Context.FluentBuilders
{
  ...
  public class MixinContextBuilderTest
  {
    ...
    public void ParentMembers ()
    {
      ...
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.Clear()).Returns(r1).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.AddMixin(typeof(object), origin)).Returns(r4).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.AddMixin(typeof(object), expectedInferredOrigin)).Returns(r4).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.AddMixin<string>(origin)).Returns(r4).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.AddMixin<string>(expectedInferredOrigin)).Returns(r4).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.AddMixins(origin, typeof(BT1Mixin1), typeof(BT1Mixin2))).Returns(r1).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.AddMixins(expectedInferredOrigin, typeof(BT1Mixin1), typeof(BT1Mixin2))).Returns(r1).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.AddMixins<BT1Mixin1, BT1Mixin2>(origin)).Returns(r1).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.AddMixins<BT1Mixin1, BT1Mixin2>(expectedInferredOrigin)).Returns(r1).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.AddMixins<BT1Mixin1, BT1Mixin2, BT3Mixin1>(origin)).Returns(r1).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.AddMixins<BT1Mixin1, BT1Mixin2, BT3Mixin1>(expectedInferredOrigin)).Returns(r1).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.AddOrderedMixins(origin, typeof(BT1Mixin1), typeof(BT1Mixin2))).Returns(r1).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.AddOrderedMixins(expectedInferredOrigin, typeof(BT1Mixin1), typeof(BT1Mixin2))).Returns(r1).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.AddOrderedMixins<BT1Mixin1, BT1Mixin2>(origin)).Returns(r1).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.AddOrderedMixins<BT1Mixin1, BT1Mixin2>(expectedInferredOrigin)).Returns(r1).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.AddOrderedMixins<BT1Mixin1, BT1Mixin2, BT3Mixin1>(origin)).Returns(r1).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.AddOrderedMixins<BT1Mixin1, BT1Mixin2, BT3Mixin1>(expectedInferredOrigin)).Returns(r1).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.EnsureMixin(typeof(object), origin)).Returns(r4).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.EnsureMixin(typeof(object), expectedInferredOrigin)).Returns(r4).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.EnsureMixin<string>(origin)).Returns(r4).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.EnsureMixin<string>(expectedInferredOrigin)).Returns(r4).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.EnsureMixins(origin, typeof(BT1Mixin1), typeof(BT1Mixin2))).Returns(r1).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.EnsureMixins(expectedInferredOrigin, typeof(BT1Mixin1), typeof(BT1Mixin2))).Returns(r1).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.EnsureMixins<BT1Mixin1, BT1Mixin2>(origin)).Returns(r1).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.EnsureMixins<BT1Mixin1, BT1Mixin2>(expectedInferredOrigin)).Returns(r1).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.EnsureMixins<BT1Mixin1, BT1Mixin2, BT3Mixin1>(origin)).Returns(r1).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.EnsureMixins<BT1Mixin1, BT1Mixin2, BT3Mixin1>(expectedInferredOrigin)).Returns(r1).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.AddComposedInterface(typeof(IBT6Mixin1))).Returns(r1).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.AddComposedInterface<IBT6Mixin1>()).Returns(r1).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.AddComposedInterfaces(typeof(IBT6Mixin1), typeof(IBT6Mixin2))).Returns(r1).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.AddComposedInterfaces<IBT6Mixin1, IBT6Mixin2>()).Returns(r1).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.AddComposedInterfaces<IBT6Mixin1, IBT6Mixin2, IBT6Mixin3>()).Returns(r1).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.AddComposedInterfaces<IBT6Mixin1, IBT6Mixin2, IBT6Mixin3>()).Returns(r1).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.SuppressMixin(suppressionRuleStub.Object)).Returns(r1).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.SuppressMixin(typeof(object))).Returns(r1).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.SuppressMixin<string>()).Returns(r1).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.SuppressMixins(typeof(BT1Mixin1), typeof(BT1Mixin2))).Returns(r1).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.SuppressMixins<BT1Mixin1, BT1Mixin2>()).Returns(r1).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.SuppressMixins<BT1Mixin1, BT1Mixin2, BT3Mixin1>()).Returns(r1).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.AddMixinDependency(typeof(BT1Mixin1), typeof(BT1Mixin2))).Returns(r1).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.AddMixinDependency<BT1Mixin1, BT1Mixin2>()).Returns(r1).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.BuildClassContext(inheritedContexts)).Returns(r5).Verifiable();
      _parentBuilderMock.InVerifiableSequence(sequence).Setup(mock => mock.BuildClassContext()).Returns(r5).Verifiable();
