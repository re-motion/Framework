...
namespace Remotion.Mixins.Context.FluentBuilders
{
  ...
  public class InheritanceResolvingClassContextBuilder
  {
    ...
    {
      ArgumentNullException.ThrowIfNull(classContextBuilders);
      ArgumentNullException.ThrowIfNull(parentContexts);
      ArgumentNullException.ThrowIfNull(inheritancePolicy);
    ...
    {
      _finishedContextCache.TryGetValue(type, out var finishedContext);
