...
namespace Remotion.Mixins.Validation.Rules
{
      ...
      where TMemberIntroductionDefinition : class, IMemberIntroductionDefinition
  {
    ...
    public IEnumerable<TMemberIntroductionDefinition> GetCachedPublicIntroductionsByName (Dictionary<object, object> contextStore, TargetClassDefinition targetClass, string name)
    {
