...
namespace Remotion.Mixins
{
  ...
  {
    private static readonly ICache<Type, ClassContext> s_classContextForConcreteTypesCache =
        CacheFactory.CreateWithSynchronization<Type, ClassContext>();

    private static readonly ICache<Type, ReadOnlyCollection<Type>> s_exactMixinTypesCache =
        CacheFactory.CreateWithSynchronization<Type, ReadOnlyCollection<Type>>();
