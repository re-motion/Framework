...
namespace Remotion.Security.UnitTests.SecurityClientTests
{
  ...
  public class HasMethodAccessTest_WithMethodInformation
  {
    ...
    public void Test_WithoutRequiredPermissions_ShouldThrowArgumentException ()
    {
      ...
      Assert.That(
          () => _securityClient.HasMethodAccess(_testHelper.SecurableObject, _methodInformation.Object),
    ...
    public void Test_WithSecurityStrategyIsNull ()
    {
      ...
      Assert.That(
          () => _securityClient.HasMethodAccess(new SecurableObject(null), _methodInformation.Object),
