...
namespace Remotion.Security.UnitTests.SecurityClientTests
{
  ...
  public class CheckPropertyReadAccessTest_WithMethodInformation
  {
    ...
    public void Test_AccessGranted ()
    {
      ...
      _securityClient.CheckPropertyReadAccess (_testHelper.SecurableObject, _methodInformation.Object);
    ...
    public void Test_WithSecurityStrategyIsNull ()
    {
      ...
      Assert.That (
          () => _securityClient.CheckPropertyReadAccess (new SecurableObject (null), _methodInformation.Object),
