...
namespace Remotion.Security.UnitTests.SecurityClientTests
{
  ...
  public class HasPropertyReadAccessTest_WithMethodInformation
  {
    ...
    public void Test_AccessGranted ()
    {
      ...
      bool hasAccess = _securityClient.HasPropertyReadAccess(_testHelper.SecurableObject, _methodInformation.Object);
    ...
    public void Test_WithinSecurityFreeSection_AccessGranted ()
    {
      ...
      {
        hasAccess = _securityClient.HasPropertyReadAccess(_testHelper.SecurableObject, _methodInformation.Object);
      }
