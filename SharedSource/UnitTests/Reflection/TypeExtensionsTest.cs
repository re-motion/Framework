...
namespace Remotion.UnitTests.Reflection
{
  ...
  public class TypeExtensionsTest
  {
    ...
    public void GetAssemblyQualifiedNameSafe_WithOpenConstructedGenericType_ReturnsTypeName ()
    {
      ...
      Assert.That(
          openConstructedGenericType.GetAssemblyQualifiedNameSafe(),
          Is.EqualTo("List`1"));
    }
    ...
    public void GetAssemblyQualifiedNameSafe_WithClosedConstructedGenericType_ReturnsAssemblyQualifiedName ()
    {
      ...
      var assemblyString = typeof(int).Assembly.ToString();
      Assert.That(
          closedConstructedGenericType.GetAssemblyQualifiedNameSafe(),
          Is.EqualTo($"System.Collections.Generic.List`1[[System.Int32, {assemblyString}]], {assemblyString}"));
    }
    ...
    public void GetAssemblyQualifiedNameChecked_WithClosedConstructedGenericType_ReturnsAssemblyQualifiedName ()
    {
      ...
      var assemblyString = typeof(int).Assembly.ToString();
      Assert.That(
          closedConstructedGenericType.GetAssemblyQualifiedNameChecked(),
          Is.EqualTo($"System.Collections.Generic.List`1[[System.Int32, {assemblyString}]], {assemblyString}"));
    }
    ...
    public void GetFullNameSafe_WithOpenConstructedGenericType_ReturnsTypeName ()
    {
      ...
      Assert.That(
          openConstructedGenericType.GetFullNameSafe(),
          Is.EqualTo("List`1"));
    }
    ...
    public void GetFullNameSafe_WithClosedConstructedGenericType_ReturnsFullName ()
    {
      ...
      var assemblyString = typeof(int).Assembly.ToString();
      Assert.That(
          closedConstructedGenericType.GetFullNameSafe(),
          Is.EqualTo($"System.Collections.Generic.List`1[[System.Int32, {assemblyString}]]"));
    }
    ...
    public void GetFullNameChecked_WithOpenConstructedGenericType_ThrowsInvalidOperationException ()
    {
      ...
      Assert.That(
          openConstructedType.GetFullNameChecked(),
          Is.EqualTo("System.Collections.Generic.List`1[T]"));
    }
    ...
    public void GetFullNameChecked_WithClosedConstructedGenericType_ReturnsFullName ()
    {
      ...
      var assemblyString = typeof(int).Assembly.ToString();
      Assert.That(
          closedConstructedType.GetFullNameChecked(),
          Is.EqualTo($"System.Collections.Generic.List`1[[System.Int32, {assemblyString}]]"));
    }
