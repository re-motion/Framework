...
namespace Remotion.UnitTests.Utilities.EnumUtilityTests
{
  ...
  public class SByteEnum
  {
    ...
    {
      Assert.That (EnumUtility.IsValidEnumValue ((TestEnum) (sbyte)(-3)), Is.False);
    }
    ...
    {
      Assert.That (EnumUtility.IsValidEnumValue (typeof (TestEnum), (SByte)1), Is.True);
    }
    ...
    {
      Assert.That (EnumUtility.IsValidEnumValue ((TestFlags) (sbyte) (-3)), Is.False);
    }

    [Test]
    public void IsValidEnumValue_WithFlag_AndValueOutOfRange_UndefinedBit ()
    {
      Assert.That (EnumUtility.IsValidEnumValue (TestFlags.Flag1 | ((TestFlags) (sbyte) 16)), Is.False);
    }
