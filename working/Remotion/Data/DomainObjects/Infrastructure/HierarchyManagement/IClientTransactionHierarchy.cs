...
{
  /// <summary>
  ///  Defines an interface for classes representing and tracking a <see cref="ClientTransaction"/> hierarchy.
  /// </summary>
  public interface IClientTransactionHierarchy
  {
    ClientTransaction RootTransaction { get; }
    ClientTransaction LeafTransaction { get; }
