...
DROP TYPE IF EXISTS [dbo].[TVP_AccessControlEntry_Insert]
DROP TYPE IF EXISTS [dbo].[TVP_AccessControlEntry_Update]
DROP TYPE IF EXISTS [dbo].[TVP_Permission_Insert]
DROP TYPE IF EXISTS [dbo].[TVP_Permission_Update]
DROP TYPE IF EXISTS [dbo].[TVP_StateCombination_Insert]
DROP TYPE IF EXISTS [dbo].[TVP_StateCombination_Update]
DROP TYPE IF EXISTS [dbo].[TVP_AccessControlList_Insert]
DROP TYPE IF EXISTS [dbo].[TVP_AccessControlList_Update]
DROP TYPE IF EXISTS [dbo].[TVP_StateUsage_Insert]
DROP TYPE IF EXISTS [dbo].[TVP_StateUsage_Update]
DROP TYPE IF EXISTS [dbo].[TVP_EnumValueDefinition_Insert]
DROP TYPE IF EXISTS [dbo].[TVP_EnumValueDefinition_Update]
DROP TYPE IF EXISTS [dbo].[TVP_AccessTypeReference_Insert]
DROP TYPE IF EXISTS [dbo].[TVP_AccessTypeReference_Update]
DROP TYPE IF EXISTS [dbo].[TVP_Culture_Insert]
DROP TYPE IF EXISTS [dbo].[TVP_Culture_Update]
DROP TYPE IF EXISTS [dbo].[TVP_LocalizedName_Insert]
DROP TYPE IF EXISTS [dbo].[TVP_LocalizedName_Update]
DROP TYPE IF EXISTS [dbo].[TVP_SecurableClassDefinition_Insert]
DROP TYPE IF EXISTS [dbo].[TVP_SecurableClassDefinition_Update]
DROP TYPE IF EXISTS [dbo].[TVP_StatePropertyDefinition_Insert]
DROP TYPE IF EXISTS [dbo].[TVP_StatePropertyDefinition_Update]
DROP TYPE IF EXISTS [dbo].[TVP_StatePropertyReference_Insert]
DROP TYPE IF EXISTS [dbo].[TVP_StatePropertyReference_Update]
DROP TYPE IF EXISTS [dbo].[TVP_Group_Insert]
DROP TYPE IF EXISTS [dbo].[TVP_Group_Update]
DROP TYPE IF EXISTS [dbo].[TVP_GroupType_Insert]
DROP TYPE IF EXISTS [dbo].[TVP_GroupType_Update]
DROP TYPE IF EXISTS [dbo].[TVP_GroupTypePosition_Insert]
DROP TYPE IF EXISTS [dbo].[TVP_GroupTypePosition_Update]
DROP TYPE IF EXISTS [dbo].[TVP_Position_Insert]
DROP TYPE IF EXISTS [dbo].[TVP_Position_Update]
DROP TYPE IF EXISTS [dbo].[TVP_Role_Insert]
DROP TYPE IF EXISTS [dbo].[TVP_Role_Update]
DROP TYPE IF EXISTS [dbo].[TVP_Substitution_Insert]
DROP TYPE IF EXISTS [dbo].[TVP_Substitution_Update]
DROP TYPE IF EXISTS [dbo].[TVP_Tenant_Insert]
DROP TYPE IF EXISTS [dbo].[TVP_Tenant_Update]
DROP TYPE IF EXISTS [dbo].[TVP_User_Insert]
DROP TYPE IF EXISTS [dbo].[TVP_User_Update]
