...
<table class="accessControlList">
  ...
  <tr>
    <td class="stateCombinationsContainer">
      ...
      <asp:CustomValidator ID="MissingStateCombinationsValidator" runat="server" ErrorMessage="###" OnServerValidate="MissingStateCombinationsValidator_ServerValidate" CssClass="permissionsEditorValidationMessage" EnableClientScript="false" />
    </td>
  </tr>
  <tr>
    <td class="stateCombinationsButtons">      
