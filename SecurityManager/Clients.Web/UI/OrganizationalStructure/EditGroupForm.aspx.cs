...
namespace Remotion.SecurityManager.Clients.Web.UI.OrganizationalStructure
{
  public partial class EditGroupForm : BaseEditPage<Group>
  {
    ...
    {
      Title = GlobalizationService.GetResourceManager (typeof (ResourceIdentifier)).GetText (ResourceIdentifier.Title).ToString (WebStringEncoding.HtmlWithTransformedLineBreaks);
